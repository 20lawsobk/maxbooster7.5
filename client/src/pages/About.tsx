      ...
      <section className="relative px-4 pt-20 pb-16 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            The complete platform for independent artists to create, distribute,
            promote, and monetize their music
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
              To democratize the music industry by providing independent artists
              with professional-grade tools that were previously only accessible
              to major label artists—all in one affordable platform.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={i}
                className="text-center hover-lift dark:bg-gray-900 dark:border-gray-700"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
              <p>
                Max Booster started with a simple question: Why should
                independent artists pay for multiple expensive platforms when
                everything could work together seamlessly?
              </p>
              <p>
                We've built the industry's first truly unified platform that
                combines:
              </p>
              ...
              <p>
                Instead of juggling subscriptions to DistroKid ($20), BeatStars
                ($30), Studio One ($400), Hootsuite ($100), and various ad
                platforms ($200+), you get everything in Max Booster for just
                $49/month.
              </p>
              <p className="font-medium text-blue-600">
                Save over $500/month while getting better tools and a unified
                workflow.
              </p>
            </div>
          </div>
