              ...
              <form onSubmit={handleUpdateProject} className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setEditForm((prev) => ({ ...prev, genre: value }))
                    }
                  >
                    <SelectTrigger>
                  ...
                  >
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                setLocation(`/analytics?project=${project.id}`)
                              }
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <Badge
                            ...
                            className={getStatusColor(
                              project.workflowStage || project.status,
                            )}
                          >
                      ...
                      >
                        ...
                        {project.workflowStage === "delivery" ||
      ...
      <div className="lg:col-span-1 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Dialog open={isNewDialogOpen} onOpenChange={setIsNewDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>New Songwriting Session</DialogTitle>
              </DialogHeader>
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setNewSession({ ...newSession, genre: v })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewSession({ ...newSession, key: e.target.value })
                      }
                    />
                  </div>
                </div>
                ...
                <div>
                  <Label>Mood</Label>
                  <Input
                    placeholder="melancholy, hype, romantic..."
                    value={newSession.mood}
                    onChange={(e) =>
                      setNewSession({ ...newSession, mood: e.target.value })
                    }
                  />
                </div>
                <Button
        ...
        {isLoading ? (
          ...
          sessions.map((s: Record<string, unknown>) => (
            <Card
              key={s.id}
              className={`cursor-pointer hover:shadow-md transition-shadow ${selectedSession?.id === s.id ? "border-blue-500 shadow-md" : ""}`}
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {s.genre} • {s.key} • {s.bpm} BPM
                    </p>
                    {s.mood && (
                      <p className="text-xs text-gray-400 mt-1">{s.mood}</p>
                    )}
                  </div>
        ...
        {selectedSession ? (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Song ideas, references, production notes..."
                ...
                <CardContent>
                  <div className="flex gap-2 mb-3">
                    <Input
                      ...
                      onKeyDown={(e) => e.key === "Enter" && getRhymes()}
                    />
                    <Button size="sm" onClick={getRhymes}>
                      Find
                    </Button>
                  </div>
                  {rhymes.length > 0 && (
                      ...
                      {rhymes.map((r) => (
                        <Badge
                          ...
                          onClick={() =>
                            setSelectedSession({
                              ...selectedSession,
                              lyrics: (selectedSession.lyrics || "") + " " + r,
                            })
                          }
                        >
                          {r}
                  ...
                  {aiChord && (
                    <p className="text-xs text-gray-500 mt-3 border-t pt-2">
                      <span className="font-medium">Suggested chords:</span>{" "}
                      {aiChord}
                    </p>
                  )}
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-2">
                    {SONG_STRUCTURES.map((s, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-2 p-2 bg-gray-50 dark:bg-gray-800 rounded text-xs cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/20"
                        onClick={() =>
                          setSelectedSession({
                            ...selectedSession,
          ...
          <Card className="p-12 text-center">
            ...
            <p className="text-sm text-gray-400">
              Choose a session from the list or create a new one to start
              writing
            </p>
          </Card>
        )}
