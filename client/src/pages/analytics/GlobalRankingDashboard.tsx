...
const ScoreGauge = memo(
  ({ score, size = 200 }: { score: number; size?: number }) => {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Rank #{platform.rank.toLocaleString()}
          </p>
        </div>
      </div>
...
const RankingHistoryChart = memo(
  ({ history }: { history: RankingHistory[] }) => {
...
const SimilarArtistsComparison = memo(
  ({
    artists,
    currentScore,
  }: {
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Rank #{artist.rank.toLocaleString()}
                  </p>
                </div>
                <div className="w-20">
                  {artist.comparison === "ahead" ? (
...
export default function GlobalRankingDashboard({
  ...
  const platformScores: PlatformScore[] =
    propPlatformScores || rankingData?.platformScores || [];
  const rankingHistory: RankingHistory[] =
    propRankingHistory || rankingData?.rankingHistory || [];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-1">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Your overall performance rating (0-100)
            </CardDescription>
          </CardHeader>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How you compare to artists in your genre
            </CardDescription>
          </CardHeader>
          <CardContent>
