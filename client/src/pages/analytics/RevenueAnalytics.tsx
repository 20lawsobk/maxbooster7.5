...
const EarningsCard = memo(
  ({
    ...
    const variantClasses = {
      ...
      warning:
        "bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20 border-red-200",
    };
        ...
        <Card className={cn("border", variantClasses[variant])}>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              ...
              <div
                className={cn(
                  "p-2.5 rounded-lg bg-white/50 dark:bg-slate-800/50",
                  iconClasses[variant],
                )}
              >
...
export function RevenueAnalytics({
  ...
  const revenueBreakdown = useMemo<RevenueBreakdown[]>(() => {
    ...
    return data.revenue.revenueByPlatform.map((p: Record<string, unknown>) => ({
      ...
      change: p.change || 0,
      color:
        PLATFORM_COLORS[p.platform.toLowerCase().replace(" ", "_")] ||
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Track earnings, royalties, and payout status
          </p>
        </div>
        <DateRangePicker
          value={timeRange}
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Revenue distribution across streaming platforms
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Earnings and rate per stream by platform
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between text-xs text-muted-foreground">
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            <Badge
                              variant={
                                platform.change > 0 ? "default" : "secondary"
                              }
        ...
        <TabsContent value="royalties" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Understanding your different revenue streams
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Withholding and deductions for this period
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <div className="p-4 rounded-lg bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200">
                    ...
                    <p className="text-3xl font-bold text-green-600">
                      ${taxInfo.grossEarnings.toLocaleString()}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">
                        Tax Withheld ({taxInfo.taxRate}%)
                      </p>
                      <p className="text-xl font-bold text-red-600">
                        -${taxInfo.taxWithheld.toLocaleString()}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200">
                    ...
                    <p className="text-3xl font-bold text-blue-600">
                      ${taxInfo.netEarnings.toLocaleString()}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Download your tax forms and reports
                </CardDescription>
              </CardHeader>
              <CardContent>
