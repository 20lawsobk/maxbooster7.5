                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Avatar>
                            ...
                            <AvatarFallback>
                              {(request.name || "UN").slice(0, 2).toUpperCase()}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              declineConnectionMutation.mutate(request.id)
                            }
                          >
                            <X className="h-4 w-4" />
                          </Button>
                          <Button
                            size="sm"
                            onClick={() =>
                              acceptConnectionMutation.mutate(request.id)
                            }
                          >
                            ...
                            {connection.genres &&
                              connection.genres.length > 0 && (
                                <div className="flex items-center gap-2">
                                  ...
                                  <span>
                                    {connection.genres.slice(0, 3).join(", ")}
                                  </span>
                                </div>
                              )}
                            {connection.location && (
              ...
              <TabsContent value="projects" className="space-y-4">
                ...
                {projects.length === 0 ? (
                  <Card className="p-8 text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Start a project with your connections to collaborate on
                      music
                    </p>
                    <Button
                      className="mt-4"
            ...
            >
              <DialogContent className="max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Create a shared workspace for you and your collaborators to
                ...
                {selectedUser && (
                  <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg">
                    <Avatar>
                      ...
                      <AvatarFallback>
                        {(selectedUser.name || "UN").slice(0, 2).toUpperCase()}
                      </AvatarFallback>
                    </Avatar>
                    <div>
