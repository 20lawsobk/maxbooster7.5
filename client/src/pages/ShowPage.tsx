  ...
  useEffect(() => {
    if (savedSetlists && savedSetlists.length > 0) {
      ...
      if (Array.isArray(latest.tracks) && latest.tracks.length > 0) {
        setSetlist(
          latest.tracks.map((t: Record<string, unknown>, i: number) => ({
            id: String(t.id || i + 1),
            title: t.title,
            artist: t.artist || "",
            duration:
              typeof t.duration === "string"
                ? parseInt(t.duration) || 240
                : t.duration || 240,
            bpm: t.bpm || 120,
            key: t.key || "",
            notes: t.notes || "",
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className={
                      remoteControlEnabled ? "text-green-400" : "text-gray-400"
                    }
                  >
            ...
            <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-3xl mt-4 text-white">
                  {setlist[currentSongIndex + 1]?.title}
                </div>
                <div className="text-xl text-gray-400 mt-2">
                  {setlist[currentSongIndex + 1]?.bpm} BPM •{" "}
                  {setlist[currentSongIndex + 1]?.key}
                </div>
              </div>
            </div>
          )}
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
              <div className="h-20 bg-gray-900/50 border-b border-gray-800 flex items-center justify-center gap-4 shrink-0">
                ...
                <Button
                  ...
                  className={
                    metronomeEnabled ? "bg-blue-600 hover:bg-blue-700" : ""
                  }
                >
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            setTeleprompterFontSize((s) => Math.max(16, s - 4))
                          }
                        >
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            setTeleprompterFontSize((s) => Math.min(64, s + 4))
                          }
                        >
                  ...
                  <div className="w-80 bg-gray-900 border-l border-gray-800 flex flex-col shrink-0">
                    <div className="p-3 border-b border-gray-800 flex items-center justify-between">
                      ...
                      <Button
                        ...
                        size="icon"
                        className="h-7 w-7"
                        onClick={() => setEffectsPanelVisible(false)}
                      >
                        <EyeOff className="w-4 h-4" />
                      </Button>
                    </div>
                      ...
                      <div className="p-4 space-y-6">
                        <div>
                          <Label className="text-xs text-gray-400 mb-3 flex items-center justify-between">
                            ...
                            <span className="font-mono">
                              {Math.round(effectValues.masterVolume * 100)}%
                            </span>
                          </Label>
                          <Slider
                        ...
                        <div>
                          <Label className="text-xs text-gray-400 mb-3 flex items-center justify-between">
                            ...
                            <span className="font-mono">
                              {Math.round(effectValues.reverbMix * 100)}%
                            </span>
                          </Label>
                          <Slider
                            ...
                            step={0.01}
                            onValueChange={([v]) =>
                              setEffectValues((p) => ({ ...p, reverbMix: v }))
                            }
                          />
                        </div>
                        ...
                        <div>
                          <Label className="text-xs text-gray-400 mb-3 flex items-center justify-between">
                            <span>Delay Mix</span>
                            <span className="font-mono">
                              {Math.round(effectValues.delayMix * 100)}%
                            </span>
                          </Label>
                          <Slider
                            ...
                            step={0.01}
                            onValueChange={([v]) =>
                              setEffectValues((p) => ({ ...p, delayMix: v }))
                            }
                          />
                        </div>
                        ...
                        <div>
                          <Label className="text-xs text-gray-400 mb-3 flex items-center justify-between">
                            ...
                            <span className="font-mono">
                              {Math.round(effectValues.compression * 100)}%
                            </span>
                          </Label>
                          <Slider
                            ...
                            step={0.01}
                            onValueChange={([v]) =>
                              setEffectValues((p) => ({ ...p, compression: v }))
                            }
                          />
                        </div>
                          ...
                          <div className="flex justify-between gap-4">
                            <div className="flex-1 text-center">
                              ...
                              <div className="text-xs font-mono mt-1">
                                {effectValues.eqLow > 0 ? "+" : ""}
                                {effectValues.eqLow}dB
                              </div>
                            </div>
                            <div className="flex-1 text-center">
                              <div className="text-xs text-gray-500 mb-1">
                              ...
                              />
                              <div className="text-xs font-mono mt-1">
                                {effectValues.eqMid > 0 ? "+" : ""}
                                {effectValues.eqMid}dB
                              </div>
                            </div>
                            <div className="flex-1 text-center">
                              <div className="text-xs text-gray-500 mb-1">
                              ...
                              />
                              <div className="text-xs font-mono mt-1">
                                {effectValues.eqHigh > 0 ? "+" : ""}
                                {effectValues.eqHigh}dB
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div className="absolute bottom-4 right-4 flex gap-2">
                  ...
                  {!effectsPanelVisible && (
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => setEffectsPanelVisible(true)}
                    >
            ...
            <DialogContent className="bg-gray-900 border-gray-800 text-white max-w-md">
              ...
              <div className="space-y-6 py-4">
                ...
                <div>
                  ...
                  <Select
                    value={clickTrackOutput}
                    onValueChange={setClickTrackOutput}
                  >
                ...
                {remoteControlEnabled && (
                  <div className="p-3 bg-gray-800 rounded-lg">
                    ...
                    <div className="text-xs text-gray-500">
                      Open the Max Booster companion app on your tablet or phone
                      to connect. Make sure both devices are on the same
                      network.
                    </div>
                    <Badge
                      variant="outline"
              ...
              <div className="space-y-4 py-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewSongForm((f) => ({ ...f, title: e.target.value }))
                    }
                  />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewSongForm((f) => ({ ...f, key: e.target.value }))
                      }
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setNewSongForm((f) => ({ ...f, notes: e.target.value }))
                    }
                  />
                </div>
              </div>
              <DialogFooter>
                ...
                <Button
                  onClick={() => {
                    ...
                    toast({
                      title: "Song added",
                      description: `"${newSong.title}" added to setlist`,
                    });
                  }}
                >
                  Add Song
