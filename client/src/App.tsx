...
const NPSSurvey = lazy(() =>
  import("@/components/retention/NPSSurvey").then((m) => ({
    default: m.NPSSurvey,
  })),
);
const AIAssistantPublic = lazy(() =>
  import("@/components/support/AIAssistantPublic").then((m) => ({
    default: m.AIAssistantPublic,
  })),
);
const AIAssistantPersonalized = lazy(() =>
  import("@/components/support/AIAssistantPersonalized").then((m) => ({
    default: m.AIAssistantPersonalized,
  })),
);
const InstallBanner = lazy(() =>
  import("@/components/pwa/InstallBanner").then((m) => ({
    default: m.InstallBanner,
  })),
);
const DeepLinkHandler = lazy(() =>
  import("@/components/DeepLinkHandler").then((m) => ({
    default: m.DeepLinkHandler,
  })),
);
const OAuthCallbackHandler = lazy(() =>
  import("@/components/OAuthCallbackHandler").then((m) => ({
    default: m.OAuthCallbackHandler,
  })),
);
const UndoToast = lazy(() =>
  import("@/components/undo/UndoToast").then((m) => ({ default: m.UndoToast })),
);
const CommandPalette = lazy(() =>
  import("@/components/commands/CommandPalette").then((m) => ({
    default: m.CommandPalette,
  })),
);
const ShortcutGuide = lazy(() =>
  import("@/components/shortcuts").then((m) => ({ default: m.ShortcutGuide })),
);
const QuickActionBar = lazy(() =>
  import("@/components/shortcuts").then((m) => ({ default: m.QuickActionBar })),
);
const ConnectionStatusBar = lazy(() =>
  import("@/components/ConnectionStatusBar").then((m) => ({
    default: m.ConnectionStatusBar,
  })),
);
...
const MusicWorkflowAutomations = lazy(
  () => import("@/pages/MusicWorkflowAutomations"),
);
  ...
  return (
    <Switch>
      ...
      <Route
        ...
        component={MusicWorkflowAutomations}
      />
...
function isNativeApp(): boolean {
  return (
    !!(window as Record<string, unknown>).electronAPI?.isElectron ||
...
function AppWithKeyboardShortcuts() {
  ...
  useEffect(() => {
    const metaEl = document.querySelector(
      'meta[name="x-maxbooster-subdomain"]',
    );
    const storefrontSlug =
      metaEl?.getAttribute("content") ||
      (window as Record<string, unknown>).__MAXBOOSTER_SUBDOMAIN__;
