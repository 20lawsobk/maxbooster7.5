    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          type: "deesser",
          bypass: false,
          parameters: { frequency: 6000, threshold: -20, range: 6 },
        },
      ],
      sends: [
      ...
      effects: [
        {
          ...
          type: "compressor",
          bypass: false,
          parameters: { threshold: -15, ratio: 3, attack: 15, release: 120 },
        },
        {
          id: "vd-chorus",
          name: "Stereo Chorus",
        ...
        },
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 150, midGain: 0, highGain: 1 },
        },
      ],
      sends: [
    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          type: "compressor",
          bypass: false,
          parameters: { threshold: -10, ratio: 4, attack: 5, release: 50 },
        },
        {
          id: "kick-sat",
          name: "Saturation",
  ...
  },
  {
    ...
    data: {
      ...
      effects: [
        ...
        {
          id: "snare-comp",
          name: "Snare Compressor",
          type: "compressor",
          bypass: false,
          parameters: { threshold: -15, ratio: 3, attack: 3, release: 80 },
        },
      ],
      sends: [
        {
    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          type: "compressor",
          bypass: false,
          parameters: { threshold: -12, ratio: 2, attack: 10, release: 60 },
        },
      ],
      sends: [],
      outputBus: "drum-bus",
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 200, lowGain: -3, midGain: 0, highGain: 2 },
        },
        {
          id: "oh-comp",
    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          type: "compressor",
          bypass: false,
          parameters: { threshold: -14, ratio: 4, attack: 10, release: 100 },
        },
        {
          id: "bass-sat",
          name: "Tube Warmth",
    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowBoost: 50, lowGain: 2, lowCut: 30, midGain: 0 },
        },
        {
          id: "808-lim",
          name: "808 Limiter",
          type: "limiter",
          bypass: false,
          parameters: { ceiling: -1, release: 50 },
        },
      ],
      sends: [],
      outputBus: "bass-bus",
    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          type: "compressor",
          bypass: false,
          parameters: { threshold: -12, ratio: 2, attack: 20, release: 150 },
        },
      ],
      sends: [
        {
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 100, midGain: 1, highGain: 2 },
        },
        {
          id: "cgtr-chorus",
          name: "Subtle Chorus",
        ...
        },
        {
          ...
          type: "compressor",
          bypass: false,
          parameters: { threshold: -10, ratio: 2, attack: 25, release: 100 },
        },
      ],
      sends: [
        { busId: "reverb-bus", busName: "Reverb", level: 0.2, preFader: false },
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 150, midGain: 2, highGain: 3 },
        },
        {
          id: "sl-comp",
          name: "Lead Compression",
          type: "compressor",
          bypass: false,
          parameters: { threshold: -12, ratio: 3, attack: 10, release: 80 },
        },
      ],
      sends: [
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 100, lowGain: -2, midGain: 0, highGain: 1 },
        },
        {
          id: "sp-chorus",
          name: "Wide Chorus",
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowBoost: 60, lowGain: 3, midGain: -1, highGain: 0 },
        },
        {
          id: "sb-comp",
          ...
          type: "compressor",
          bypass: false,
          parameters: { threshold: -12, ratio: 4, attack: 8, release: 60 },
        },
        {
          id: "sb-sat",
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowGain: 0, midGain: 1, highGain: 2 },
        },
        {
          id: "piano-comp",
          name: "Light Compression",
          type: "compressor",
          bypass: false,
          parameters: { threshold: -15, ratio: 2, attack: 20, release: 150 },
        },
      ],
      sends: [
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowGain: 1, midGain: 0, highGain: 2 },
        },
        {
          id: "ep-chorus",
          name: "Classic Chorus",
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 80, lowGain: 0, midGain: 1, highGain: 2 },
        },
      ],
      sends: [
        { busId: "reverb-bus", busName: "Reverb", level: 0.4, preFader: false },
    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          bypass: false,
          preset: "drum-glue",
          parameters: { threshold: -8, ratio: 4, attack: 10, release: 100 },
        },
        {
          id: "db-sat",
    ...
    data: {
      ...
      effects: [
        ...
        },
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 60, highGain: 1 },
        },
      ],
      sends: [
        {
      ...
      effects: [
        {
          ...
          type: "eq",
          bypass: false,
          parameters: { lowCut: 200, highGain: 4 },
        },
      ],
      sends: [
...
export function importPresets(jsonString: string): {
  ...
  try {
    ...
    return {
      success: false,
      presets: [],
      error: `Failed to parse preset file: ${err}`,
    };
  }
}
