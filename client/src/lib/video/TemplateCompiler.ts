...
function compileTemplateToCompiledTemplate(
  ...
  switch (options.type) {
    ...
    default:
      throw new Error(
        `Unknown template type: ${(options as Record<string, unknown>).type}`,
      );
  }
}
...
function convertBackgroundConfig(
...
function convertVisualizerConfig(
  config: Record<string, unknown>,
): VisualizerConfig {
  return {
  ...
  switch (type) {
    case "release":
      return {
        ...
        type: "release",
        artistName:
          (partial as Partial<ReleaseAnnouncementOptions>).artistName ||
          "Artist Name",
        releaseName:
          (partial as Partial<ReleaseAnnouncementOptions>).releaseName ||
          "Release Title",
        releaseType:
          (partial as Partial<ReleaseAnnouncementOptions>).releaseType ||
          "single",
        releaseDate:
          (partial as Partial<ReleaseAnnouncementOptions>).releaseDate ||
          "Coming Soon",
        coverArtUrl: (partial as Partial<ReleaseAnnouncementOptions>)
          .coverArtUrl,
    ...
    case "tour":
      return {
        ...
        type: "tour",
        tourName:
          (partial as Partial<TourEventOptions>).tourName || "Tour Name",
        artistName:
          (partial as Partial<TourEventOptions>).artistName || "Artist Name",
    ...
    case "bts":
      return {
        ...
        type: "bts",
        title:
          (partial as Partial<BehindTheScenesOptions>).title ||
          "Behind The Scenes",
        artistName:
          (partial as Partial<BehindTheScenesOptions>).artistName ||
          "Artist Name",
        mediaClips:
          (partial as Partial<BehindTheScenesOptions>).mediaClips || [],
    ...
    case "quote":
      return {
        ...
        type: "quote",
        quote:
          (partial as Partial<QuoteLyricOptions>).quote || "Your quote here...",
        artistName:
          (partial as Partial<QuoteLyricOptions>).artistName || "Artist Name",
        quotationStyle:
          (partial as Partial<QuoteLyricOptions>).quotationStyle || "minimal",
    ...
    case "countdown":
      return {
        ...
        artistName:
          (partial as Partial<CountdownTimerOptions>).artistName ||
          "Artist Name",
        timerStyle:
          (partial as Partial<CountdownTimerOptions>).timerStyle || "digital",
        showLabels:
          (partial as Partial<CountdownTimerOptions>).showLabels ?? true,
    ...
    case "split":
      return {
        ...base,
        type: "split",
        leftContent: (partial as Partial<SplitScreenOptions>).leftContent || {
          title: "Left",
        },
        rightContent: (partial as Partial<SplitScreenOptions>).rightContent || {
          title: "Right",
        },
        dividerStyle:
          (partial as Partial<SplitScreenOptions>).dividerStyle || "solid",
        comparisonType:
          (partial as Partial<SplitScreenOptions>).comparisonType ||
          "side-by-side",
    ...
    case "teaser":
      return {
        ...
        type: "teaser",
        hookText:
          (partial as Partial<SocialTeaserOptions>).hookText ||
          "Coming Soon...",
        mainContent:
          (partial as Partial<SocialTeaserOptions>).mainContent || "Stay Tuned",
        artistName:
          (partial as Partial<SocialTeaserOptions>).artistName || "Artist Name",
        contentType:
          (partial as Partial<SocialTeaserOptions>).contentType ||
          "announcement",
        teaserLength:
          (partial as Partial<SocialTeaserOptions>).teaserLength || 15,
