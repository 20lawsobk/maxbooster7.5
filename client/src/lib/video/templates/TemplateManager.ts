...
const TEMPLATE_REGISTRY: Map<string, TemplateMetadata> = new Map([
  [
    "release-announcement",
    {
      ...
      description:
        "Announce your new single, album, or EP with stunning visuals and cover art reveal",
      type: "release",
  ...
  [
    "tour-event",
    {
      ...
      description:
        "Showcase your upcoming tour dates and events with dynamic date reveals",
      type: "tour",
      category: "event",
  ...
  [
    "behind-the-scenes",
    {
      ...
      description:
        "Share exclusive behind-the-scenes footage with authentic, documentary-style edits",
      type: "bts",
      category: "content",
  ...
  [
    "quote-lyric",
    {
      ...
      description:
        "Feature powerful lyrics or quotes with beautiful typography and animations",
      type: "quote",
      category: "content",
  ...
  [
    "countdown-timer",
    {
      ...
      description:
        "Build anticipation with dynamic countdown timers for releases and events",
      type: "countdown",
      category: "engagement",
  ...
  [
    "split-screen",
    {
      ...
      description:
        "Compare before/after, versions, or create engaging VS content",
      type: "split",
      category: "comparison",
  ...
  [
    "social-teaser",
    {
      ...
      description:
        "Short, punchy teasers optimized for social media engagement",
      type: "teaser",
      category: "engagement",
...
export class TemplateManager {
  ...
  private mergeBackground(
    override?: Partial<BackgroundConfig>,
    palette?: ColorPalette,
  ): BackgroundConfig {
    return {
  ...
  getSupportedAspectRatios(): Record<
    AspectRatio,
