import { BasePlugin } from './plugins/built-in plugins dsp/BasePlugin';
import { CompressorPlugin } from './plugins/built-in plugins dsp/CompressorPlugin';
import { EQPlugin } from './plugins/built-in plugins dsp/EQPlugin';
import { ReverbPlugin } from './plugins/built-in plugins dsp/ReverbPlugin';
import { DelayPlugin } from './plugins/built-in plugins dsp/DelayPlugin';
import { DistortionPlugin } from './plugins/built-in plugins dsp/DistortionPlugin';
import { ChorusPlugin } from './plugins/built-in plugins dsp/ChorusPlugin';
import { FlangerPlugin } from './plugins/built-in plugins dsp/FlangerPlugin';
import { PhaserPlugin } from './plugins/built-in plugins dsp/PhaserPlugin';
import { DeEsserPlugin } from './plugins/built-in plugins dsp/DeEsserPlugin';
import { VocoderPlugin } from './plugins/built-in plugins dsp/VocoderPlugin';
import { DynamicEQPlugin } from './plugins/built-in plugins dsp/DynamicEQPlugin';
