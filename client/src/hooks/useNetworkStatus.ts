...
export function useNetworkStatus(options: UseNetworkStatusOptions = {}): NetworkState & {
  ...
  }, [checkConnection, scheduleReconnect, pingInterval, showToasts, onOnline, onOffline, onSlow, getConnectionInfo]);
...
export function useRetryWithBackoff<T>(
  ...
  const execute = useCallback(async (): Promise<T | null> => {
    ...
    return null;
  }, [fn, maxRetries, initialDelay, maxDelay, onRetry, onSuccess, onFailure, error]);
