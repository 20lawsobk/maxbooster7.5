...
export const categoryConfig: Record<NotificationCategory, { label: string; description: string; emoji: string }> = {
  account_security:   { label: 'Security & Account',     description: 'Login alerts, 2FA, password changes, subscriptions',                      emoji: '🔐' },
  distribution:       { label: 'Distribution',            description: 'Release status, uploads, streams, AI processing',                          emoji: '🎵' },
  social_media:       { label: 'Social Scheduling',       description: 'Post scheduling, publishing, and autopilot activity',                       emoji: '📅' },
  direct_interaction: { label: 'Direct Interactions',     description: 'Likes, comments, replies, mentions, DMs, and follows',                     emoji: '❤️' },
  platform_generated: { label: 'Platform Suggestions',    description: 'Suggested accounts, trending topics, group activity, events',              emoji: '🔥' },
  content_based:      { label: 'Content Updates',         description: 'New posts from people you follow, live streams, recommended content',      emoji: '📝' },
  engagement_summary: { label: 'Engagement Summaries',    description: 'Post performance milestones, story reactions, and activity digests',       emoji: '📊' },
  location_based:     { label: 'Location & Local',        description: 'Nearby events and content trending in your area',                          emoji: '📍' },
  marketplace:        { label: 'Marketplace',             description: 'Purchases, sales, reviews, offers, and beat play milestones',              emoji: '🛍️' },
  royalties:          { label: 'Royalties & Payments',    description: 'Incoming payments, payout status, and royalty statements',                 emoji: '💰' },
  collaboration:      { label: 'Collaboration',           description: 'Project invites, comments, and mentions from collaborators',               emoji: '🤝' },
  achievements:       { label: 'Achievements',            description: 'Badges, streaks, and career milestones',                                   emoji: '🏆' },
  system:             { label: 'System & Platform',       description: 'Maintenance, updates, storage warnings, and ad campaigns',                 emoji: '⚙️' },
  platform_admin:     { label: 'Platform Admin',          description: 'Admin-only: new users, health alerts, flagged accounts, reports',          emoji: '🛠️' },
};
