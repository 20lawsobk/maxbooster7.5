      ...
      <TabsContent value="visual" className="space-y-4 mt-4">
        <div className="space-y-2">
          ...
          <Select
            value={highContrast.contrastMode}
            onValueChange={(value) =>
              highContrast.setContrastMode(value as ContrastMode)
            }
          >
            <SelectTrigger>
              <SelectValue />
      ...
      <TabsContent value="keyboard" className="space-y-4 mt-4">
        <div className="rounded-lg border p-4 space-y-2">
          ...
          <ul className="text-sm space-y-1 text-muted-foreground">
            <li>
              <kbd className="px-1 rounded bg-muted">Alt+1</kbd> - Skip to main
              content
            </li>
            <li>
              <kbd className="px-1 rounded bg-muted">Alt+2</kbd> - Skip to
              navigation
            </li>
            <li>
              <kbd className="px-1 rounded bg-muted">?</kbd> - Show all
              shortcuts
            </li>
            <li>
              <kbd className="px-1 rounded bg-muted">Tab</kbd> - Navigate
              forward
            </li>
            <li>
              <kbd className="px-1 rounded bg-muted">Shift+Tab</kbd> - Navigate
              backward
            </li>
            <li>
              <kbd className="px-1 rounded bg-muted">Escape</kbd> - Close
              dialogs/modals
            </li>
          </ul>
        </div>
