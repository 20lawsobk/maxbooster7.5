...
const RETENTION_OFFERS: Partial<
  Record<CancelReason, { title: string; description: string }>
> = {
  too_expensive: {
    title: "Before you go — 30% off for 3 months?",
    description:
      "We'd hate to lose you over price. Use code STAY30 at checkout for 30% off your next 3 months.",
  },
  not_using_enough: {
    title: "How about pausing instead?",
    description:
      "You can pause your subscription for up to 3 months and resume any time — no data loss, no setup.",
  },
  temporary_pause: {
    title: "Pause, don't cancel",
    description:
      "No need to cancel — you can pause your subscription and come back whenever your schedule allows.",
  },
};
...
export function CancellationModal({
  ...
  const feedbackMutation = useMutation({
    mutationFn: (data: object) =>
      apiRequest("POST", "/api/retention/cancellation-feedback", data),
  });
        ...
        {step === "reason" && (
          <div className="space-y-4">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              We're sorry to see you go. Understanding why helps us improve for
              all artists.
            </p>
        ...
        {step === "confirm" && (
          <div className="space-y-4">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <strong>{currentPlan}</strong> plan? You'll lose access to premium
