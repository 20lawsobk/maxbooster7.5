    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            <div className={cn('absolute inset-0 bg-gradient-to-br opacity-95', rarityStyle.bg)} />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <span className={cn('text-xs font-medium uppercase tracking-wider', rarityStyle.text)}>
    ...
    >
      <div
        className={cn(
          ...
          isUnlocked
            ? cn('bg-gradient-to-br', rarityStyle.bg, 'shadow-lg', rarityStyle.glow)
            : 'bg-muted'
        )}
      >
        {isUnlocked ? (
