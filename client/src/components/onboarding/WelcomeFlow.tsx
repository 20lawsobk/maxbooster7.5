...
export default function WelcomeFlow({
  ...
  const completeMutation = useMutation({
    mutationFn: async (welcomeData: WelcomeData) => {
      const response = await apiRequest('POST', '/api/onboarding/complete-welcome', {
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-2 pt-4">
              {['AI Studio', 'Distribution', 'Marketing', 'Analytics'].map((feature, i) => (
                <motion.div
                  key={feature}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {ARTIST_TYPES.map((type) => {
                ...
                return (
                  ...
                  >
                    {isSelected && (
                      <div className={cn('absolute inset-0 opacity-10 bg-gradient-to-br', type.color)} />
                    )}
        ...
        return (
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-muted-foreground max-w-md mx-auto">
                Your profile is complete. You're ready to start your journey with Max Booster.
              </p>
            </div>
...
export function useWelcomeFlow() {
  ...
  const { data: loginStatus } = useQuery<{ isFirstLogin: boolean; showWelcomeWizard: boolean }>({
