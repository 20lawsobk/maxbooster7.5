                  ...
                  <button
                    ...
                    onClick={() =>
                      handleVisibilityChange(
                        option.value as "public" | "private" | "connections",
                      )
                    }
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleToggle("allowSearchIndexing", checked)
                }
              />
            </div>
          </div>
        ...
        <CardContent className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              ...
              export your personal data. You can manage your consent preferences
              below.
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleToggle("gdprMarketing", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleToggle("gdprAnalytics", checked)
                }
              />
            </div>
          </div>
