        ...
        <TabsContent value="design" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setValue("theme.textColor", e.target.value)
                      }
                      placeholder="#FFFFFF"
                    />
                  </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Capture fan emails for your mailing list
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setValue("collectEmails", checked)
                  }
                />
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {AVAILABLE_PLATFORMS.map((platform, index) => {
                ...
                const isEnabled =
                  watchedValues.platforms?.[index]?.enabled || false;
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-muted rounded-lg">
                <p className="text-sm text-muted-foreground">
                  Social links will appear as share buttons on your HyperFollow
                  page, making it easy for fans to share your release.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                <p className="text-sm">
                  <strong>Pro Tip:</strong> Analytics are updated in real-time.
                  Track which platforms your fans prefer and optimize your
                  marketing strategy.
                </p>
              </div>
            </CardContent>
      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              This is how your HyperFollow page will look
            </DialogDescription>
          </DialogHeader>
          ...
          <div
            ...
            style={{
              backgroundColor:
                watchedValues.theme?.backgroundColor || "#0F0F0F",
            ...
            <div className="p-6 space-y-4">
              <div className="text-center space-y-2">
                <h2 className="text-2xl font-bold">
                  {watchedValues.title || "Release Title"}
                </h2>
                <p className="text-lg">
                  {watchedValues.artistName || "Artist Name"}
                </p>
              ...
              <div className="space-y-2">
                {watchedValues.platforms
                  ?.filter((p) => p.enabled)
                  .map((platform) => {
                    const platformData = AVAILABLE_PLATFORMS.find(
                      (ap) => ap.id === platform.id,
                    );
                    ...
                    return (
                      <button
                        ...
                        style={{
                          backgroundColor:
                            watchedValues.theme?.primaryColor || "#8B5CF6",
                          borderRadius:
