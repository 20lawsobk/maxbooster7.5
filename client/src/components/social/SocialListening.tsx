...
export function SocialListening() {
  ...
  const handleToggleAlerts = (_id: string, enabled: boolean) => {
    toast({
      ...
      description: enabled
        ? "You will receive notifications for this keyword."
        : "Notifications disabled for this keyword.",
    });
  };
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium">
                          {Math.round((100 - avgSentiment) * 0.7)}%
                        </span>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium">
                          {Math.round((100 - avgSentiment) * 0.3)}%
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {trending
                      .slice(0, 5)
                      .map((topic: TrendingTopic, index: number) => (
                        <div key={topic.id} className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-muted-foreground">
                              {formatNumber(topic.volume)} mentions
                            </p>
                          </div>
                          <div
                            className={`flex items-center gap-1 ${topic.volumeChange >= 0 ? "text-green-500" : "text-red-500"}`}
                          >
                            {topic.volumeChange >= 0 ? (
                              <TrendingUp className="w-4 h-4" />
                            ) : (
                              <TrendingDown className="w-4 h-4" />
                            )}
                            <span className="text-sm">
                              {Math.abs(topic.volumeChange)}%
                            </span>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold">
                          {formatNumber(keyword.mentionCount)}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          mentions
                        </p>
                      ...
                      <div className="w-32">
                        <div className="flex items-center gap-1 mb-1">
                          <div
                            ...
                            style={{ width: `${keyword.sentiment.positive}%` }}
                          />
                          <div
                            className="flex-1 h-2 rounded bg-yellow-500"
                            style={{ width: `${keyword.sentiment.neutral}%` }}
                          />
                          <div
                            className="flex-1 h-2 rounded bg-red-500"
                            style={{ width: `${keyword.sentiment.negative}%` }}
                          />
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              handleToggleAlerts(keyword.id, checked)
                            }
                          />
          ...
          <TabsContent value="influencers" className="mt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {influencers.map((influencer: Influencer) => {
                const PlatformIcon =
                  PLATFORM_CONFIG[
                    influencer.platform as keyof typeof PLATFORM_CONFIG
                  ]?.icon;
                const SentimentIcon =
                  SENTIMENT_CONFIG[influencer.sentiment].icon;
                  ...
                  <Card key={influencer.id}>
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between mt-4">
                        ...
                        <Badge
                          className={`${SENTIMENT_CONFIG[influencer.sentiment].bg} ${SENTIMENT_CONFIG[influencer.sentiment].color}`}
                        >
              ...
              {alerts.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground">
                    Your brand mentions are within normal parameters
                  </p>
                </div>
              ) : (
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm">
                            ...
                            <span
                              className={`flex items-center gap-1 ${alert.sentiment >= 0 ? "text-green-500" : "text-red-500"}`}
                            >
                              {alert.sentiment >= 0 ? (
                                <TrendingUp className="w-4 h-4" />
                              ) : (
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Monitor mentions, hashtags, or keywords across social media
              platforms.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: "keyword" | "hashtag" | "mention") =>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (isSelected) {
                          setNewKeyword({
                            ...newKeyword,
                            platforms: newKeyword.platforms.filter(
                              (p) => p !== key,
                            ),
                          });
                        } else {
