    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
          ...
          <div className="p-2 border-t border-slate-800">
            ...
            {history.map((item: SearchHistoryItem) => (
              ...
              >
                ...
                <span className="text-sm text-slate-200 flex-1">{item.query}</span>
                <Button
                  type="button"
                  variant="ghost"
                  size="icon"
        ...
        {showTrending && trending.length > 0 && (
          <div className="p-2 border-t border-slate-800">
            <div className="px-2 py-1 text-xs font-medium text-slate-500 uppercase tracking-wider">Trending</div>
            {trending.map((item: TrendingSearch) => (
              ...
              >
                ...
                <Badge variant="secondary" className="text-xs">{item.searchCount}</Badge>
              </button>
            ))}
          </div>
        )}
