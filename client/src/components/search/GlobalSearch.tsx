              ...
              {suggestions.map((suggestion: AutocompleteSuggestion, index: number) => (
                ...
                >
                  ...
                  <span 
                    ...
                    dangerouslySetInnerHTML={{ __html: (typeof DOMPurify !== 'undefined' ? DOMPurify.sanitize((typeof DOMPurify !== 'undefined' ? DOMPurify.sanitize(suggestion.highlighted) : suggestion.highlighted)) : (typeof DOMPurify !== 'undefined' ? DOMPurify.sanitize(suggestion.highlighted) : suggestion.highlighted)) }}
                  />
                </button>
              ))}
            </div>
