...
export function AIAssistantPersonalized() {
  ...
  const getAIResponse = (userMessage: string): string => {
    ...
    if (
      ...
      lowerMessage.includes("apple music")
    ) {
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-400 font-normal flex items-center gap-1">
                  ...
                  {userTier !== "free" && (
                    <Badge
                      variant="outline"
                      className="ml-1 text-[10px] px-1 py-0 h-4 border-cyan-500/30 text-cyan-400"
                    >
                      {userTier}
                    </Badge>
                  )}
