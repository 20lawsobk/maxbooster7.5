...
const getDeclineReason = (
  ...
  if (declineCode === "expired_card" || code === "CARD_EXPIRED")
    return "expired_card";
  if (declineCode === "incorrect_cvc" || code === "CARD_VALIDATION_ERROR")
  ...
  if (code === "PAYMENT_DECLINED" || declineCode === "generic_decline")
    return "generic_decline";
  return "unknown";
};

const declineReasonConfig: Record<
  DeclineReason,
  {
...
> = {
  insufficient_funds: {
    ...
    description:
      "Your card doesn't have enough available credit. Please try a different card or add funds to your account.",
  ...
  expired_card: {
    ...
    title: "Card Expired",
    description:
      "The card on file has expired. Please update your payment method with a valid card.",
    actions: ["update_card"],
    severity: "error",
  },
  incorrect_cvc: {
    ...
    description:
      "The card security code (CVC) was incorrect. Please update your payment method.",
    actions: ["update_card"],
    severity: "error",
  },
  fraud_suspected: {
    ...
    description:
      "This transaction was flagged by your bank's fraud protection. Please contact your bank or try a different card.",
  ...
  processing_error: {
    ...
    description:
      "There was a temporary issue processing your payment. This usually resolves itself.",
  ...
  card_not_supported: {
    ...
    description:
      "This type of card is not supported. Please try a different Visa, Mastercard, or American Express.",
    actions: ["update_card"],
    severity: "error",
  },
  generic_decline: {
    ...
    title: "Card Declined",
    description:
      "Your card was declined. Please contact your bank for details or try a different card.",
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className={`${getIconColor()}`}>{config.icon}</div>
            <div>
