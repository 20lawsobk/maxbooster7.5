...
export function SpatialAudioMixer({
  ...
  const [speakerConfig, setSpeakerConfig] =
    useState<SpeakerConfiguration>(initialConfig);
  ...
  const updateObject = useCallback(
    (id: string, updates: Partial<AudioObject>) => {
      setObjects((prev) =>
  ...
  const handleCanvasMouseMove = (e: React.MouseEvent) => {
    if (!isDragging.current || !dragObjectId.current || !canvasRef.current)
      return;
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-700">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <Label htmlFor="binaural" className="text-xs text-gray-400">
              Binaural
            </Label>
            <Switch
              id="binaural"
            ...
            />
            <Headphones
              className={`w-4 h-4 ${binauralMode ? "text-green-400" : "text-gray-500"}`}
            />
          </div>
          ...
          <Select
            value={speakerConfig}
            onValueChange={(v) =>
              handleSpeakerConfigChange(v as SpeakerConfiguration)
            }
          >
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: getSpeakerTypeColor(speaker.type),
                    }}
                  >
              ...
              <div className="space-y-3">
                <div className="space-y-1">
                  ...
                  <Slider
                    ...
                    onValueChange={([v]) =>
                      updateObject(selectedObject.id, { x: v })
                    }
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <Slider
                    ...
                    onValueChange={([v]) =>
                      updateObject(selectedObject.id, { y: v })
                    }
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <Slider
                    ...
                    onValueChange={([v]) =>
                      updateObject(selectedObject.id, { z: v })
                    }
                  />
                </div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-gray-300">
                      {Math.round(selectedObject.volume * 100)}%
                    </span>
                  </div>
                  <Slider
                    min={0}
                    ...
                    onValueChange={([v]) =>
                      updateObject(selectedObject.id, { volume: v })
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      updateObject(selectedObject.id, { mute: v })
                    }
                  />
                  <Label htmlFor="mute" className="text-xs text-gray-400">
                    Mute
                  </Label>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      updateObject(selectedObject.id, { solo: v })
                    }
                  />
                  <Label htmlFor="solo" className="text-xs text-gray-400">
                    Solo
                  </Label>
                </div>
              </div>
