    ...
    <div className="flowstate-studio flex flex-col h-screen">
      ...
      <header className="flow-transport">
        ...
        <div className="flex items-center gap-4">
          <div className="flow-time-display">{formatTime(currentTime)}</div>
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <button
            className="flow-btn-ghost p-2 rounded-lg hover:bg-white/5"
            onClick={onSave}
          >
          ...
          <AnimatePresence>
            {activePanel && (
              ...
              >
                ...
                {activePanel === "sidechain" && (
                  <FlowStateSidechainVisualizer />
                )}
