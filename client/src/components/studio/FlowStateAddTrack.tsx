...
const TRACK_TYPES: TrackType[] = [
  ...
  },
  {
    ...
    description: "Drum patterns & beats",
    backendType: "midi",
  },
  {
    id: "guitar",
    ...
    description: "Guitar with amp simulation",
    backendType: "audio",
  },
  {
    id: "bus",
    ...
    description: "Route multiple tracks",
    backendType: "aux",
  },
  {
    id: "folder",
    ...
    description: "Organize track groups",
    backendType: "aux",
  },
];
...
export function FlowStateAddTrack({
  onAddTrack,
  onClose,
  isOpen,
  projectId,
  onCreateProject,
}: FlowStateAddTrackProps) {
  ...
  const handleCreate = async () => {
    ...
    const name =
      trackName.trim() ||
      `${selectedType.name} ${Date.now().toString(36).slice(-4).toUpperCase()}`;
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/50">
                    Choose a track type to get started
                  </p>
                </div>
              </div>
              <motion.button
                ...
                >
                  <div className="p-4 space-y-4">
                    ...
                    <motion.button
                      ...
                      disabled={
                        createTrackMutation.isPending || isCreatingProject
                      }
                      className={cn(
