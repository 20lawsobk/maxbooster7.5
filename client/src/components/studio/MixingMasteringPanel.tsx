...
interface MixingMasteringPanelProps {
  ...
  onMasterApplied?: (settings: MasterSettings, metrics: LoudnessMetrics) => void;
  className?: string;
}
...
export function MixingMasteringPanel({
  ...
  const handlePlatformChange = useCallback((platform: MasterSettings['platform']) => {
  ...
  return (
    <div className={cn("flex flex-col h-full bg-zinc-950 text-white", className)}>
      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">Professional audio processing</p>
          </div>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'mix' | 'master')} className="flex-1 flex flex-col">
        ...
        <TabsContent value="mix" className="flex-1 p-4 space-y-4 overflow-y-auto">
                ...
                <div key={band} className="flex flex-col items-center gap-1">
                  <div className="h-24 flex items-end">
                    <Slider
                      ...
                      onValueChange={([v]) => setMixSettings(s => ({
                        ...s,
                        eq: { ...s.eq, [band]: v }
                      }))}
                      min={-12}
                  ...
                  <span className="text-xs text-zinc-400">{band.replace('Mid', 'M')}</span>
                  <span className="text-xs font-mono text-zinc-500">
                    {mixSettings.eq[band] > 0 ? '+' : ''}{mixSettings.eq[band].toFixed(1)}
                  </span>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono">{mixSettings.compression.threshold} dB</span>
                </div>
                <Slider
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono">{mixSettings.compression.ratio}:1</span>
                </div>
                <Slider
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono">{mixSettings.compression.attack} ms</span>
                </div>
                <Slider
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono">{mixSettings.compression.release} ms</span>
                </div>
                <Slider
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-mono">{Math.round(mixSettings.stereoWidth * 100)}%</span>
            </div>
            <Slider
              value={[mixSettings.stereoWidth]}
              onValueChange={([v]) => setMixSettings(s => ({ ...s, stereoWidth: v }))}
              min={0}
              max={2}
              step={0.01}
            />
        ...
        <TabsContent value="master" className="flex-1 p-4 space-y-4 overflow-y-auto">
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 bg-zinc-900 rounded-lg text-center">
              <div className="text-xs text-zinc-500 mb-1">Integrated</div>
              <div className={cn(
                "text-lg font-mono font-bold",
                getLUFSColor(loudnessMetrics.integratedLUFS, masterSettings.targetLUFS)
              )}>
            ...
            <div className="p-3 bg-zinc-900 rounded-lg text-center">
              ...
              <div className={cn(
                "text-lg font-mono font-bold",
                loudnessMetrics.truePeak > masterSettings.truePeakLimit ? 'text-red-400' : 'text-green-400'
              )}>
          ...
          <div className="h-16 bg-zinc-900 rounded-lg flex items-center justify-around px-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm font-mono text-purple-400">{masterSettings.targetLUFS} LUFS</div>
            </div>
          </div>

          <div className="space-y-3">
            <Label className="text-sm font-medium">Target Platform</Label>
            <Select value={masterSettings.platform} onValueChange={handlePlatformChange}>
              <SelectTrigger className="bg-zinc-900 border-zinc-700">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="spotify">Spotify (-14 LUFS)</SelectItem>
                <SelectItem value="apple_music">Apple Music (-16 LUFS)</SelectItem>
                <SelectItem value="youtube">YouTube (-14 LUFS)</SelectItem>
                <SelectItem value="soundcloud">SoundCloud (-14 LUFS)</SelectItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={([v]) => setMasterSettings(s => ({ ...s, targetLUFS: v }))}
                  min={-24}
                  max={-6}
                  step={0.5}
                />
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-mono">{masterSettings.truePeakLimit} dB</span>
                </div>
                <Slider
                  value={[masterSettings.truePeakLimit]}
                  onValueChange={([v]) => setMasterSettings(s => ({ ...s, truePeakLimit: v }))}
                  min={-3}
                  max={0}
                  step={0.1}
                />
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) => setMasterSettings(s => ({ ...s, enhanceBass: v }))}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) => setMasterSettings(s => ({ ...s, enhanceClarity: v }))}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) => setMasterSettings(s => ({ ...s, analogWarmth: v }))}
                />
              </div>
            </div>
          </div>
