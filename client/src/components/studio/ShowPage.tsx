...
export function ShowPage() {
  ...
  }, [performanceState.isPerforming, performanceState.elapsedTime, updatePerformanceElapsedTime]);
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      } else if (e.key === 'Enter' && !showAddSongDialog && !showNewSetlistDialog) {
        if (performanceState.isPerforming) {
          stopPerformance();
        } else {
          startPerformance();
  ...
  }, [showShowPage, isFullscreen, performanceState.isPerforming, toggleShowPage, nextItem, previousItem, startPerformance, stopPerformance, showAddSongDialog, showNewSetlistDialog]);
    ...
    >
        ...
        <ScrollArea className="flex-1">
          <div className="p-2">
            {activeSetlist?.items.map((item, index) => {
              const isCurrent =
                performanceState.isPerforming && performanceState.currentItemIndex === index;
              const isNext =
                performanceState.isPerforming && performanceState.currentItemIndex + 1 === index;
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8">
          {currentItem ? (
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-8 mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-4xl font-bold text-white">{currentItem.bpm}</div>
                        <div className="text-sm text-white/50 uppercase">BPM</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-4xl font-bold text-white">{currentItem.key}</div>
                        <div className="text-sm text-white/50 uppercase">KEY</div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-white">{nextItemData.name}</div>
                    </div>
                    <div className="flex items-center gap-6 text-white/60">
                      <div className="text-center">
                        <div className="text-xl font-bold text-white">{nextItemData.bpm}</div>
                        <div className="text-xs uppercase">BPM</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xl font-bold text-white">{nextItemData.key}</div>
            ...
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-white/50 mb-2">No Song Selected</h2>
        ...
        >
          <Button
            ...
            disabled={!performanceState.isPerforming || performanceState.currentItemIndex === 0}
          >
          ...
          <Button
            ...
            disabled={
              !performanceState.isPerforming ||
              !activeSetlist ||
              performanceState.currentItemIndex >= activeSetlist.items.length - 1
            }
          >
      ...
      <Dialog open={showAddSongDialog} onOpenChange={setShowAddSongDialog}>
        <DialogContent className="bg-gray-900 border-gray-700 text-white">
          ...
          <div className="space-y-4 py-4">
            <div>
              <label className="text-sm text-white/70 mb-1 block">Song Name</label>
              <Input
                value={newSongName}
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <label className="text-sm text-white/70 mb-1 block">Duration (s)</label>
                <Input
                  type="number"
            ...
            <div>
              <label className="text-sm text-white/70 mb-1 block">Notes (optional)</label>
              <Input
                value={newSongNotes}
      ...
      <Dialog open={showNewSetlistDialog} onOpenChange={setShowNewSetlistDialog}>
        <DialogContent className="bg-gray-900 border-gray-700 text-white">
          ...
          <div className="py-4">
            <label className="text-sm text-white/70 mb-1 block">Setlist Name</label>
            <Input
          ...
          <DialogFooter>
            <Button variant="ghost" onClick={() => setShowNewSetlistDialog(false)}>
              Cancel
            </Button>
            <Button
