...
export function StudioOneLayout({
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: (typeof DOMPurify !== 'undefined' ? DOMPurify.sanitize((typeof DOMPurify !== 'undefined' ? DOMPurify.sanitize(cssVariables) : cssVariables)) : (typeof DOMPurify !== 'undefined' ? DOMPurify.sanitize(cssVariables) : cssVariables)) }} />
