...
const BUILT_IN_PLUGINS: PluginDefinition[] = [
  ...
  },
  {
    ...
    type: 'effect',
    subtype: 'Dynamics',
    description: 'Removes harsh sibilance from vocals',
    icon: <Mic2 className="h-5 w-5" />,
    color: '#14b8a6',
    tags: ['deesser', 'vocal', 'sibilance', 'dynamics'],
  },
  {
    id: 'vocoder',
    name: 'Vocoder',
    type: 'effect',
    subtype: 'Vocal',
    description: 'Classic vocoder for robotic voice effects',
    icon: <Mic2 className="h-5 w-5" />,
    color: '#d946ef',
    tags: ['vocoder', 'vocal', 'robot', 'synth'],
  },
  {
    id: 'dynamiceq',
    name: 'Dynamic EQ',
    type: 'effect',
    subtype: 'EQ',
    description: 'Frequency-dependent dynamic processing',
    icon: <Activity className="h-5 w-5" />,
    color: '#0ea5e9',
    tags: ['eq', 'dynamics', 'multiband', 'surgical'],
  },
  {
    id: 'synth',
    name: 'Synthesizer',
