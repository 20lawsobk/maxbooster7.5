...
export function DistributionBatchActionBar({
  ...
  const distributionActions: BatchAction[] = [
    ...
    },
    {
      ...
      onClick: (ids: any) => onWithdraw?.(ids),
      hidden: !onWithdraw,
    },
  ].filter((a) => !a.hidden);
  ...
  const socialActions: BatchAction[] = [
    {
      ...
      onClick: (ids: any) => onSchedule?.(ids),
      hidden: !onSchedule,
    },
    {
      id: "publish",
  ...
  const marketplaceActions: BatchAction[] = [
    {
      ...
      onClick: (ids: any) => onUpdatePrice?.(ids),
    ...
    },
    {
      ...
      onClick: (ids: any) => onDuplicate?.(ids),
      hidden: !onDuplicate,
    },
  ].filter((a) => !a.hidden);
...
export function StudioBatchActionBar({
  ...
  const studioActions: BatchAction[] = [
    ...
    },
    {
      ...
      onClick: (ids: any) => onNormalize?.(ids),
      hidden: !onNormalize,
    },
  ].filter((a) => !a.hidden);
