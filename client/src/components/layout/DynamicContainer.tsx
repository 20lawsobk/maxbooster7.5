...
export const DynamicContainer = forwardRef<HTMLDivElement, DynamicContainerProps>(
...
export function DynamicSection({ children, spacing = 'md', className }: DynamicSectionProps) {
  return (
...
export function DynamicCard({ children, padding = 'md', hover = false, className }: DynamicCardProps) {
  return (
    <div
      className={cn(
...
export function DynamicText({ children, variant = 'body', className, as }: DynamicTextProps) {
...
export function AdaptiveVisibility({ children, showOn, hideOn }: AdaptiveVisibilityProps) {
