...
const navItems: NavItem[] = [
  ...
  {
    labelKey: "navigation.careerCoach",
    path: "/career-coach",
    icon: GraduationCap,
  },
  ...
  {
    labelKey: "navigation.adminAutonomy",
    path: "/admin/autonomy",
    icon: Brain,
    adminOnly: true,
  },
    ...
    <>
      ...
      {isMobileOpen && (
        <div
          ...
          onKeyDown={(e) => {
            if (e.key === "Escape" || e.key === "Enter") onMobileClose?.();
          }}
          onTouchEnd={(e) => {
            e.preventDefault();
            onMobileClose?.();
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <h2 className="text-base font-black tracking-tight sidebar-brand-text">
                  Max Booster
                </h2>
