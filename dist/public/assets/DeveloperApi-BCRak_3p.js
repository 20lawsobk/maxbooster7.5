...
import { A as _ } from "./AppLayout-D2pri0rw.js";
import {
  u as fe,
  a8 as w,
  a4 as De,
...
import { A as we, f as Ee } from "./index-D5xLbTBZ.js";
import { m as ke } from "./vendor-animation-CFQslDag.js";
import "./vendor-utils-C_Rs6IXs.js";
import "./vendor-ui-Ds7F22HT.js";
import "./vendor-state-Bxk_Qy8r.js";
import "./TopBar-jcH3P98k.js";
function qe() {
  const { user: y, isLoading: Z } = be(),
    { toast: o } = fe(),
    x = te(),
    [J, b] = t.useState(!1),
    [f, K] = t.useState(""),
    ...
    [p, C] = t.useState(null),
    [D, N] = t.useState(null),
    [ee, I] = t.useState(null),
    [g, re] = t.useState("curl"),
    { data: se, isLoading: ie } = T({
      queryKey: ["/api/developer/keys"],
      enabled: !!y,
    }),
    { data: h, isLoading: je } = T({
      queryKey: ["/api/developer/usage"],
      enabled: !!y,
    }),
    A = S({
      mutationFn: async (r) =>
        (await X("POST", "/api/developer/keys/create", r)).json(),
      onSuccess: (r) => {
        (C(r.apiKey.apiKey),
          x.invalidateQueries({ queryKey: ["/api/developer/keys"] }),
          o({
      ...
      onError: (r) => {
        o({
          title: "Error",
          description: r.message || "Failed to create API key",
          variant: "destructive",
        });
      },
    }),
    d = S({
      mutationFn: async (r) => await X("DELETE", `/api/developer/keys/${r}`),
      onSuccess: () => {
        (x.invalidateQueries({ queryKey: ["/api/developer/keys"] }),
          x.invalidateQueries({ queryKey: ["/api/developer/usage"] }),
          N(null),
          o({
      ...
      onError: (r) => {
        o({
          title: "Error",
          description: r.message || "Failed to revoke API key",
          variant: "destructive",
        });
      },
    }),
    le = () => {
      ...
      A.mutate({ keyName: f, tier: P });
    },
    ne = (r) => {
      (navigator.clipboard.writeText(r),
        I(r),
        setTimeout(() => I(null), 2e3),
        o({ title: "Copied", description: "API key copied to clipboard" }));
    },
    c = se?.apiKeys || [],
    ae = h?.totalUsage?.totalRequests || 0,
    R = {
...
print('Demographics:', demographics)`,
  ...
  return Z
    ? e.jsxDEV(
            ...
            "div",
            {
              ...
              children: [
                e.jsxDEV(
                  ...
                  {
                    fileName:
                      "/home/runner/workspace/client/src/pages/DeveloperApi.tsx",
                    lineNumber: 248,
                    columnNumber: 11,
                  },
                  this,
        ...
        !1,
        {
          fileName: "/home/runner/workspace/client/src/pages/DeveloperApi.tsx",
          lineNumber: 246,
          columnNumber: 7,
        },
        this,
                  ...
                  "div",
                  {
                    ...
                    children: [
                      e.jsxDEV(
                        ...
                        {
                          className:
                            "text-4xl font-bold mb-2 flex items-center gap-3",
                          children: [
                            e.jsxDEV(
                              ce,
                              { className: "h-8 w-8" },
                                          ...
                                          "div",
                                          {
                                            children: [
                                              ...
                                              e.jsxDEV(
                                                ...
                                                {
                                                  className:
                                                    "block bg-muted p-3 rounded text-sm",
                                                  children:
                                                ...
                                                "ul",
                                                {
                                                  ...
                                                  children: [
                                                    ...
                                                    e.jsxDEV(
                                                      ...
                                                      {
                                                        children:
                                                          "Enterprise tier: 5,000 requests per second",
                                                      },
                                                      void 0,
                                                      !1,
                                                      {
                                          ...
                                          children: [
                                            {
                                              ...
                                              description:
                                                "List connected streaming platforms",
                                            },
                                            {
                                              method: "GET",
                                              path: "/analytics/streams/:artistId?",
                                              description:
                                                "Get streaming statistics across platforms",
                                            },
                                            {
                                              method: "GET",
                                            ...
                                            },
                                            {
                                              ...
                                              description:
                                                "Get playlist placement information",
                                            },
                                            {
                                              method: "GET",
