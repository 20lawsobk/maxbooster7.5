...
import { a as M } from "./index-D5xLbTBZ.js";
import {
  u as _,
  C as N,
  h as g,
...
import { L as G } from "./Logo-DS4JhmIC.js";
...
function se() {
  const [, t] = B(),
    [V] = r.useState(() => new URLSearchParams(window.location.search)),
    m = V.get("session_id"),
    [c, R] = r.useState(""),
    [x, D] = r.useState(""),
    [u, C] = r.useState(!1),
  ...
  const Y = async (s) => {
    ...
    try {
      if (c !== x) throw new Error("Passwords do not match");
      if (c.length < 6)
        throw new Error("Password must be at least 6 characters long");
      if (!u)
        throw new Error("You must accept the Terms of Service to continue");
      if (!d) throw new Error("You must accept the Privacy Policy to continue");
      const o = await (
        await W("POST", "/api/register-after-payment", {
          sessionId: m,
          password: c,
          tosAccepted: u,
          privacyAccepted: d,
      ...
      else throw new Error(o.error || "Account creation failed");
    } catch (n) {
      const o =
        n instanceof Error
          ? n.message
                ...
                g,
                {
                  ...
                  children: [
                    e.jsxDEV(
                      ...
                      {
                        fileName:
                          "/home/runner/workspace/client/src/pages/RegisterSuccess.tsx",
                        lineNumber: 129,
                        columnNumber: 13,
                      },
                      this,
                            ...
                            children: [
                              ...
                              e.jsxDEV(
                                "p",
                                {
                                  ...
                                  children:
                                    "Your payment has been processed successfully. Now create your password to complete your account setup.",
                                },
                                void 0,
                                !1,
                                {
                                ...
                                "form",
                                {
                                  ...
                                  children: [
                                    ...
                                    e.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "space-y-3 pt-2 border-t border-gray-200",
                                        children: [
                                          e.jsxDEV(
                                            "div",
                                            {
