...
function O() {
  const { tier: P } = j();
  R();
  const [s, k] = x.useState({ username: "", email: "", birthdate: "" }),
    [h, p] = x.useState(!1),
    { toast: E } = C(),
    r = I[P];
  if (!r)
    return e.jsxDEV(
              ...
              c,
              {
                ...
                children: [
                  e.jsxDEV(
                    ...
                    {
                      fileName:
                        "/home/runner/workspace/client/src/pages/RegisterPayment.tsx",
                      lineNumber: 105,
                      columnNumber: 13,
                    },
                    this,
      ...
      !1,
      {
        fileName: "/home/runner/workspace/client/src/pages/RegisterPayment.tsx",
        lineNumber: 102,
        columnNumber: 7,
      },
      this,
  ...
  const D = async (a) => {
      ...
      try {
        if (!s.username.trim() || !s.email.trim() || !s.birthdate.trim())
          throw new Error("Please fill in all fields");
        if (!s.email.includes("@"))
          throw new Error("Please enter a valid email address");
        const t = new Date(s.birthdate),
          i = new Date();
        let N = i.getFullYear() - t.getFullYear();
        const g = i.getMonth() - t.getMonth();
        if (((g < 0 || (g === 0 && i.getDate() < t.getDate())) && N--, N < 13))
          throw new Error(
            "You must be at least 13 years old to create an account (COPPA compliance)",
          );
        const b = await (
          await S("POST", "/api/create-checkout-session", {
            tier: r.id,
            userEmail: s.email,
            username: s.username,
        ...
        (E({ title: "Error", description: i, variant: "destructive" }), p(!1));
      }
    },
    l = (a) => {
      k((t) => ({ ...t, [a.target.name]: a.target.value }));
    };
  return e.jsxDEV(
    "div",
    {
                  ...
                  e.jsxDEV(
                    "div",
                    {
                      ...
                      children: e.jsxDEV(
                        o,
                        {
                          className: `${r.popular ? "border-primary shadow-lg" : "shadow-md"}`,
                          children: [
                            e.jsxDEV(
                              y,
                              {
                                    ...
                                    e.jsxDEV(
                                      "div",
                                      {
                                        ...
                                        children: e.jsxDEV(
                                          ...
                                          {
                                            className:
                                              "bg-primary text-white text-sm px-3 py-1 rounded-full",
                              ...
                              c,
                              {
                                children: [
                                          ...
                                          "li",
                                          {
                                            ...
                                            children: [
                                              e.jsxDEV(
                                                ...
                                                {
                                                  className:
                                                    "w-5 h-5 rounded-full bg-green-100 dark:bg-green-900/40 flex items-center justify-center mt-0.5 flex-shrink-0",
                                                  children: e.jsxDEV(
                                                    "div",
                                                    {
                                                      className:
                                  ...
                                  e.jsxDEV(
                                    ...
                                    {
                                      className:
                                        "mt-6 p-4 bg-blue-50 dark:bg-blue-950/40 rounded-lg border border-blue-200 dark:border-blue-800",
                                      children: [
                                        e.jsxDEV(
                                          "div",
                                          {
                                            className:
                                              "flex items-center space-x-2 text-blue-800 dark:text-blue-300",
                                            children: [
                                              e.jsxDEV(
                                                A,
                                                { className: "h-5 w-5" },
                                        ...
                                        e.jsxDEV(
                                          ...
                                          {
                                            className:
                                              "text-blue-700 dark:text-blue-400 text-sm mt-1",
                                            children:
                              ...
                              y,
                              {
                                ...
                                children: [
                                  e.jsxDEV(
                                    ...
                                    {
                                      className:
                                        "mx-auto w-12 h-12 gradient-bg rounded-xl flex items-center justify-center mb-4",
                                      children: e.jsxDEV(
                                        f,
                              ...
                              c,
                              {
                                ...
                                children: [
                                      ...
                                      children: [
                                        ...
                                        e.jsxDEV(
                                          n,
                                          {
                                            type: "submit",
                                            className:
                                              "w-full py-3 bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90",
                                            size: "lg",
                                            disabled: h,
                                            "data-testid":
                                  ...
                                  e.jsxDEV(
                                    ...
                                    {
                                      className:
                                        "text-center text-xs text-gray-500 space-y-2",
                                      children: [
                                        e.jsxDEV(
                                          "p",
                                          {
