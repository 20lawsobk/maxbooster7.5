const m = (t) => typeof t == "string",
  ...
  In = /###/g,
  Pt = (t) => (t && t.indexOf("###") > -1 ? t.replace(In, ".") : t),
  Lt = (t) => !t || m(t),
  ne = (t, e, n) => {
    const i = m(e) ? e.split(".") : e;
    let r = 0;
    for (; r < i.length - 1; ) {
      if (Lt(t)) return {};
      const s = Pt(i[r]);
      (!t[s] && n && (t[s] = new n()),
        Object.prototype.hasOwnProperty.call(t, s) ? (t = t[s]) : (t = {}),
        ++r);
    }
    return Lt(t) ? {} : { obj: t, k: Pt(i[r]) };
  },
  kt = (t, e, n) => {
    const { obj: i, k: r } = ne(t, e, Object);
    ...
    for (; o.obj === void 0 && a.length; )
      ((s = `${a[a.length - 1]}.${s}`),
        ...
        (o = ne(t, a, Object)),
        o?.obj && typeof o.obj[`${o.k}.${s}`] < "u" && (o.obj = void 0));
    o.obj[`${o.k}.${s}`] = n;
  },
  Rn = (t, e, n, i) => {
    const { obj: r, k: s } = ne(t, e, Object);
    ((r[s] = r[s] || []), r[s].push(n));
  },
  be = (t, e) => {
    const { obj: n, k: i } = ne(t, e);
    if (n && Object.prototype.hasOwnProperty.call(n, i)) return n[i];
  },
  Fn = (t, e, n) => {
    const i = be(t, n);
    return i !== void 0 ? i : be(e, n);
  },
  an = (t, e, n) => {
    for (const i in e)
      i !== "__proto__" &&
...
const En = (t) => (m(t) ? t.replace(/[&<>"'\/]/g, (e) => Nn[e]) : t);
class Dn {
  constructor(e) {
    ((this.capacity = e),
...
const Tn = [" ", ",", "?", "!", ";"],
  ...
  zn = (t, e, n) => {
    ((e = e || ""), (n = n || ""));
    const i = Tn.filter((a) => e.indexOf(a) < 0 && n.indexOf(a) < 0);
    if (i.length === 0) return !0;
    const r = An.getRegExp(
      `(${i.map((a) => (a === "?" ? "\\?" : a)).join("|")})`,
    );
    let s = !r.test(t);
    if (!s) {
      const a = t.indexOf(n);
      a > 0 && !r.test(t.substring(0, a)) && (s = !0);
    }
    return s;
  },
  Xe = (t, e, n = ".") => {
    ...
    for (let s = 0; s < i.length; ) {
      ...
      for (let l = s; l < i.length; ++l)
        if ((l !== s && (o += n), (o += i[l]), (a = r[o]), a !== void 0)) {
          if (
...
class ve {
  ...
  forward(e, n, i, r) {
    return r && !this.debug
      ? null
      : (m(e[0]) && (e[0] = `${i}${this.prefix} ${e[0]}`), this.logger[n](e));
  }
  create(e) {
  ...
  emit(e, ...n) {
    (this.observers[e] &&
      Array.from(this.observers[e].entries()).forEach(([r, s]) => {
        for (let a = 0; a < s; a++) r(...n);
      }),
      this.observers["*"] &&
        Array.from(this.observers["*"].entries()).forEach(([r, s]) => {
          for (let a = 0; a < s; a++) r.apply(r, [e, ...n]);
        }));
  }
}
class Ct extends Ne {
        ...
        i &&
          (Array.isArray(i)
            ...
            : m(i) && s
              ? o.push(...i.split(s))
              : o.push(i)));
    const l = be(this.data, o);
    return (
      !l &&
        !n &&
        !i &&
        e.indexOf(".") > -1 &&
        ((e = o[0]), (n = o[1]), (i = o.slice(2).join("."))),
      l || !a || !m(i) ? l : Xe(this.data?.[e]?.[n], i, s)
    );
  }
  addResource(e, n, i, r, s = { silent: !1 }) {
    const a =
      s.keySeparator !== void 0 ? s.keySeparator : this.options.keySeparator;
    let o = [e, n];
    (i && (o = o.concat(a ? i.split(a) : i)),
      e.indexOf(".") > -1 && ((o = e.split(".")), (r = n), (n = o[1])),
      this.addNamespaces(n),
      kt(this.data, o, r),
      s.silent || this.emit("added", e, n, i, r));
  }
  addResources(e, n, i, r = { silent: !1 }) {
    for (const s in i)
      (m(i[s]) || Array.isArray(i[s])) &&
        this.addResource(e, n, s, i[s], { silent: !0 });
    r.silent || this.emit("added", e, n, i);
  }
  addResourceBundle(e, n, i, r, s, a = { silent: !1, skipCopy: !1 }) {
    let o = [e, n];
    (e.indexOf(".") > -1 && ((o = e.split(".")), (r = i), (i = n), (n = o[1])),
      this.addNamespaces(n));
    let l = be(this.data, o) || {};
    (a.skipCopy || (i = JSON.parse(JSON.stringify(i))),
      r ? an(l, i, s) : (l = { ...l, ...i }),
      kt(this.data, o, l),
      a.silent || this.emit("added", e, n, i));
  }
...
var ln = {
  ...
  handle(t, e, n, i, r) {
    return (
      t.forEach((s) => {
        e = this.processors[s]?.process(e, n, i, r) ?? e;
      }),
      e
    );
  },
};
const un = Symbol("i18next/PATH_KEY");
function Mn() {
  const t = [],
  ...
  return (
    (e.get = (i, r) => (
      n?.revoke?.(),
      r === un ? t : (t.push(r), (n = Proxy.revocable(i, e)), n.proxy)
    )),
...
const $t = {},
  He = (t) => !m(t) && typeof t != "boolean" && typeof t != "number";
class we extends Ne {
  constructor(e, n = {}) {
    (super(),
      $n(
  ...
  extractFromKey(e, n) {
    ...
    if (a && !o) {
      ...
      if (l && l.length > 0) return { key: e, namespaces: m(s) ? [s] : s };
      const u = e.split(i);
      ((i !== r || (i === r && this.options.ns.indexOf(u[0]) > -1)) &&
        (s = u.shift()),
        (e = u.join(r)));
    }
    return { key: e, namespaces: m(s) ? [s] : s };
  }
  translate(e, n, i) {
    let r = typeof n == "object" ? { ...n } : n;
    if (
      (typeof r != "object" &&
      ...
      return "";
    (typeof e == "function" && (e = Ze(e, { ...this.options, ...r })),
    ...
    const s =
      ...
      a =
        r.keySeparator !== void 0 ? r.keySeparator : this.options.keySeparator,
      { key: o, namespaces: l } = this.extractFromKey(e[e.length - 1], r),
      u = l[l.length - 1];
    let c = r.nsSeparator !== void 0 ? r.nsSeparator : this.options.nsSeparator;
    c === void 0 && (c = ":");
    const f = r.lng || this.language,
    ...
    const S = d?.usedKey || o,
      ...
      x = r.count !== void 0 && !m(r.count),
      b = we.hasDefaultValue(r),
      R = x ? this.pluralResolver.getSuffix(f, r.count, r) : "",
      j =
        r.ordinal && x
          ? this.pluralResolver.getSuffix(f, r.count, { ordinal: !1 })
          : "",
      xt = x && !r.ordinal && r.count === 0,
      M =
        (xt && r[`defaultValue${this.options.pluralSeparator}zero`]) ||
        r[`defaultValue${R}`] ||
        r[`defaultValue${j}`] ||
        r.defaultValue;
    let F = h;
    v && !h && b && (F = M);
    const kn = He(F),
      Cn = Object.prototype.toString.apply(F);
    if (v && F && kn && y.indexOf(Cn) < 0 && !(m(_) && Array.isArray(F))) {
      if (!r.returnObjects && !this.options.returnObjects) {
        this.options.returnedObjectHandler ||
          this.logger.warn(
            "accessing an object - but returnObjects options is not enabled!",
          );
        const N = this.options.returnedObjectHandler
          ? this.options.returnedObjectHandler(S, F, { ...r, ns: l })
          : `key '${o} (${this.language})' returned an object instead of string.`;
        return s
          ? ((d.res = N), (d.usedParams = this.getUsedParamsDetails(r)), d)
          : N;
      }
      if (a) {
        const N = Array.isArray(F),
          I = N ? [] : {},
          bt = N ? g : S;
        for (const E in F)
          if (Object.prototype.hasOwnProperty.call(F, E)) {
            const T = `${bt}${a}${E}`;
            (b && !h
              ? (I[E] = this.translate(T, {
                  ...r,
                  defaultValue: He(M) ? M[E] : void 0,
                  joinArrays: !1,
                  ns: l,
                }))
              : (I[E] = this.translate(T, { ...r, joinArrays: !1, ns: l })),
              I[E] === T && (I[E] = F[E]));
          }
        h = I;
      }
    } else if (v && m(_) && Array.isArray(h))
      ((h = h.join(_)), h && (h = this.extendTranslation(h, e, r, i)));
    else {
      let N = !1,
        I = !1;
      (!this.isValidLookup(h) && b && ((N = !0), (h = M)),
        this.isValidLookup(h) || ((I = !0), (h = o)));
      const E =
          ...
          I
            ? void 0
            : h,
        T = b && M !== h && this.options.updateMissing;
      if (I || N || T) {
        if (
          (this.logger.log(T ? "updateKey" : "missingKey", f, u, o, T ? M : h),
          a)
        ) {
          const L = this.resolve(o, { ...r, keySeparator: !1 });
          L &&
            L.res &&
            this.logger.warn(
        ...
        if (this.options.saveMissingTo === "fallback" && pe && pe[0])
          for (let L = 0; L < pe.length; L++) Z.push(pe[L]);
        else
          this.options.saveMissingTo === "all"
            ? (Z = this.languageUtils.toResolveHierarchy(
                r.lng || this.language,
              ))
            : Z.push(r.lng || this.language);
        const vt = (L, K, ee) => {
          const wt = b && ee !== h ? ee : E;
          (this.options.missingKeyHandler
            ? this.options.missingKeyHandler(L, u, K, wt, T, r)
            : this.backendConnector?.saveMissing &&
              this.backendConnector.saveMissing(L, u, K, wt, T, r),
            this.emit("missingKey", L, u, K, h));
        };
        this.options.saveMissing &&
          (this.options.saveMissingPlurals && x
            ? Z.forEach((L) => {
                const K = this.pluralResolver.getSuffixes(L, r);
                (xt &&
      ...
      ((h = this.extendTranslation(h, e, r, d, i)),
        ...
        (I || N) &&
          ...
          (h = this.options.parseMissingKeyHandler(
            this.options.appendNamespaceToMissingKey ? `${u}${c}${o}` : o,
            N ? h : void 0,
            r,
          )));
    }
    return s
      ? ((d.res = h), (d.usedParams = this.getUsedParamsDetails(r)), d)
      : h;
  }
  extendTranslation(e, n, i, r, s) {
    if (this.i18nFormat?.parse)
      ...
      let c = i.replace && !m(i.replace) ? i.replace : i;
      if (
        ...
        i.nest !== !1 &&
          (e = this.interpolator.nest(
            ...
            (...f) =>
              s?.[0] === f[0] && !i.context
                ? (this.logger.warn(
                    `It seems you are nesting recursively key: ${f[0]} in key: ${n[0]}`,
                  ),
                  null)
                : this.translate(...f, n),
            i,
  ...
  resolve(e, n = {}) {
    ...
    return (
      ...
      e.forEach((l) => {
        ...
        const p = n.count !== void 0 && !m(n.count),
          d = p && !n.ordinal && n.count === 0,
          h =
            n.context !== void 0 &&
        ...
        f.forEach((g) => {
          this.isValidLookup(i) ||
            ...
            !$t[`${S[0]}-${g}`] &&
              ...
              (($t[`${S[0]}-${g}`] = !0),
              this.logger.warn(
                `key "${r}" for languages "${S.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`,
            ...
            S.forEach((y) => {
              ...
              if (this.i18nFormat?.addLookupKeys)
                this.i18nFormat.addLookupKeys(_, c, y, g, n);
              else {
                let x;
                ...
                if (
                  (p &&
                    (n.ordinal &&
                      x.indexOf(R) === 0 &&
                      _.push(c + x.replace(R, this.options.pluralSeparator)),
                    _.push(c + x),
                    d && _.push(c + b)),
                  h)
                ) {
                  ...
                  (_.push(j),
                    p &&
                      (n.ordinal &&
                        x.indexOf(R) === 0 &&
                        _.push(j + x.replace(R, this.options.pluralSeparator)),
                      _.push(j + x),
                      d && _.push(j + b)));
                }
              }
              ...
              for (; (v = _.pop()); )
                this.isValidLookup(i) ||
                  ((s = v), (i = this.getResource(y, g, v, n)));
            }));
        });
      }),
      { res: i, usedKey: r, exactUsedKey: s, usedLng: a, usedNS: o }
    );
  }
  isValidLookup(e) {
    return (
  ...
  getResource(e, n, i, r = {}) {
    return this.i18nFormat?.getResource
      ? this.i18nFormat.getResource(e, n, i, r)
      : this.resourceStore.getResource(e, n, i, r);
  }
  getUsedParamsDetails(e = {}) {
    const n = [
      ...
      i = e.replace && !m(e.replace);
    let r = i ? e.replace : e;
    if (
      (i && typeof e.count < "u" && (r.count = e.count),
      this.options.interpolation.defaultVariables &&
        (r = { ...this.options.interpolation.defaultVariables, ...r }),
      !i)
    ) {
      r = { ...r };
      for (const s of n) delete r[s];
    }
    return r;
  }
...
class It {
  ...
  getFallbackCodes(e, n) {
    ...
    let i = e[n];
    return (
      i || (i = e[this.getScriptPartFromCode(n)]),
      i || (i = e[this.formatLanguageCode(n)]),
      i || (i = e[this.getLanguagePartFromCode(n)]),
      i || (i = e.default),
      i || []
    );
  }
  toResolveHierarchy(e, n) {
    ...
    return (
      m(e) && (e.indexOf("-") > -1 || e.indexOf("_") > -1)
        ...
        : m(e) && s(this.formatLanguageCode(e)),
      i.forEach((a) => {
...
const Rt = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
  Ft = {
...
class Un {
  ...
  getRule(e, n = {}) {
    const i = re(e === "dev" ? "en" : e),
      r = n.ordinal ? "ordinal" : "cardinal",
      s = JSON.stringify({ cleanedCode: i, type: r });
    if (s in this.pluralRulesCache) return this.pluralRulesCache[s];
    let a;
    try {
      a = new Intl.PluralRules(i, { type: r });
    } catch {
      if (typeof Intl > "u")
        return (
  ...
  needsPlural(e, n = {}) {
    ...
    return (
      i || (i = this.getRule("dev", n)),
      i?.resolvedOptions().pluralCategories.length > 1
    );
  }
  getPluralFormsOfKey(e, n, i = {}) {
    return this.getSuffixes(e, i).map((r) => `${n}${r}`);
  }
  getSuffixes(e, n = {}) {
    let i = this.getRule(e, n);
    return (
      ...
      i
        ? i
            .resolvedOptions()
            .pluralCategories.sort((r, s) => Rt[r] - Rt[s])
            .map(
              (r) =>
                `${this.options.prepend}${n.ordinal ? `ordinal${this.options.prepend}` : ""}${r}`,
            )
        : []
    );
  }
  getSuffix(e, n, i = {}) {
    ...
    return r
      ? `${this.options.prepend}${i.ordinal ? `ordinal${this.options.prepend}` : ""}${r.select(n)}`
      : (this.logger.warn(`no plural rule found for: ${e}`),
        this.getSuffix("dev", n, i));
  }
}
const Nt = (t, e, n, i = ".", r = !0) => {
    let s = Fn(t, e, n);
    return (
      !s && r && m(n) && ((s = Xe(t, n, i)), s === void 0 && (s = Xe(e, n, i))),
      s
    );
  },
  Be = (t) => t.replace(/\$/g, "$$$$");
class Et {
  constructor(e = {}) {
    ((this.logger = D.create("interpolator")),
      (this.options = e),
      (this.format = e?.interpolation?.format || ((n) => n)),
      this.init(e));
  }
  init(e = {}) {
    ...
    ((this.escape = n !== void 0 ? n : En),
      ...
      (this.nestingPrefix = p ? Y(p) : d || Y("$t(")),
      (this.nestingSuffix = h ? Y(h) : S || Y(")")),
  ...
  resetRegExp() {
    const e = (n, i) =>
      n?.source === i ? ((n.lastIndex = 0), n) : new RegExp(i, "g");
  ...
  interpolate(e, n, i, r) {
      ...
      u = (d) => {
        if (d.indexOf(this.formatSeparator) < 0) {
          ...
          return this.alwaysFormat
            ? this.format(y, void 0, i, { ...r, ...n, interpolationkey: d })
            : y;
        }
        const h = d.split(this.formatSeparator),
          S = h.shift().trim(),
    ...
    return (
      [
        { regex: this.regexpUnescape, safeValue: (d) => Be(d) },
        {
          regex: this.regexp,
          safeValue: (d) => (this.escapeValue ? Be(this.escape(d)) : Be(d)),
        },
      ].forEach((d) => {
        for (o = 0; (s = d.regex.exec(e)); ) {
          const h = s[1].trim();
          if (((a = u(h)), a === void 0))
            if (typeof c == "function") {
              const g = c(e, s, r);
              a = m(g) ? g : "";
            } else if (r && Object.prototype.hasOwnProperty.call(r, h)) a = "";
            else if (f) {
              a = s[0];
              continue;
            } else
              (this.logger.warn(
                ...
                (a = ""));
          else !m(a) && !this.useRawValueToEscape && (a = Ot(a));
          const S = d.safeValue(a);
          if (
            ((e = e.replace(s[0], S)),
            f
    ...
    for (; (r = this.nestingRegexp.exec(e)); ) {
      ...
      (m(s) || (s = Ot(s)),
        ...
        l.length &&
          (s = l.reduce(
            (c, f) =>
              this.format(c, f, i.lng, { ...i, interpolationkey: r[1].trim() }),
            s.trim(),
          )),
        (e = e.replace(r[0], s)),
...
const Kn = (t) => {
  ...
  Dt = (t) => {
    ...
    return (n, i, r) => {
      ...
      let o = e[a];
      return (o || ((o = t(re(i), r)), (e[a] = o)), o(n));
    };
  },
  Vn = (t) => (e, n, i) => t(re(n), i)(e);
class Hn {
  constructor(e = {}) {
  ...
  init(e, n = { interpolation: {} }) {
    ...
    const i = n.cacheInBuiltFormats ? Dt : Vn;
    this.formats = {
      number: i((r, s) => {
        const a = new Intl.NumberFormat(r, { ...s });
        return (o) => a.format(o);
      }),
      currency: i((r, s) => {
        const a = new Intl.NumberFormat(r, { ...s, style: "currency" });
        return (o) => a.format(o);
      }),
      datetime: i((r, s) => {
        const a = new Intl.DateTimeFormat(r, { ...s });
        return (o) => a.format(o);
      }),
      relativetime: i((r, s) => {
        const a = new Intl.RelativeTimeFormat(r, { ...s });
        return (o) => a.format(o, s.range || "day");
      }),
      list: i((r, s) => {
        const a = new Intl.ListFormat(r, { ...s });
        return (o) => a.format(o);
      }),
    };
  }
  ...
  addCached(e, n) {
    this.formats[e.toLowerCase().trim()] = Dt(n);
  }
  format(e, n, i, r = {}) {
    ...
    return s.reduce((o, l) => {
      const { formatName: u, formatOptions: c } = Kn(l);
      if (this.formats[u]) {
        let f = o;
        try {
          const p = r?.formatParams?.[r.interpolationkey] || {},
            d = p.locale || p.lng || r.locale || r.lng || i;
          f = this.formats[u](o, d, { ...c, ...r, ...p });
        } catch (p) {
          this.logger.warn(p);
        }
        return f;
...
class Jn extends Ne {
  ...
  queueLoad(e, n, i, r) {
    ...
    return (
      e.forEach((u) => {
        ...
        (n.forEach((f) => {
          const p = `${u}|${f}`;
          !i.reload && this.store.hasResourceBundle(u, f)
            ? (this.state[p] = 2)
            : this.state[p] < 0 ||
              (this.state[p] === 1
                ? a[p] === void 0 && (a[p] = !0)
  ...
  loaded(e, n, i) {
    ...
    (n && this.emit("failedLoading", s, a, n),
      !n &&
        i &&
        this.store.addResourceBundle(s, a, i, void 0, void 0, { skipCopy: !0 }),
      (this.state[e] = n ? -1 : 2),
      n && i && (this.state[e] = 0));
    const o = {};
  ...
  read(e, n, i, r = 0, s = this.retryTimeout, a) {
    ...
    const o = (u, c) => {
        ...
        if (u && c && r < this.maxRetries) {
          setTimeout(() => {
            this.read.call(this, e, n, i, r + 1, s * 2, a);
          }, s);
          return;
        }
        a(u, c);
  ...
  prepareLoading(e, n, i = {}, r) {
    ...
    (m(e) && (e = this.languageUtils.toResolveHierarchy(e)), m(n) && (n = [n]));
    const s = this.queueLoad(e, n, i, r);
  ...
  reload(e, n, i) {
    this.prepareLoading(e, n, { reload: !0 }, i);
  }
  loadOne(e, n = "") {
    const i = e.split("|"),
      r = i[0],
    ...
    this.read(r, s, "read", void 0, void 0, (a, o) => {
      (a &&
        this.logger.warn(
          `${n}loading namespace ${s} for language ${r} failed`,
          a,
        ),
        !a &&
          o &&
          this.logger.log(`${n}loaded namespace ${s} for language ${r}`, o),
        this.loaded(e, a, o));
    });
  }
  saveMissing(e, n, i, r, s, a = {}, o = () => {}) {
    if (
    ...
    if (!(i == null || i === "")) {
      if (this.backend?.create) {
        const l = { ...a, isUpdate: s },
          u = this.backend.create.bind(this.backend);
        if (u.length < 6)
          try {
            let c;
            (u.length === 5 ? (c = u(e, n, i, r, l)) : (c = u(e, n, i, r)),
              c && typeof c.then == "function"
                ? c.then((f) => o(null, f)).catch(o)
                : o(null, c));
          } catch (c) {
            o(c);
          }
...
const Je = () => ({
    ...
    overloadTranslationOptionHandler: (t) => {
      ...
      if (
        ...
        m(t[1]) && (e.defaultValue = t[1]),
        m(t[2]) && (e.tDescription = t[2]),
  ...
  Tt = (t) => (
    m(t.ns) && (t.ns = [t.ns]),
    m(t.fallbackLng) && (t.fallbackLng = [t.fallbackLng]),
    m(t.fallbackNS) && (t.fallbackNS = [t.fallbackNS]),
...
const Yn = (t) =>
  !!(
    t?.modules?.backend?.name?.indexOf("Locize") > 0 ||
    t?.modules?.backend?.constructor?.name?.indexOf("Locize") > 0 ||
    (t?.options?.backend?.backends &&
      t.options.backend.backends.some(
        (e) =>
...
class ie extends Ne {
  ...
  init(e = {}, n) {
    ...
    const i = Je();
    ((this.options = { ...i, ...this.options, ...Tt(e) }),
      (this.options.interpolation = {
        ...i.interpolation,
        ...this.options.interpolation,
      }),
      ...
      typeof this.options.overloadTranslationOptionHandler != "function" &&
        (this.options.overloadTranslationOptionHandler =
          i.overloadTranslationOptionHandler),
    ...
    if (!this.options.isClone) {
      ...
      ((f.logger = D),
        ...
        (f.interpolator = new Et(this.options)),
        (f.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }),
        (f.backendConnector = new Jn(
          r(this.modules.backend),
          f.resourceStore,
          f,
          this.options,
        )),
        f.backendConnector.on("*", (d, ...h) => {
          this.emit(d, ...h);
        }),
        this.modules.languageDetector &&
          ((f.languageDetector = r(this.modules.languageDetector)),
  ...
  loadResources(e, n = ge) {
    let i = n;
    const r = m(e) ? e : this.language;
    if (
  ...
  use(e) {
    ...
    return (
      ...
      e.type === "postProcessor" && ln.addPostProcessor(e),
      ...
      a = (o) => {
        ...
        const l = m(o) ? o : o && o[0],
          u = this.store.hasLanguageSomeTranslations(l)
            ? l
            : this.services.languageUtils.getBestMatchFromCodes(m(o) ? [o] : o);
        (u &&
          (this.language || r(u),
  ...
  getFixedT(e, n, i) {
    const r = (s, a, ...o) => {
      let l;
      (typeof a != "object"
        ? (l = this.options.overloadTranslationOptionHandler([s, a].concat(o)))
        : (l = { ...a }),
        (l.lng = l.lng || r.lng),
        (l.lngs = l.lngs || r.lngs),
        (l.ns = l.ns || r.ns),
        l.keyPrefix !== "" && (l.keyPrefix = l.keyPrefix || i || r.keyPrefix));
      ...
      return (
        l.keyPrefix && Array.isArray(s)
          ? (c = s.map(
              (f) => (
                typeof f == "function" &&
                  (f = Ze(f, { ...this.options, ...a })),
                `${l.keyPrefix}${u}${f}`
              ),
            ))
          : (typeof s == "function" && (s = Ze(s, { ...this.options, ...a })),
            (c = l.keyPrefix ? `${l.keyPrefix}${u}${s}` : s)),
        this.t(c, l)
      );
    };
    return (
      m(e) ? (r.lng = e) : (r.lngs = e),
      (r.ns = n),
      (r.keyPrefix = i),
      r
    );
  ...
  loadLanguages(e, n) {
    ...
    const r = this.options.preload || [],
      s = e.filter(
        (a) =>
          r.indexOf(a) < 0 && this.services.languageUtils.isSupportedCode(a),
      );
    return s.length
  ...
  dir(e) {
    ...
    const n = [
      ...
      i = this.services?.languageUtils || new It(Je());
    return e.toLowerCase().indexOf("-latn") > 1
      ? "ltr"
      : n.indexOf(i.getLanguagePartFromCode(e)) > -1 ||
  ...
  static createInstance(e = {}, n) {
    const i = new ie(e, n);
    return ((i.createInstance = ie.createInstance), i);
  }
  cloneInstance(e = {}, n = ge) {
    ...
    if (
      ...
      ((s.store = new Ct(o, r)), (s.services.resourceStore = s.store));
    }
    if (e.interpolation) {
      const l = {
          ...Je().interpolation,
        ...
        u = { ...r, interpolation: l };
      s.services.interpolator = new Et(u);
    }
    return (
      (s.translator = new we(s.services, r)),
      s.translator.on("*", (o, ...l) => {
        s.emit(o, ...l);
      }),
      s.init(r, n),
...
P.loadNamespaces;
P.loadLanguages;
const { slice: Gn, forEach: Qn } = [];
function qn(t) {
  return (
    Qn.call(Gn.call(arguments, 1), (e) => {
...
const zt = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  Zn = function (t, e) {
    ...
    if (i.domain) {
      if (!zt.test(i.domain)) throw new TypeError("option domain is invalid");
      s += `; Domain=${i.domain}`;
    }
    if (i.path) {
      if (!zt.test(i.path)) throw new TypeError("option path is invalid");
      s += `; Path=${i.path}`;
    }
    if (i.expires) {
    ...
    return (i.partitioned && (s += "; Partitioned"), s);
  },
  jt = {
    create(t, e, n, i) {
      let r =
      ...
      (n &&
        ((r.expires = new Date()),
        r.expires.setTime(r.expires.getTime() + n * 60 * 1e3)),
        i && (r.domain = i),
        (document.cookie = Zn(t, e, r)));
    },
    read(t) {
      const e = `${t}=`,
...
var ei = {
    ...
    lookup(t) {
      ...
      if (e && typeof document < "u") return jt.read(e) || void 0;
    },
    cacheUserLanguage(t, e) {
      ...
      n && typeof document < "u" && jt.create(n, t, i, r, s);
    },
  },
  ti = {
    name: "querystring",
    lookup(t) {
      ...
      if (typeof window < "u") {
        ...
        for (let a = 0; a < s.length; a++) {
          const o = s[a].indexOf("=");
          o > 0 && s[a].substring(0, o) === e && (n = s[a].substring(o + 1));
        }
      }
      return n;
    },
    ...
    lookup(t) {
      ...
      if (typeof window < "u") {
        ...
        if (r && r.length > 2) {
          ...
          if (i) return i;
          if (!i && n > -1) {
            const a = r.match(/\/([a-zA-Z-]*)/g);
            return Array.isArray(a)
              ? a[typeof n == "number" ? n : 0]?.replace("/", "")
              : void 0;
          }
        }
      }
...
const Mt = () => {
  if (G !== null) return G;
  try {
    if (((G = typeof window < "u" && window.localStorage !== null), !G))
      return !1;
...
var ii = {
  ...
  lookup(t) {
    ...
    if (e && Mt()) return window.localStorage.getItem(e) || void 0;
  },
  cacheUserLanguage(t, e) {
...
const Ut = () => {
  if (Q !== null) return Q;
  try {
    if (((Q = typeof window < "u" && window.sessionStorage !== null), !Q))
      return !1;
    const t = "i18next.translate.boo";
...
var ri = {
    ...
    lookup(t) {
      ...
      if (e && Ut()) return window.sessionStorage.getItem(e) || void 0;
    },
    cacheUserLanguage(t, e) {
      let { lookupSessionStorage: n } = e;
      n && Ut() && window.sessionStorage.setItem(n, t);
    },
  },
  si = {
    name: "navigator",
    lookup(t) {
      ...
      if (typeof navigator < "u") {
        const { languages: n, userLanguage: i, language: r } = navigator;
        if (n) for (let s = 0; s < n.length; s++) e.push(n[s]);
        (i && e.push(i), r && e.push(r));
      }
...
class ci {
  ...
  init() {
    ...
    ((this.services = e),
      (this.options = qn(n, this.options || {}, ui())),
  ...
  detect() {
    ...
    return (
      e.forEach((i) => {
        if (this.detectors[i]) {
          let r = this.detectors[i].lookup(this.options);
          (r && typeof r == "string" && (r = [r]), r && (n = n.concat(r)));
        }
      }),
      (n = n
        .filter((i) => i != null && !Xn(i))
        .map((i) => this.options.convertDetectedLanguage(i))),
      this.services &&
      this.services.languageUtils &&
  ...
  cacheUserLanguage(e) {
    ...
    n &&
      ((this.options.excludeCacheFor &&
        ...
        n.forEach((i) => {
          this.detectors[i] &&
            this.detectors[i].cacheUserLanguage(e, this.options);
        }));
  }
}
ci.type = "languageDetector";
var dn = Symbol.for("immer-nothing"),
  Kt = Symbol.for("immer-draftable"),
...
var C = Object,
  ...
  U = (t) => !!t && !!t[w];
function z(t) {
  return t ? hn(t) || Te(t) || !!t[Kt] || !!t[Oe]?.[Kt] || Ae(t) || ze(t) : !1;
}
var di = C[Ee][Oe].toString(),
  Vt = new WeakMap();
function hn(t) {
  if (!t || !gt(t)) return !1;
  const e = q(t);
  if (e === null || e === C[Ee]) return !0;
  const n = C.hasOwnProperty.call(e, Oe) && e[Oe];
  if (n === Object) return !0;
  if (!H(n)) return !1;
  let i = Vt.get(n);
  return (
    i === void 0 && ((i = Function.toString.call(n)), Vt.set(n, i)),
    i === di
  );
}
function De(t, e, n = !0) {
  de(t) === 0
    ? (n ? Reflect.ownKeys(t) : C.keys(t)).forEach((r) => {
        e(r, t[r], t);
      })
    : t.forEach((i, r) => e(r, i, t));
}
function de(t) {
  const e = t[w];
  return e ? e.type_ : Te(t) ? 1 : Ae(t) ? 2 : ze(t) ? 3 : 0;
}
var Ht = (t, e, n = de(t)) =>
    n === 2 ? t.has(e) : C[Ee].hasOwnProperty.call(t, e),
  tt = (t, e, n = de(t)) => (n === 2 ? t.get(e) : t[e]),
  Le = (t, e, n, i = de(t)) => {
...
var Te = Array.isArray,
  Ae = (t) => t instanceof Map,
  ze = (t) => t instanceof Set,
  gt = (t) => typeof t == "object",
...
var A = (t) => t.copy_ || t.base_,
  mt = (t) => (t.modified_ ? t.copy_ : t.base_);
function nt(t, e) {
  if (Ae(t)) return new Map(t);
  if (ze(t)) return new Set(t);
  if (Te(t)) return Array[Ee].slice.call(t);
  const n = hn(t);
  if (e === !0 || (e === "class_only" && !n)) {
    const i = C.getOwnPropertyDescriptors(t);
    delete i[w];
    let r = Reflect.ownKeys(i);
    for (let s = 0; s < r.length; s++) {
      const a = r[s],
        o = i[a];
      (o[_e] === !1 && ((o[_e] = !0), (o[et] = !0)),
        (o.get || o.set) &&
          (i[a] = { [et]: !0, [_e]: !0, [Pe]: o[Pe], [se]: t[a] }));
    }
    return C.create(q(t), i);
  } else {
    const i = q(t);
    if (i !== null && n) return { ...t };
    const r = C.create(i);
    return C.assign(r, t);
  }
}
function yt(t, e = !1) {
  return (
    je(t) ||
      ...
      !z(t) ||
      (de(t) > 1 &&
        C.defineProperties(t, { set: me, add: me, clear: me, delete: me }),
      C.freeze(t),
      e &&
        De(
          t,
...
var me = { [se]: gi };
function je(t) {
  return t === null || !gt(t) ? !0 : C.isFrozen(t);
}
var ke = "MapSet",
  it = "Patches",
  Bt = "ArrayMethods",
...
var Jt = (t) => !!pn[t],
  ...
  mi = (t, e) => ({
    ...
    mapSetPlugin_: Jt(ke) ? B(ke) : void 0,
    arrayMethodsPlugin_: Jt(Bt) ? B(Bt) : void 0,
  });
function Wt(t, e) {
  e &&
    ((t.patchPlugin_ = B(it)),
...
function rt(t) {
  (st(t), t.drafts_.forEach(yi), (t.drafts_ = null));
}
function st(t) {
  t === oe && (oe = t.parent_);
}
...
function Gt(t, e) {
  ...
  const n = e.drafts_[0];
  if (t !== void 0 && t !== n) {
    (n[w].modified_ && (rt(e), k(4)), z(t) && (t = Qt(e, t)));
    const { patchPlugin_: r } = e;
    r && r.generateReplacementPatches_(n[w].base_, t, e);
  } else t = Qt(e, n);
  return (
    Si(e, t, !0),
    rt(e),
...
function Qt(t, e) {
  if (je(e)) return e;
  const n = e[w];
  if (!n) return Ce(e, t.handledSet_, t);
  if (!Me(n, t)) return e;
  if (!n.modified_) return n.base_;
  if (!n.finalized_) {
    const { callbacks_: i } = n;
    if (i) for (; i.length > 0; ) i.pop()(t);
    Sn(n, t);
  }
  return n.copy_;
}
function Si(t, e, n = !1) {
  !t.parent_ && t.immer_.autoFreeze_ && t.canAutoFreeze_ && yt(e, n);
}
function mn(t) {
  ((t.finalized_ = !0), t.scope_.unfinalizedDrafts_--);
}
var Me = (t, e) => t.scope_ === e,
  _i = [];
function yn(t, e, n, i) {
  const r = A(t),
    s = t.type_;
  if (i !== void 0 && tt(r, i, s) === e) {
    Le(r, i, n, s);
    return;
  }
  if (!t.draftLocations_) {
    const o = (t.draftLocations_ = new Map());
    De(r, (l, u) => {
      if (U(u)) {
        const c = o.get(u) || [];
        (c.push(l), o.set(u, c));
  ...
  const a = t.draftLocations_.get(e) ?? _i;
  for (const o of a) Le(r, o, n, s);
}
function xi(t, e, n) {
...
function Sn(t, e) {
  if (
    ...
    (t.type_ === 3 ||
      ...
      (t.assigned_?.size ?? 0) > 0)
  ) {
    const { patchPlugin_: i } = e;
    if (i) {
      const r = i.getPath(t);
      r && i.generatePatches_(t, r, e);
    }
    mn(t);
  }
}
  ...
  if (U(n)) {
    ...
    z(n) &&
      t.callbacks_.push(function () {
        const s = A(t);
        t.type_ === 3
          ? s.has(n) && Ce(n, i.handledSet_, i)
          : tt(s, e, t.type_) === n &&
            i.drafts_.length > 1 &&
            (t.assigned_.get(e) ?? !1) === !0 &&
            t.copy_ &&
            Ce(tt(t.copy_, e, t.type_), i.handledSet_, i);
      });
}
function Ce(t, e, n) {
  return (
...
function vi(t, e) {
  ...
  let r = i,
    s = $e;
  n && ((r = [i]), (s = ae));
  const { revoke: a, proxy: o } = Proxy.revocable(r, s);
  return ((i.draft_ = o), (i.revoke_ = a), [o, i]);
}
var $e = {
    get(t, e) {
      if (e === w) return t;
      ...
      const r = A(t);
      if (!Ht(r, e, t.type_)) return wi(t, r, e);
      const s = r[e];
      if (
        t.finalized_ ||
        !z(s) ||
        (i &&
          t.operationMethod &&
          n?.isMutatingArrayMethod(t.operationMethod) &&
          pi(e))
      )
        return s;
      if (s === Ye(t.base_, e)) {
        xe(t);
        const a = t.type_ === 1 ? +e : e,
          o = at(t.scope_, s, t, a);
        return (t.copy_[a] = o);
      }
      return s;
    ...
    set(t, e, n) {
      const i = _n(A(t), e);
      if (i?.set) return (i.set.call(t.draft_, n), !0);
      if (!t.modified_) {
        const r = Ye(A(t), e),
          s = r?.[w];
        if (s && s.base_ === n)
          return ((t.copy_[e] = n), t.assigned_.set(e, !1), !0);
        if (hi(n, r) && (n !== void 0 || Ht(t.base_, e, t.type_))) return !0;
        (xe(t), ot(t));
      }
      return (
        (t.copy_[e] === n && (n !== void 0 || e in t.copy_)) ||
          (Number.isNaN(n) && Number.isNaN(t.copy_[e])) ||
          ((t.copy_[e] = n), t.assigned_.set(e, !0), bi(t, e, n)),
        !0
      );
    },
    deleteProperty(t, e) {
      return (
        xe(t),
        Ye(t.base_, e) !== void 0 || e in t.base_
          ? (t.assigned_.set(e, !1), ot(t))
          : t.assigned_.delete(e),
...
ae.deleteProperty = function (t, e) {
  return (isNaN(parseInt(e)) && k(13), ae.set.call(this, t, e, void 0));
};
ae.set = function (t, e, n) {
  return (
    e !== "length" && isNaN(parseInt(e)) && k(14),
    $e.set.call(this, t[0], e, n, t[0])
  );
};
function Ye(t, e) {
  const n = t[w];
...
function wi(t, e, n) {
  const i = _n(e, n);
  return i ? (se in i ? i[se] : i.get?.call(t.draft_)) : void 0;
}
function _n(t, e) {
  if (!(e in t)) return;
  let n = q(t);
...
function xe(t) {
  t.copy_ ||
    ((t.assigned_ = new Map()),
    (t.copy_ = nt(t.base_, t.scope_.immer_.useStrictShallowCopy_)));
}
var Oi = class {
  constructor(e) {
    ((this.autoFreeze_ = !0),
      ...
      (this.produce = (n, i, r) => {
        if (H(n) && !H(i)) {
          ...
          return function (u = a, ...c) {
            return o.produce(u, (f) => i.call(this, f, ...c));
          };
        }
        (H(i) || k(6), r !== void 0 && !H(r) && k(7));
        let s;
        if (z(n)) {
          const a = Yt(this),
            o = at(a, n, void 0);
          ...
          return (Wt(a, r), Gt(s, a));
        } else if (!n || !gt(n)) {
          if (
            ((s = i(n)),
            s === void 0 && (s = n),
            s === dn && (s = void 0),
            this.autoFreeze_ && yt(s, !0),
            r)
          ) {
            const a = [],
              o = [];
            (B(it).generateReplacementPatches_(n, s, {
              patches_: a,
              inversePatches_: o,
            }),
              r(a, o));
      ...
      (this.produceWithPatches = (n, i) => {
        if (H(n))
          return (o, ...l) => this.produceWithPatches(o, (u) => n(u, ...l));
        let r, s;
        return [
          this.produce(n, i, (o, l) => {
            ((r = o), (s = l));
          }),
          r,
          s,
      ...
      We(e?.autoFreeze) && this.setAutoFreeze(e.autoFreeze),
      We(e?.useStrictShallowCopy) &&
        this.setUseStrictShallowCopy(e.useStrictShallowCopy),
      We(e?.useStrictIteration) &&
  ...
  createDraft(e) {
    ...
    const n = Yt(this),
      i = at(n, e, void 0);
    return ((i[w].isManual_ = !0), st(n), i);
  }
  finishDraft(e, n) {
    const i = e && e[w];
    (!i || !i.isManual_) && k(9);
    const { scope_: r } = i;
    return (Wt(r, n), Gt(void 0, r));
  }
  setAutoFreeze(e) {
    this.autoFreeze_ = e;
  }
  ...
  applyPatches(e, n) {
    ...
    i > -1 && (n = n.slice(i + 1));
    const r = B(it).applyPatches_;
    return U(e) ? r(e, n) : this.produce(e, (s) => r(s, n));
  }
};
function at(t, e, n, i) {
  const [r, s] = Ae(e)
    ...
    : ze(e)
      ...
      : vi(e, n);
  return (
    (n?.scope_ ?? gn()).drafts_.push(r),
    (s.callbacks_ = n?.callbacks_ ?? []),
    (s.key_ = i),
    n && i !== void 0
      ? xi(n, s, i)
      : s.callbacks_.push(function (l) {
          l.mapSetPlugin_?.fixSetContents(s);
...
function Pi(t) {
  return (U(t) || k(10, t), xn(t));
}
function xn(t) {
  if (!z(t) || je(t)) return t;
  const e = t[w];
  let n,
    i = !0;
  if (e) {
    ...
    ((e.finalized_ = !0),
      (n = nt(t, e.scope_.immer_.useStrictShallowCopy_)),
...
function O(t, ...e) {
  {
    const n = ki[t],
      i = typeof n == "function" ? n.apply(null, e) : n;
    throw new Error(`[Immer] ${i}`);
  }
}
...
function vn(t) {
  ...
  let i = Xt.get(n);
  return (
    i === void 0 && ((i = Function.toString.call(n)), Xt.set(n, i)),
    i === Ci
  );
}
function Ie(t, e, n = !0) {
  Ue(t) === 0
    ? (n ? Reflect.ownKeys(t) : Object.keys(t)).forEach((r) => {
        e(r, t[r], t);
      })
    : t.forEach((i, r) => e(r, i, t));
}
function Ue(t) {
  const e = t[$];
  return e ? e.type_ : Array.isArray(t) ? 1 : he(t) ? 2 : Ke(t) ? 3 : 0;
}
function lt(t, e) {
  return Ue(t) === 2 ? t.has(e) : Object.prototype.hasOwnProperty.call(t, e);
}
function wn(t, e, n) {
  const i = Ue(t);
  i === 2 ? t.set(e, n) : i === 3 ? t.add(n) : (t[e] = n);
...
function ut(t, e) {
  if (he(t)) return new Map(t);
  if (Ke(t)) return new Set(t);
...
function St(t, e = !1) {
  return (
    Ve(t) ||
      ...
      !J(t) ||
      (Ue(t) > 1 &&
        Object.defineProperties(t, { set: ye, add: ye, clear: ye, delete: ye }),
      Object.freeze(t),
      e && Object.values(t).forEach((n) => St(n, !0))),
    t
  );
}
function Ii() {
...
function ct(t) {
  (ft(t), t.drafts_.forEach(Ni), (t.drafts_ = null));
}
function ft(t) {
  t === ue && (ue = t.parent_);
}
...
function tn(t, e) {
  ...
  return (
    t !== void 0 && t !== n
      ? (n[$].modified_ && (ct(e), O(4)),
        J(t) && ((t = Re(e, t)), e.parent_ || Fe(e, t)),
        e.patches_ &&
...
function Re(t, e, n) {
  if (Ve(e)) return e;
  const i = t.immer_.shouldUseStrictIteration(),
    r = e[$];
  if (!r) return (Ie(e, (s, a) => nn(t, r, e, s, a, n), i), e);
  if (r.scope_ !== t) return e;
  if (!r.modified_) return (Fe(t, r.base_, !0), r.base_);
  if (!r.finalized_) {
    ((r.finalized_ = !0), r.scope_.unfinalizedDrafts_--);
    const s = r.copy_;
    let a = s,
      o = !1;
    (r.type_ === 3 && ((a = new Set(s)), s.clear(), (o = !0)),
      Ie(a, (l, u) => nn(t, r, s, l, u, n, o), i),
      Fe(t, s, !1),
      n &&
        t.patches_ &&
        W("Patches").generatePatches_(r, n, t.patches_, t.inversePatches_));
  }
  return r.copy_;
}
function nn(t, e, n, i, r, s, a) {
  if (r == null || (typeof r != "object" && !a)) return;
  const o = Ve(r);
  if (!(o && !a)) {
    if ((r === n && O(5), X(r))) {
      const l =
          s && e && e.type_ !== 3 && !lt(e.assigned_, i) ? s.concat(i) : void 0,
        u = Re(t, r, l);
      if ((wn(n, i, u), X(u))) t.canAutoFreeze_ = !1;
      else return;
    } else a && n.add(r);
    if (J(r) && !o) {
      if (
        (!t.immer_.autoFreeze_ && t.unfinalizedDrafts_ < 1) ||
        (e && e.base_ && e.base_[i] === r && o)
      )
        return;
      (Re(t, r),
        (!e || !e.scope_.parent_) &&
...
function Fe(t, e, n = !1) {
  !t.parent_ && t.immer_.autoFreeze_ && t.canAutoFreeze_ && St(e, n);
}
function Ei(t, e) {
  const n = Array.isArray(t),
    i = {
      type_: n ? 1 : 0,
      scope_: e ? e.scope_ : On(),
      modified_: !1,
      finalized_: !1,
      assigned_: {},
      parent_: e,
  ...
  n && ((r = [i]), (s = ce));
  const { revoke: a, proxy: o } = Proxy.revocable(r, s);
  return ((i.draft_ = o), (i.revoke_ = a), o);
}
var _t = {
    get(t, e) {
      if (e === $) return t;
      const n = V(t);
      if (!lt(n, e)) return Di(t, n, e);
      const i = n[e];
      return t.finalized_ || !J(i)
        ? i
        : i === Ge(t.base_, e)
          ? (Qe(t), (t.copy_[e] = ht(i, t)))
          : i;
    },
    has(t, e) {
      return e in V(t);
    ...
    set(t, e, n) {
      ...
      if (!t.modified_) {
        ...
        if ($i(n, r) && (n !== void 0 || lt(t.base_, e))) return !0;
        (Qe(t), dt(t));
      }
      return (
        (t.copy_[e] === n && (n !== void 0 || e in t.copy_)) ||
    ...
    deleteProperty(t, e) {
      return (
        Ge(t.base_, e) !== void 0 || e in t.base_
          ? ((t.assigned_[e] = !1), Qe(t), dt(t))
...
ce.deleteProperty = function (t, e) {
  return (isNaN(parseInt(e)) && O(13), ce.set.call(this, t, e, void 0));
};
ce.set = function (t, e, n) {
  return (
    e !== "length" && isNaN(parseInt(e)) && O(14),
    _t.set.call(this, t[0], e, n, t[0])
  );
};
function Ge(t, e) {
  const n = t[$];
...
function dt(t) {
  t.modified_ || ((t.modified_ = !0), t.parent_ && dt(t.parent_));
}
function Qe(t) {
  t.copy_ || (t.copy_ = ut(t.base_, t.scope_.immer_.useStrictShallowCopy_));
}
var Ti = class {
  constructor(t) {
    ((this.autoFreeze_ = !0),
      ...
      (this.produce = (e, n, i) => {
        ...
        (typeof n != "function" && O(6),
          i !== void 0 && typeof i != "function" && O(7));
        let r;
        if (J(e)) {
          const s = en(this),
            a = ht(e, void 0);
          ...
          return (Zt(s, i), tn(r, s));
        } else if (!e || typeof e != "object") {
          if (
            ((r = n(e)),
            r === void 0 && (r = e),
            r === bn && (r = void 0),
            this.autoFreeze_ && St(r, !0),
            i)
          ) {
            const s = [],
              a = [];
            (W("Patches").generateReplacementPatches_(e, r, s, a), i(s, a));
          }
          return r;
        } else O(1, e);
      }),
      ...
      typeof t?.useStrictIteration == "boolean" &&
  ...
  createDraft(t) {
    ...
    const e = en(this),
      n = ht(t, void 0);
    return ((n[$].isManual_ = !0), ft(e), n);
  }
  finishDraft(t, e) {
    const n = t && t[$];
    (!n || !n.isManual_) && O(9);
    const { scope_: i } = n;
    return (Zt(i, e), tn(void 0, i));
  }
  setAutoFreeze(t) {
    this.autoFreeze_ = t;
  }
  ...
  applyPatches(t, e) {
    ...
    return X(t) ? i(t, e) : this.produce(t, (r) => i(r, e));
  }
};
function ht(t, e) {
  const n = he(t)
    ? W("MapSet").proxyMap_(t, e)
    : Ke(t)
      ? W("MapSet").proxySet_(t, e)
      : Ei(t, e);
  return ((e ? e.scope_ : On()).drafts_.push(n), n);
}
function Ai(t) {
  return (X(t) || O(10, t), Ln(t));
}
function Ln(t) {
  if (!J(t) || Ve(t)) return t;
  const e = t[$];
  let n,
    i = !0;
  if (e) {
    if (!e.modified_) return e.base_;
    ((e.finalized_ = !0),
      (n = ut(t, e.scope_.immer_.useStrictShallowCopy_)),
      (i = e.scope_.immer_.shouldUseStrictIteration()));
  } else n = ut(t, !0);
  return (
    Ie(
...
const rn = (t) => {
  ...
  on = (t) => !!t.dispatchFromDevtools && typeof t.dispatch == "function",
  fe = new Map(),
  Se = (t) => {
    const e = fe.get(t);
    return e
      ? Object.fromEntries(
          Object.entries(e.stores).map(([n, i]) => [n, i.getState()]),
        )
      : {};
  },
  ji = (t, e, n) => {
    if (t === void 0) return { type: "untracked", connection: e.connect(n) };
    const i = fe.get(n.name);
    if (i) return { type: "tracked", store: t, ...i };
    const r = { connection: e.connect(n), stores: {} };
    return (fe.set(n.name, r), { type: "tracked", store: t, ...r });
  },
  Mi = (t, e) => {
    if (e === void 0) return;
    const n = fe.get(t);
    n &&
      (delete n.stores[e], Object.keys(n.stores).length === 0 && fe.delete(t));
  },
  Ui = (t) => {
    var e, n;
    if (!t) return;
    const i = t.split(`
`),
      r = i.findIndex((a) => a.includes("api.setState"));
    if (r < 0) return;
    const s = ((e = i[r + 1]) == null ? void 0 : e.trim()) || "";
    return (n = /.+ (.+) .+/.exec(s)) == null ? void 0 : n[1];
  },
  Ki =
    (t, e = {}) =>
    (n, i, r) => {
      const { enabled: s, anonymousActionType: a, store: o, ...l } = e;
      let u;
      try {
        u =
          (s ?? (sn ? "production" : void 0) !== "production") &&
          window.__REDUX_DEVTOOLS_EXTENSION__;
      } catch {}
      if (!u) return t(n, i, r);
      const { connection: c, ...f } = ji(o, u, l);
      let p = !0;
      ((r.setState = (S, g, y) => {
        const _ = n(S, g);
        if (!p) return _;
        const v =
          y === void 0
            ? { type: a || Ui(new Error().stack) || "anonymous" }
            : typeof y == "string"
              ? { type: y }
              : y;
        return o === void 0
      ...
      if (
        (f.type === "untracked"
          ...
          : ((f.stores[f.store] = r),
            c?.init(
              Object.fromEntries(
                Object.entries(f.stores).map(([S, g]) => [
                  S,
                  S === f.store ? h : g.getState(),
                ]),
              ),
            )),
        on(r))
        ...
        const g = r.dispatch;
        r.dispatch = (...y) => {
          ((sn ? "production" : void 0) !== "production" &&
            y[0].type === "__setState" &&
            !S &&
            (console.warn(
            ...
            case "ACTION":
              ...
              return qe(S.payload, (y) => {
                if (y.type === "__setState") {
                  ...
                  const _ = y.state[o];
                  if (_ == null) return;
                  JSON.stringify(r.getState()) !== JSON.stringify(_) && d(_);
                  return;
                }
                on(r) && r.dispatch(y);
              });
            case "DISPATCH":
              switch (S.payload.type) {
                case "RESET":
                  return (
                    d(h),
                    o === void 0 ? c?.init(r.getState()) : c?.init(Se(l.name))
                  );
                case "COMMIT":
                  if (o === void 0) {
                    c?.init(r.getState());
                  ...
                  return c?.init(Se(l.name));
                case "ROLLBACK":
                  return qe(S.state, (y) => {
                    if (o === void 0) {
                      (d(y), c?.init(r.getState()));
                      return;
                    }
                    (d(y[o]), c?.init(Se(l.name)));
                  });
                case "JUMP_TO_STATE":
                case "JUMP_TO_ACTION":
                  return qe(S.state, (y) => {
                    ...
                    JSON.stringify(r.getState()) !== JSON.stringify(y[o]) &&
                      d(y[o]);
                  });
                case "IMPORT_STATE": {
                  const { nextLiftedState: y } = S.payload,
                    _ =
                      (g = y.computedStates.slice(-1)[0]) == null
                        ? void 0
                        : g.state;
                  if (!_) return;
                  (d(o === void 0 ? _ : _[o]), c?.send(null, y));
                  return;
                }
...
const pt = (t) => (e) => {
  ...
  Bi = (t, e) => (n, i, r) => {
    ...
    const f = () => {
      ...
      p = r.setState;
    r.setState = (g, y) => (p(g, y), f());
    const d = t((...g) => (n(...g), f()), i, r);
    r.getInitialState = () => d;
    let h;
    const S = () => {
      var g, y;
      ...
      ((a = !1),
        l.forEach((x) => {
          var b;
          return x((b = i()) != null ? b : d);
        }));
      const v =
        ((y = s.onRehydrateStorage) == null
          ? void 0
          : y.call(s, (g = i()) != null ? g : d)) || void 0;
      return pt(c.getItem.bind(c))(s.name)
        .then((x) => {
          if (x)
            if (typeof x.version == "number" && x.version !== s.version) {
              if (s.migrate) {
                const b = s.migrate(x.state, x.version);
                return b instanceof Promise ? b.then((R) => [!0, R]) : [!0, b];
              }
              console.error(
        ...
        .then((x) => {
          ...
          if (_ !== o) return;
          const [R, j] = x;
          if (((h = s.merge(j, (b = i()) != null ? b : d)), n(h, !0), R))
            return f();
        })
        .then(() => {
          _ === o &&
            (v?.(h, void 0), (h = i()), (a = !0), u.forEach((x) => x(h)));
        })
        .catch((x) => {
          _ === o && v?.(void 0, x);
        });
