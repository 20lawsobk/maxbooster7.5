...
export function Sidebar({ isMobileOpen = false, onMobileClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white dark:bg-blue-950 border-r border-gray-200 dark:border-blue-900 flex flex-col h-full transition-transform duration-300 lg:translate-x-0',
          isMobileOpen ? 'translate-x-0' : '-translate-x-full'
        )}
      >
        <div className="p-4 border-b border-gray-200 dark:border-blue-900">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <Music className="w-6 h-6 text-blue-600" />
              <div className="flex flex-col">
                <h2 className="text-lg font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Max Booster</h2>
                <span className="text-xs text-gray-500 dark:text-gray-400">by B-Lawz Music</span>
              </div>
            </div>
            {/* Mobile Close Button */}
            <Button
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-800/40 dark:to-blue-700/40 text-blue-600 dark:text-white shadow-sm'
                    : 'text-gray-700 dark:text-blue-100 hover:bg-gray-100 dark:hover:bg-blue-900/50 hover:shadow-sm'
                )}
                onClick={(e) => {
        ...
        <div className="p-4 border-t border-gray-200 dark:border-blue-900 space-y-3">
