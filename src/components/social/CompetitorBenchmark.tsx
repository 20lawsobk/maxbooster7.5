...
const MOCK_YOUR_BRAND: Competitor = {
  id: 'you',
  name: 'Your Brand',
  handle: '@maxbooster',
  isYou: true,
  platforms: [
    {
      platform: 'instagram',
      handle: 'maxbooster',
      url: 'https://instagram.com/maxbooster',
      followers: 125000,
      followersChange: 3.5,
      engagement: 5.2,
      ...
      topHashtags: ['#musicproduction', '#beatmaker', '#independentartist'],
      contentMix: { images: 30, videos: 25, carousels: 20, stories: 15, reels: 10, text: 0 },
    },
    {
      platform: 'twitter',
      handle: 'maxbooster',
      url: 'https://twitter.com/maxbooster',
      followers: 45000,
      followersChange: 2.1,
      engagement: 3.8,
      ...
      avgViews: 12000,
      postFrequency: 28,
      bestPostingTimes: ['10:00 AM', '2:00 PM', '8:00 PM'],
      topHashtags: ['#musicindustry', '#streaming', '#newmusic'],
      contentMix: { images: 20, videos: 15, carousels: 0, stories: 0, reels: 0, text: 65 },
    },
  ],
  totalFollowers: 170000,
  totalFollowersChange: 3.1,
  avgEngagement: 4.5,
  avgEngagementChange: 0.65,
  shareOfVoice: 18,
  postFrequency: 42,
  avgPostsPerWeek: 21,
  topContentTypes: ['Behind-the-scenes', 'Tips & Tutorials', 'New Releases'],
  bestPerformingPosts: [],
  audienceGrowth: Array.from({ length: 30 }, (_, i) => ({
    date: format(subDays(new Date(), 29 - i), 'yyyy-MM-dd'),
    value: 160000 + Math.floor(Math.random() * 10000) + i * 300,
  })),
    ...
    platforms: [
      {
        ...
        avgViews: 85000,
        postFrequency: 12,
        bestPostingTimes: ['9:00 AM', '6:00 PM', '9:00 PM'],
        topHashtags: ['#distrokid', '#musicdistribution', '#indiemusic'],
        contentMix: { images: 40, videos: 30, carousels: 15, stories: 10, reels: 5, text: 0 },
      },
      {
        platform: 'twitter',
        handle: 'distrokid',
        ...
        avgViews: 25000,
        postFrequency: 25,
        bestPostingTimes: ['12:00 PM', '3:00 PM', '8:00 PM'],
        topHashtags: ['#musicindustry', '#spotify', '#applemusic'],
        contentMix: { images: 25, videos: 20, carousels: 0, stories: 0, reels: 0, text: 55 },
      },
    ],
    totalFollowers: 430000,
    totalFollowersChange: 2.1,
    avgEngagement: 3.5,
    avgEngagementChange: 0.15,
    shareOfVoice: 32,
    postFrequency: 37,
    avgPostsPerWeek: 18,
    topContentTypes: ['Artist Success Stories', 'Platform Updates', 'Industry News'],
    bestPerformingPosts: [],
    audienceGrowth: Array.from({ length: 30 }, (_, i) => ({
      date: format(subDays(new Date(), 29 - i), 'yyyy-MM-dd'),
      value: 410000 + Math.floor(Math.random() * 20000) + i * 600,
    })),
    engagementTrend: Array.from({ length: 30 }, (_, i) => ({
      date: format(subDays(new Date(), 29 - i), 'yyyy-MM-dd'),
      value: 3.0 + Math.random() * 1.5,
    })),
    lastUpdated: new Date().toISOString(),
    color: '#6366f1',
  },
    ...
    platforms: [
      {
        platform: 'instagram',
        handle: 'tunecore',
        url: 'https://instagram.com/tunecore',
        followers: 198000,
        followersChange: 1.5,
        engagement: 3.8,
        ...
        avgViews: 62000,
        postFrequency: 8,
        bestPostingTimes: ['10:00 AM', '5:00 PM', '8:00 PM'],
        topHashtags: ['#tunecore', '#independentartist', '#musicbusiness'],
        contentMix: { images: 35, videos: 35, carousels: 20, stories: 5, reels: 5, text: 0 },
      },
      {
        platform: 'tiktok',
        handle: 'tunecore',
        url: 'https://tiktok.com/@tunecore',
        followers: 89000,
        followersChange: 5.2,
        engagement: 8.5,
        ...
        avgViews: 250000,
        postFrequency: 15,
        bestPostingTimes: ['7:00 PM', '9:00 PM', '11:00 PM'],
        topHashtags: ['#musicbiz', '#artisttips', '#fyp'],
        contentMix: { images: 0, videos: 100, carousels: 0, stories: 0, reels: 0, text: 0 },
      },
    ],
    totalFollowers: 287000,
    totalFollowersChange: 3.4,
    avgEngagement: 6.15,
    avgEngagementChange: 0.75,
    shareOfVoice: 24,
    postFrequency: 23,
    avgPostsPerWeek: 12,
    topContentTypes: ['Educational Content', 'Artist Tips', 'Success Stories'],
    bestPerformingPosts: [],
    audienceGrowth: Array.from({ length: 30 }, (_, i) => ({
      date: format(subDays(new Date(), 29 - i), 'yyyy-MM-dd'),
      value: 270000 + Math.floor(Math.random() * 17000) + i * 550,
    })),
    engagementTrend: Array.from({ length: 30 }, (_, i) => ({
      date: format(subDays(new Date(), 29 - i), 'yyyy-MM-dd'),
      value: 5.0 + Math.random() * 2.5,
    })),
    lastUpdated: new Date().toISOString(),
    color: '#ec4899',
  },
    ...
    platforms: [
      {
        ...
        topHashtags: ['#cdbaby', '#indieartist', '#musicroyalties'],
        contentMix: { images: 45, videos: 25, carousels: 15, stories: 10, reels: 5, text: 0 },
      },
      {
        platform: 'youtube',
        handle: 'cdbaby',
        url: 'https://youtube.com/cdbaby',
        followers: 156000,
        followersChange: 1.2,
        engagement: 4.5,
        engagementChange: 0.8,
        ...
        avgViews: 125000,
        postFrequency: 3,
        bestPostingTimes: ['3:00 PM', '6:00 PM'],
        topHashtags: ['#musicmarketing', '#artisttutorials', '#musicbusiness'],
        contentMix: { images: 0, videos: 100, carousels: 0, stories: 0, reels: 0, text: 0 },
      },
    ],
    totalFollowers: 476000,
    totalFollowersChange: 1.0,
    avgEngagement: 3.3,
    avgEngagementChange: 0.25,
    shareOfVoice: 28,
    postFrequency: 8,
    avgPostsPerWeek: 4,
    topContentTypes: ['Long-form Educational', 'Webinars', 'Artist Spotlights'],
    bestPerformingPosts: [],
    audienceGrowth: Array.from({ length: 30 }, (_, i) => ({
      date: format(subDays(new Date(), 29 - i), 'yyyy-MM-dd'),
      value: 465000 + Math.floor(Math.random() * 11000) + i * 350,
    })),
    engagementTrend: Array.from({ length: 30 }, (_, i) => ({
      date: format(subDays(new Date(), 29 - i), 'yyyy-MM-dd'),
      value: 2.8 + Math.random() * 1.2,
    })),
    lastUpdated: new Date().toISOString(),
    color: '#22c55e',
  },
...
const MOCK_INSIGHTS: BenchmarkInsight[] = [
  {
    id: '1',
    type: 'opportunity',
    title: 'Higher Engagement Rate',
    description: 'Your engagement rate is 28% higher than the industry average',
    metric: 'Engagement Rate',
    yourValue: 4.5,
    avgValue: 3.5,
    topValue: 6.15,
    recommendation: 'Continue your current content strategy and consider A/B testing to further optimize',
  },
  {
    id: '2',
    type: 'threat',
    title: 'Competitor Growing Faster on TikTok',
    description: 'TuneCore is growing 5.2% monthly on TikTok while you have no presence',
    competitorId: '2',
    metric: 'TikTok Growth',
    yourValue: 0,
    avgValue: 3.4,
    topValue: 5.2,
    recommendation: 'Consider expanding to TikTok to capture the younger demographic',
  },
  {
    id: '3',
    type: 'weakness',
    title: 'Lower Post Frequency',
    description: 'You post 42% less than the top competitor',
    metric: 'Weekly Posts',
    yourValue: 21,
    avgValue: 11,
    topValue: 18,
    recommendation: 'Increase posting frequency to 25-30 posts per week for better visibility',
  },
  {
    id: '4',
    type: 'strength',
    title: 'Strong Video Performance',
    description: 'Your video content gets 35% more engagement than competitors',
    metric: 'Video Engagement',
    yourValue: 6.8,
    avgValue: 5.0,
    topValue: 6.8,
    recommendation: 'Double down on video content, especially behind-the-scenes and tutorials',
  },
];
...
export function CompetitorBenchmark() {
  ...
  const { data: competitorsData, isLoading } = useQuery({
    ...
    placeholderData: { competitors: MOCK_COMPETITORS, yourBrand: MOCK_YOUR_BRAND },
  });
  ...
  const competitors = competitorsData?.competitors || MOCK_COMPETITORS;
  const yourBrand = competitorsData?.yourBrand || MOCK_YOUR_BRAND;
  const insights = insightsData?.insights || MOCK_INSIGHTS;
