  ...
  try {
    ...
    if (existingWorkspace?.length === 0) {
      const [workspace] = await db
        ...
        .values({
          ...
          ownerId: adminId,
          description:
            "Official workspace for B-Lawz Music team and collaborators",
          isActive: true,
          settings: {
      ...
      await db?.insert(listings).values([
        {
          ...
          description:
            "Over 200 premium samples including drums, melodies, and FX",
          priceCents: 4999,
          currency: "usd",
    ...
    if (existingVoice?.length === 0) {
      await db?.insert(userBrandVoices).values({
        ...
        description:
          "Authentic, confident, and creative voice for B-Lawz Music brand",
        tone: "confident",
      ...
      await db?.insert(contentCalendar).values([
        {
          ...
          content: {
            caption:
              "Late night in the studio. Something special coming soon...",
            hashtags: ["studiolife", "newmusic", "producer"],
          },
        ...
        },
        {
          ...
          status: "planned",
          content: {
            caption: "Big announcement coming next week. Y'all ready?",
            hashtags: ["newmusic"],
          },
      ...
      await db?.insert(notifications).values([
        {
          ...
          message:
            "Your lifetime account is fully activated. Explore all premium features.",
          isRead: true,
          actionUrl: "/dashboard",
        },
        {
          ...
          message:
            "Congratulations! Your music has reached 10,000 streams on Spotify.",
          isRead: false,
          actionUrl: "/analytics",
        },
      ]);
