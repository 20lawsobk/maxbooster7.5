...
const requireWorkspaceMember = async (
  ...
  try {
    ...
    const workspaceId = (req.params.id as string) || (req.params.workspaceId as string);
...
router.get(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const roles = await rbacService?.getWorkspaceRoles((req.params.id as string));
      res.json({ roles });
    } catch (error) {
...
router.post(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      const result = await rbacService?.createRole((req.params.id as string), {
...
router.get(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      const logs = await workspaceService?.getAuditLog((req.params.id as string), 1000, 0);
      ...
      if (format === "csv") {
        ...
        const safeId = (req.params.id as string)
...
router.get(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const links = await workspaceService?.getShareLinks((req.params.projectId as string));
      res.json({ links });
    } catch (error) {
...
router.get(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const config = await ssoService?.getSSOConfig((req.params.id as string));
      res.json({ config });
    } catch (error) {
...
router.post(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const result = await ssoService?.enableSSO((req.params.id as string), req.user!.id);
...
router.post(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const result = await ssoService?.disableSSO((req.params.id as string), req.user!.id);
...
router.post(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const result = await ssoService?.testSSOConnection((req.params.id as string));
...
router.post(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const result = await ssoService?.enableSCIM((req.params.id as string), req.user!.id);
...
router.post(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const result = await ssoService?.disableSCIM((req.params.id as string), req.user!.id);
...
router.get(
  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      const catalog = await workspaceService?.getCatalog((req.params.id as string));
      res.json({ catalog });
    } catch (error) {
