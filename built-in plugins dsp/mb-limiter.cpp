 ...
 * Version  : 1.0.0
 * Author   : Max Booster
 * Desc     : Brickwall limiter for mastering
 *
...
class MbLimiter : public PluginBase {
public:
    static constexpr const char* PLUGIN_ID      = "mb-limiter";
    static constexpr const char* PLUGIN_NAME    = "MB Limiter";
...
private:
    ...
    inline float processSample(float input, const Parameters& params) {
        // DSP implementation for MB Limiter
        return input;
    }
};
