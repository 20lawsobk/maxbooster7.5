 ...
 * Version  : 1.0.0
 * Author   : Max Booster
 * Desc     : Lush string ensemble with multiple articulations
 *
...
class MbStrings : public PluginBase {
public:
    static constexpr const char* PLUGIN_ID      = "mb-strings";
    static constexpr const char* PLUGIN_NAME    = "MB Strings";
...
private:
    ...
    inline float processSample(float input, const Parameters& params) {
        // DSP implementation for MB Strings
        return input;
    }
};
