...
export class CompressorPlugin extends BasePlugin {
  ...
  private rebuildInputPath(): void {
    ...
    try {
      this.input.disconnect(this.inputHPF);
    } catch (e) {}
    try {
  ...
  setParameters(params: Record<string, any>): void {
    ...
    if (params.inputHPFFrequency !== undefined)
      this.setInputHPFFrequency(params.inputHPFFrequency);
    if (params.sidechainHPF !== undefined)
      this.setInputHPF(params.sidechainHPF);
    if (params.sidechainHPFFrequency !== undefined)
      this.setInputHPFFrequency(params.sidechainHPFFrequency);
