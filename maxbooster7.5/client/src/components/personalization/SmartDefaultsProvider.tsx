...
const genrePresets: Record<string, Partial<GenrePreset>> = {
  "hip-hop": {
    defaultBPM: 90,
    suggestedPlatforms: ["spotify", "tiktok", "youtube"],
    postingFrequency: "high",
  },
  electronic: {
    defaultBPM: 128,
    suggestedPlatforms: ["spotify", "soundcloud", "beatport"],
    postingFrequency: "medium",
  },
  pop: {
    defaultBPM: 120,
    suggestedPlatforms: ["spotify", "tiktok", "instagram"],
    postingFrequency: "high",
  },
  rock: {
    defaultBPM: 140,
    suggestedPlatforms: ["spotify", "youtube", "bandcamp"],
    postingFrequency: "medium",
  },
  "r&b": {
    defaultBPM: 85,
    suggestedPlatforms: ["spotify", "apple-music", "instagram"],
    postingFrequency: "medium",
  },
  indie: {
    defaultBPM: 110,
    suggestedPlatforms: ["bandcamp", "spotify", "youtube"],
    postingFrequency: "low",
  },
  classical: {
    defaultBPM: 60,
    suggestedPlatforms: ["spotify", "apple-music", "youtube"],
    postingFrequency: "low",
  },
  jazz: {
    defaultBPM: 120,
    suggestedPlatforms: ["spotify", "bandcamp", "tidal"],
    postingFrequency: "low",
  },
};
