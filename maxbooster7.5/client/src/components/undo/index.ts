...
export type {
  ...
  RestorePoint,
} from "./RestorePointDialog";

export { GlobalUndoProvider, useGlobalUndoContext } from "./GlobalUndoProvider";
export type {
  GlobalUndoProviderProps,
  GlobalUndoContextValue,
  RecoveryPoint as GlobalRecoveryPoint,
  GlobalUndoState,
} from "./GlobalUndoProvider";

export {
  UndoKeyboardHandler,
  useUndoKeyboardShortcuts,
} from "./UndoKeyboardHandler";
...
export type {
  ...
  RecoveryPoint as RecoveryPointItem,
} from "./RecoveryPointManager";
