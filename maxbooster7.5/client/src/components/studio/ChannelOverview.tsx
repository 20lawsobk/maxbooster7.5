...
export function ChannelOverview({
  ...
  const getTrackTypeIcon = () => {
    switch (trackType) {
      ...
      case "bus":
        return (
          <ArrowDownToLine className="h-4 w-4" style={{ color: trackColor }} />
        );
      case "master":
    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          ...
          transition={{ duration: 0.2 }}
        >
          <div className="h-2 w-full" style={{ background: trackColor }} />
                ...
                <div className="space-y-2">
                  {inserts.map((insert, index) => (
                    <motion.div
                      ...
                      style={{
                        background: insert.bypass
                          ? "transparent"
                          : `${getPluginTypeColor(insert.type)}15`,
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{
                            background: getPluginTypeColor(insert.type),
                          }}
                        />
                        <div>
                          <span
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex items-center gap-1.5">
                          ...
                          <Switch
                            ...
                            onCheckedChange={() =>
                              onInsertBypassToggle(insert.id)
                            }
                            className="scale-75"
                          />
                        </div>
                    ...
                    >
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {onSendMuteToggle && (
                              <Button
                                aria-label={
                                  send.mute ? "Unmute send" : "Mute send"
                                }
                        ...
                        <Knob
                          value={send.level}
                          onChange={(value) =>
                            onSendLevelChange(send.busId, value)
                          }
                          size={36}
                          min={0}
                          max={1}
            ...
            >
              <div className="space-y-3">
                <div>
                  ...
                  <Select
                    value={io.input}
                    onValueChange={(value) => onIOChange?.("input", value)}
                  >
                    <SelectTrigger
                ...
                <div>
                  ...
                  <Select
                    value={io.output}
                    onValueChange={(value) => onIOChange?.("output", value)}
                  >
                    <SelectTrigger
                      className="h-8 text-xs"
                      style={{
