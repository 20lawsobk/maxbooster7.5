    ...
    <div className="flex-1 flex items-center justify-center p-8">
      ...
      >
        ...
        <p className="text-white/50 mb-8 max-w-md mx-auto">
          Your creative journey starts here. Add tracks, import audio, or let AI help you create something amazing.
        </p>
        ...
        <div className="flex items-center justify-center gap-6 text-xs text-white/30">
          <div className="flex items-center gap-2">
            <kbd className="px-2 py-1 rounded bg-white/10 text-white/50 font-mono">⌘ N</kbd>
            <span>New Track</span>
          </div>
          <div className="flex items-center gap-2">
            <kbd className="px-2 py-1 rounded bg-white/10 text-white/50 font-mono">Space</kbd>
            <span>Play/Pause</span>
          </div>
          <div className="flex items-center gap-2">
            <kbd className="px-2 py-1 rounded bg-white/10 text-white/50 font-mono">?</kbd>
            <span>Shortcuts</span>
          </div>
        </div>
        ...
        >
          <p className="text-xs text-white/30 flex items-center justify-center gap-2">
            ...
            Pro Tip: Press <kbd className="px-1.5 py-0.5 rounded bg-white/10 text-white/50 font-mono text-[10px]">Tab</kbd> to toggle Zero-Chrome mode for distraction-free editing
          </p>
        </motion.div>
      </motion.div>
    </div>
