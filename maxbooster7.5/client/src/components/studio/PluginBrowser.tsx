...
export function PluginBrowser({
  ...
  const typesList =
    selectedCategory === "instrument" ? INSTRUMENT_TYPES : EFFECT_TYPES;
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-700">
          <div className="flex items-center gap-4">
            ...
            <div className="flex rounded-lg bg-slate-800 p-0.5">
              ...
              <button
                onClick={() => {
                  setSelectedCategory("instrument");
                  setSelectedType(null);
                }}
                className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm transition-all ${
        ...
        <div className="flex flex-1 overflow-hidden">
          <div className="w-44 border-r border-slate-700 p-2 overflow-y-auto">
            ...
            >
              ...
              All{" "}
              {selectedCategory === "instrument" ? "Instruments" : "Effects"}
            </button>
                  ...
                  >
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <div
                            ...
                            style={{
                              backgroundColor: getTypeColor(plugin.type),
                            }}
                          />
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <span
                        ...
                        style={{
                          backgroundColor: `${getTypeColor(plugin.type)}20`,
