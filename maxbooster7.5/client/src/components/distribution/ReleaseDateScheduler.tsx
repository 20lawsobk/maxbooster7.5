  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Schedule your release date. Earlier submissions get better playlist
          consideration.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>Spotify Editorial Playlisting:</strong> Submit at least 2
            weeks before release for editorial review. 4+ weeks is recommended
              ...
              {isDateValid(selectedDate) ? (
                ...
                <>
                  ...
                  <p className="text-destructive">
                    Release date must be at least {minWeeksAhead} weeks from
                    today
                  </p>
                </>
              )}
        ...
        {selectedDate && getDayOfWeek(selectedDate) !== "Friday" && (
          <Alert>
            <Info className="h-4 w-4" />
            <AlertDescription>
              <strong>Tip:</strong> Most releases go live on Fridays (industry
              standard for new music). Consider{" "}
              {format(
                addDays(selectedDate, (5 - selectedDate.getDay() + 7) % 7),
                "MMMM dd",
              )}
              instead?
            </AlertDescription>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2 p-2 bg-muted/50 rounded">
                ...
                <div>
                  <p className="font-medium">
                    {format(addWeeks(today, 1), "MMM dd")}: Available on
                    platforms
                  </p>
                  <p className="text-muted-foreground text-xs">
