  ...
  const factors: SecurityFactor[] = useMemo(
    () => [
      ...
      },
      {
        ...
        action: !has2FA
          ? { label: "Enable", onClick: () => onEnable2FA?.() }
          : undefined,
      },
      {
        id: "recovery",
      ...
      },
      {
        ...
        action: !hasRecentPasswordChange
          ? { label: "Update", onClick: () => onChangePassword?.() }
          : undefined,
      },
      {
        id: "single_session",
        ...
        action: hasMultipleSessions
          ? { label: "Review", onClick: () => onReviewSessions?.() }
          : undefined,
      },
      {
        id: "no_suspicious",
            ...
            {factors.map((factor) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p
                      className={`text-sm font-medium ${factor.enabled ? "text-green-700 dark:text-green-400" : ""}`}
                    >
                      {factor.name}
                    </p>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700 dark:text-amber-500 mt-0.5">
                  Enable {recommendations.length} more feature
                  {recommendations.length > 1 ? "s" : ""} to increase your
                  security score.
                </p>
              </div>
            </div>
