...
export default function ContextualFeatureHint({
  currentPage,
}: ContextualFeatureHintProps) {
  ...
  const getActiveHint = (): FeatureHint | null => {
    const completedSteps =
      (userProgress as Record<string, unknown>)?.completedSteps || [];
    ...
    const availableHints = FEATURE_HINTS.filter(
      (hint) =>
