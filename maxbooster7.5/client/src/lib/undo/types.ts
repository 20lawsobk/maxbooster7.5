export type ActionCategory = 'CRUD' | 'navigation' | 'settings' | 'file' | 'track' | 'release' | 'social' | 'collaboration' | 'other';
...
export interface ActionGroup {
  ...
  metadata: Pick<ActionMetadata, 'timestamp' | 'userId' | 'module' | 'description'>;
  isUndone: boolean;
}
...
export interface UndoManagerConfig {
  ...
  onHistoryChange?: (history: UndoableAction[], redoStack: UndoableAction[]) => void;
}
