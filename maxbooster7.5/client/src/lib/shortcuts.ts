import { ShortcutDefinition, ShortcutContext, ShortcutCategory, ShortcutModifier } from './shortcuts/types';
...
export function getShortcutsByContext(context: ShortcutContext): ShortcutDefinition[] {
  return ALL_SHORTCUTS.filter(s => s.context === context || s.context === 'global');
}
...
export const SHORTCUT_MAPPINGS: ShortcutMapping = {
  ...
  'command-palette': { key: 'k', modifiers: ['cmd'], description: 'Command Palette' },
