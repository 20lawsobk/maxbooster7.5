      ...
      <section className="relative px-4 pt-20 pb-16 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Max Booster respects the intellectual property rights of others and
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="mb-8 dark:bg-gray-900 dark:border-gray-700">
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  Max Booster complies with the Digital Millennium Copyright Act
                  (DMCA) and will respond to valid notices of copyright
                  infringement. If you believe that your copyrighted work has
                  been copied in a way that constitutes copyright infringement
                  and is accessible on our platform, please notify us.
                </p>
                <p>
                  We take copyright infringement seriously and will promptly
                  remove or disable access to content that is claimed to be
                  infringing upon the copyright of any person.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8 dark:bg-gray-900 dark:border-gray-700">
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  If you are a copyright owner (or authorized to act on behalf
                  of one) and believe that content on Max Booster infringes your
                  copyright, you may submit a DMCA takedown notice containing:
                </p>
            ...
            <CardContent className="p-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Please allow 1-2 business days for processing. We will notify
                  the affected user and may request additional information if
                  needed.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-4">
                  ...
                  it to the original complainant. If they do not file a court
                  action within 10-14 business days, we may restore the content.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="dark:bg-gray-900 dark:border-gray-700">
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  Max Booster maintains a policy of terminating accounts of
                  users who are repeat infringers. We may suspend or terminate
                ...
                <p className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4 text-sm">
                  <strong>Note:</strong> Submitting a false DMCA notice may
                  result in legal liability. Please ensure your claim is
                  legitimate before filing.
                </p>
              </div>
            </CardContent>
          </Card>
