...
export const BUSINESS_CONFIG = {
  ...
  helpDesk: {
    ...
    welcomeMessage:
      "Hi! I'm Max, your AI assistant for Max Booster. I'm here to help you with any questions about music distribution, royalties, the studio, social media features, or anything else. How can I assist you today?",
    capabilities: [
