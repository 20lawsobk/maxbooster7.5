...
**Data Controller:** Max Booster, Inc.  
**Compliance:** GDPR, CCPA, SOC2, ISO 27001

## 1. Introduction

Max Booster ("we," "our," or "us") is committed to protecting your privacy and personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our music career management platform.

This policy complies with the EU General Data Protection Regulation (GDPR), California Consumer Privacy Act (CCPA), and other applicable privacy laws.
...
- Process royalty payments and revenue sharing
...
**Privacy Shield:** We monitor Privacy Shield successor frameworks and adapt as regulations evolve.
...
**Financial Data:** 7 years (tax and audit requirements)  
...
We provide similar rights to users worldwide, regardless of location.
...
- Regular security audits (SOC2, ISO 27001)
...
Max Booster is not directed to children under 16. We do not knowingly collect personal data from children under 16.

If you believe a child under 16 has provided us with personal data, please contact us at privacy@maxbooster.com, and we will delete such information.

**Parental Consent:** Users aged 13-15 require parental consent in compliance with COPPA (US) and GDPR (EU).
...
Our platform may contain links to third-party websites and services. We are not responsible for privacy practices of third parties. Please review their privacy policies.
...
**Version History:** Available at maxbooster.com/privacy/history
...
EU/EEA users have the right to lodge a complaint with their local data protection authority.
...
We value your trust and work hard to earn it every day.
