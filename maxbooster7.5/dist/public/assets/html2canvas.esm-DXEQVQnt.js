...
var cA = (function () {
    ...
    return (
      (e.prototype.add = function (A, t, r, B) {
        return new e(
          this.left + A,
          this.top + t,
          this.width + r,
...
for (var le = 0; le < nt.length; le++) on[nt.charCodeAt(le)] = le;
var st = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
  zA = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (var fe = 0; fe < st.length; fe++) zA[st.charCodeAt(fe)] = fe;
var Qn = function (e) {
    var A = e.length * 0.75,
      t = e.length,
      r,
    ...
    var o =
        ...
        typeof Uint8Array.prototype.slice < "u"
          ? new ArrayBuffer(A)
          : new Array(A),
      Q = Array.isArray(o) ? o : new Uint8Array(o);
    for (r = 0; r < t; r += 4)
      ((n = zA[e.charCodeAt(r)]),
        (s = zA[e.charCodeAt(r + 1)]),
        (i = zA[e.charCodeAt(r + 2)]),
        (a = zA[e.charCodeAt(r + 3)]),
        (Q[B++] = (n << 2) | (s >> 4)),
        (Q[B++] = ((s & 15) << 4) | (i >> 2)),
        (Q[B++] = ((i & 3) << 6) | (a & 63)));
    return o;
  ...
  at = function (e, A, t) {
    return e.slice
      ? e.slice(A, t)
      : new Uint16Array(Array.prototype.slice.call(e, A, t));
  },
  Hn = function (e, A, t) {
    return e.slice
      ? e.slice(A, t)
      : new Uint32Array(Array.prototype.slice.call(e, A, t));
  },
  pn = function (e, A) {
    var t = Qn(e),
      r = Array.isArray(t) ? wn(t) : new Uint32Array(t),
      B = Array.isArray(t) ? gn(t) : new Uint16Array(t),
      n = 24,
      s = at(B, n / 2, r[4] / 2),
      i = r[5] === 2 ? at(B, (n + r[4]) / 2) : Hn(r, Math.ceil((n + r[4]) / 4));
  ...
  vn = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (var Ue = 0; Ue < it.length; Ue++) vn[it.charCodeAt(Ue)] = Ue;
var yn =
  ...
  Vn = function (e, A, t, r, B) {
    if (t[r] === 0) return I;
    var n = r - 1;
    if (Array.isArray(B) && B[n] === !0) return I;
    var s = n - 1,
      i = n + 1,
      a = A[n],
      o = s >= 0 ? A[s] : 0,
    ...
    if (
      Rr.get(e[n]) === Dr ||
      ((a === he || a === de) && Rr.get(e[i]) === Dr) ||
      a === Qt ||
      Q === Qt ||
      a === gt ||
      ([FA, br, $A].indexOf(a) === -1 && Q === gt) ||
      [Fe, WA, bn, SA, OA].indexOf(Q) !== -1 ||
      lt(n, A) === ZA ||
      wr(Qr, ZA, n, A) ||
      wr([Fe, WA], Tr, n, A) ||
      wr(wt, wt, n, A)
    ...
    if (
      ...
      (QA.indexOf(Q) !== -1 && a === j) ||
      (QA.indexOf(a) !== -1 && Q === j) ||
      (a === ee && [Qe, he, de].indexOf(Q) !== -1) ||
      ([Qe, he, de].indexOf(a) !== -1 && Q === Ae) ||
      (QA.indexOf(a) !== -1 && Ct.indexOf(Q) !== -1) ||
      (Ct.indexOf(a) !== -1 && QA.indexOf(Q) !== -1) ||
      ([ee, Ae].indexOf(a) !== -1 &&
        (Q === j || ([ZA, $A].indexOf(Q) !== -1 && A[i + 1] === j))) ||
      ([ZA, $A].indexOf(a) !== -1 && Q === j) ||
    ...
    if (
      (Gr === a && [Gr, Ge, Sr, Or].indexOf(Q) !== -1) ||
      ([Ge, Sr].indexOf(a) !== -1 && [Ge, Re].indexOf(Q) !== -1) ||
      ([Re, Or].indexOf(a) !== -1 && Q === Re) ||
      (ut.indexOf(a) !== -1 && [ct, Ae].indexOf(Q) !== -1) ||
      (ut.indexOf(Q) !== -1 && a === ee) ||
      (QA.indexOf(a) !== -1 && QA.indexOf(Q) !== -1) ||
      (a === SA && QA.indexOf(Q) !== -1) ||
      (QA.concat(j).indexOf(a) !== -1 && Q === ZA && On.indexOf(e[i]) === -1) ||
      (QA.concat(j).indexOf(Q) !== -1 && a === WA)
    )
      return I;
    if (a === gr && Q === gr) {
  ...
  ms = function (e) {
    ...
    var s = n.length,
      i = s ? parseInt(S.apply(void 0, n), 10) : 0;
    (e[A] === uB || e[A] === cB) && A++;
    var a = 1;
    ...
    return (
      ...
      (e.prototype.consumeToken = function () {
        ...
        switch (A) {
          ...
          case $n:
            if (
              this.peekCodePoint(0) === zn &&
              this.peekCodePoint(1) === Z &&
              this.peekCodePoint(2) === Z
            )
      ...
      (e.prototype.consumeIdentLikeToken = function () {
        ...
        return A.toLowerCase() === "url" && this.peekCodePoint(0) === Ie
      ...
      (e.prototype.consumeUrlToken = function () {
        ...
        if (t === pe || t === He) {
          ...
          return r.type === 0 &&
            ...
            this.peekCodePoint(0) === nA || this.peekCodePoint(0) === jA)
  ...
  X = { type: 17, number: 0, flags: ce },
  $r = { type: 16, number: 50, flags: ce },
  hA = { type: 16, number: 100, flags: ce },
  re = function (e, A, t) {
    var r = e[0],
      B = e[1];
  ...
  IB = function (e) {
    return (
      e.type === 15 &&
      (e.unit === dB || e.unit === EB || e.unit === HB || e.unit === pB)
    );
  },
  vB = function (e) {
    var A = e
  ...
  dA = function (e, A, t, r) {
    return (
      ((e << 24) | (A << 16) | (t << 8) | (Math.round(r * 255) << 0)) >>> 0
    );
  },
  Et = function (e, A) {
...
var pt = function (e, A) {
    var t = A.filter(PA),
      ...
      n = t[2],
      s = t[3],
      i = (r.type === 17 ? AA(r.number) : Ar.parse(e, r)) / (Math.PI * 2),
      a = M(B) ? B.number / 100 : 0,
      o = M(n) ? n.number / 100 : 0,
      Q = typeof s < "u" && M(s) ? b(s, 1) : 1;
    if (a === 0) return dA(o * 255, o * 255, o * 255, 1);
    var g = o <= 0.5 ? o * (a + 1) : o + a - o * a,
      w = o * 2 - g,
      f = ur(w, g, i + 1 / 3),
      c = ur(w, g, i),
      C = ur(w, g, i - 1 / 3);
  ...
  js = { hsl: pt, hsla: pt, rgb: Ht, rgba: Ht },
  se = function (e, A) {
  ...
  It = function (e, A) {
    ...
    for (var o = null, s = 0; s < B.length; s++) {
      ...
      if (Q === null) o === null && (o = s);
        ...
        for (
          var g = s - o, w = B[o - 1], f = (Q - w) / (g + 1), c = 1;
          c <= g;
          c++
        )
          B[o + c - 1] = f * c;
  ...
  ea = function (e, A, t) {
    var r = typeof e == "number" ? e : Aa(e, A, t),
      B = Math.abs(A * Math.sin(r)) + Math.abs(t * Math.cos(r)),
      n = A / 2,
      s = t / 2,
      i = B / 2,
  ...
  ra = function (e, A, t, r, B) {
    ...
    return (
      Array.isArray(e.size) &&
        ((n = b(e.size[0], r)),
        (s = e.size.length === 2 ? b(e.size[1], B) : n)),
      [n, s]
    );
  },
  ta = function (e, A) {
  ...
  Ba = function (e, A) {
    ...
    return (
      ...
      B === 1
        ? { angle: (t + AA(180)) % AA(360), stops: r, type: B }
        ...
        if (
          (i === 0
            ? (a = s.reduce(function (Q, g) {
                ...
                else if (M(g) || pA(g)) return (n.push(g), !1);
                return Q;
              }, a))
            : i === 1 &&
              (a = s.reduce(function (Q, g) {
...
function ia(e) {
  return (
    !(e.type === 20 && e.value === "none") && (e.type !== 18 || !!SB[e.name])
  );
}
var SB = {
    "linear-gradient": ta,
...
var Ga = {
    ...
    type: 2,
    parse: function (e, A) {
      return A === "strict" ? Je.STRICT : Je.NORMAL;
    },
  },
  Ra = { name: "line-height", initialValue: "normal", prefix: !1, type: 4 },
  yt = function (e, A) {
    return D(e) && e.value === "normal"
      ? 1.2 * A
      : e.type === 17
        ? A * e.number
        : M(e)
  ...
  ni = { matrix: ti, matrix3d: Bi },
  Kt = { type: 16, number: 50, flags: ce },
  si = [Kt, Kt],
  ai = {
...
var oi = {
  ...
  Qi = {
    ...
    parse: function (e, A) {
      ...
      if (kA(A)) return { auto: !1, order: A.number };
  ...
  li = {
    ...
    prefix: !1,
    parse: function (e, A) {
      return kA(A) ? A.number : D(A) && A.value === "bold" ? 700 : 400;
    },
  },
  fi = {
    name: "font-variant",
  ...
  Ki = (function () {
    function e(A, t) {
      var r, B;
      ((this.animationDuration = U(A, Ei, t.animationDuration)),
        (this.backgroundClip = U(A, zs, t.backgroundClip)),
        (this.backgroundColor = U(A, $s, t.backgroundColor)),
        (this.backgroundImage = U(A, oa, t.backgroundImage)),
        (this.backgroundOrigin = U(A, Qa, t.backgroundOrigin)),
        (this.backgroundPosition = U(A, ga, t.backgroundPosition)),
        (this.backgroundRepeat = U(A, wa, t.backgroundRepeat)),
        (this.backgroundSize = U(A, Ca, t.backgroundSize)),
        (this.borderTopColor = U(A, la, t.borderTopColor)),
        (this.borderRightColor = U(A, fa, t.borderRightColor)),
        (this.borderBottomColor = U(A, Ua, t.borderBottomColor)),
        (this.borderLeftColor = U(A, Fa, t.borderLeftColor)),
        (this.borderTopLeftRadius = U(A, ha, t.borderTopLeftRadius)),
        (this.borderTopRightRadius = U(A, da, t.borderTopRightRadius)),
        (this.borderBottomRightRadius = U(A, Ea, t.borderBottomRightRadius)),
        (this.borderBottomLeftRadius = U(A, Ha, t.borderBottomLeftRadius)),
        (this.borderTopStyle = U(A, pa, t.borderTopStyle)),
        (this.borderRightStyle = U(A, Ia, t.borderRightStyle)),
        (this.borderBottomStyle = U(A, va, t.borderBottomStyle)),
        (this.borderLeftStyle = U(A, ya, t.borderLeftStyle)),
        (this.borderTopWidth = U(A, Ka, t.borderTopWidth)),
        (this.borderRightWidth = U(A, ma, t.borderRightWidth)),
        (this.borderBottomWidth = U(A, La, t.borderBottomWidth)),
        (this.borderLeftWidth = U(A, Da, t.borderLeftWidth)),
        (this.boxShadow = U(A, pi, t.boxShadow)),
        (this.color = U(A, ba, t.color)),
        (this.direction = U(A, xa, t.direction)),
        (this.display = U(A, Ta, t.display)),
        (this.float = U(A, Oa, t.cssFloat)),
        (this.fontFamily = U(A, Ci, t.fontFamily)),
        (this.fontSize = U(A, ui, t.fontSize)),
        (this.fontStyle = U(A, Ui, t.fontStyle)),
        (this.fontVariant = U(A, fi, t.fontVariant)),
        (this.fontWeight = U(A, li, t.fontWeight)),
        (this.letterSpacing = U(A, Ma, t.letterSpacing)),
        (this.lineBreak = U(A, Ga, t.lineBreak)),
        (this.lineHeight = U(A, Ra, t.lineHeight)),
        (this.listStyleImage = U(A, Va, t.listStyleImage)),
        (this.listStylePosition = U(A, Na, t.listStylePosition)),
        (this.listStyleType = U(A, _r, t.listStyleType)),
        (this.marginTop = U(A, Xa, t.marginTop)),
        (this.marginRight = U(A, _a, t.marginRight)),
        (this.marginBottom = U(A, Ja, t.marginBottom)),
        (this.marginLeft = U(A, Pa, t.marginLeft)),
        (this.opacity = U(A, gi, t.opacity)));
      var n = U(A, ka, t.overflow);
      ((this.overflowX = n[0]),
        (this.overflowY = n[n.length > 1 ? 1 : 0]),
        (this.overflowWrap = U(A, Ya, t.overflowWrap)),
        (this.paddingTop = U(A, Wa, t.paddingTop)),
        (this.paddingRight = U(A, Za, t.paddingRight)),
        (this.paddingBottom = U(A, qa, t.paddingBottom)),
        (this.paddingLeft = U(A, ja, t.paddingLeft)),
        (this.paintOrder = U(A, Ii, t.paintOrder)),
        (this.position = U(A, $a, t.position)),
        (this.textAlign = U(A, za, t.textAlign)),
        ...
        (this.textDecorationLine = U(
          A,
          ci,
          (B = t.textDecorationLine) !== null && B !== void 0
            ? B
            : t.textDecoration,
        )),
        (this.textShadow = U(A, Ai, t.textShadow)),
        (this.textTransform = U(A, ei, t.textTransform)),
        (this.transform = U(A, ri, t.transform)),
        (this.transformOrigin = U(A, ai, t.transformOrigin)),
        (this.visibility = U(A, ii, t.visibility)),
        (this.webkitTextStrokeColor = U(A, vi, t.webkitTextStrokeColor)),
        (this.webkitTextStrokeWidth = U(A, yi, t.webkitTextStrokeWidth)),
        (this.wordBreak = U(A, oi, t.wordBreak)),
        (this.zIndex = U(A, Qi, t.zIndex)));
    }
    return (
  ...
  mi = (function () {
    function e(A, t) {
      ((this.content = U(A, Fi, t.content)),
        (this.quotes = U(A, Hi, t.quotes)));
    }
    return e;
  })(),
  Lt = (function () {
    function e(A, t) {
      ((this.counterIncrement = U(A, hi, t.counterIncrement)),
        (this.counterReset = U(A, di, t.counterReset)));
    }
    return e;
  })(),
  U = function (e, A, t) {
    var r = new fB(),
      B = t !== null && typeof t < "u" ? t.toString() : A.initialValue;
    r.write(B);
    var n = new UB(r.read());
    switch (A.type) {
      case 2:
  ...
  aA = (function () {
    function e(A, t) {
      if (
        ...
        debugger;
      ((this.styles = new Ki(A, window.getComputedStyle(t, null))),
        Yr(t) &&
        ...
        (this.bounds = ze(this.context, t)),
        Jr(t, 4) && (this.flags |= 16));
    }
    return e;
  })(),
  bi =
  ...
  te = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (var be = 0; be < Dt.length; be++) te[Dt.charCodeAt(be)] = be;
var xi = function (e) {
    var A = e.length * 0.75,
      t = e.length,
      r,
    ...
    for (r = 0; r < t; r += 4)
      ((n = te[e.charCodeAt(r)]),
        (s = te[e.charCodeAt(r + 1)]),
        (i = te[e.charCodeAt(r + 2)]),
        (a = te[e.charCodeAt(r + 3)]),
        (Q[B++] = (n << 2) | (s >> 4)),
        (Q[B++] = ((s & 15) << 4) | (i >> 2)),
        (Q[B++] = ((i & 3) << 6) | (a & 63)));
    return o;
  ...
  Yi = function (e, A) {
    var t = xi(e),
      r = Array.isArray(t) ? Si(t) : new Uint32Array(t),
      B = Array.isArray(t) ? Ti(t) : new Uint16Array(t),
      n = 24,
      s = bt(B, n / 2, r[4] / 2),
      i = r[5] === 2 ? bt(B, (n + r[4]) / 2) : ki(r, Math.ceil((n + r[4]) / 4));
  ...
  Zi = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (var xe = 0; xe < xt.length; xe++) Zi[xt.charCodeAt(xe)] = xe;
var qi = 1,
  Ur = 2,
  Fr = 3,
  Tt = 4,
  ...
  no = function (e) {
    ...
    if (e.createRange) {
      ...
      if (t.getBoundingClientRect) {
        ...
        if ((e.body.removeChild(r), n === A)) return !0;
      }
    }
    return !1;
  },
  so = function (e) {
    ...
    var r = A.firstChild,
      B = $e(r.data).map(function (a) {
        return S(a);
      }),
      n = 0,
      s = {},
      i = B.every(function (a, o) {
      ...
      Xt(s)
        .then(function (i) {
          ...
          return (
            ...
            (o.style.height = t + "px"),
            Nt(a) ? Xt(Pr(t, t, 0, 0, o)) : Promise.reject(!1)
          );
        })
        .then(function (i) {
  ...
  N = {
    get SUPPORT_RANGE_BOUNDS() {
      var e = no(document);
      return (
        Object.defineProperty(N, "SUPPORT_RANGE_BOUNDS", { value: e }),
        e
      );
    },
    get SUPPORT_WORD_BREAKING() {
      ...
      return (
        Object.defineProperty(N, "SUPPORT_WORD_BREAKING", { value: e }),
        e
      );
    },
    ...
    get SUPPORT_FOREIGNOBJECT_DRAWING() {
      var e =
        typeof Array.from == "function" && typeof window.fetch == "function"
          ...
          : Promise.resolve(!1);
      return (
        Object.defineProperty(N, "SUPPORT_FOREIGNOBJECT_DRAWING", { value: e }),
        e
      );
    },
    ...
    get SUPPORT_RESPONSE_TYPE() {
      var e = io();
      return (
        Object.defineProperty(N, "SUPPORT_RESPONSE_TYPE", { value: e }),
        e
      );
    },
    ...
    get SUPPORT_NATIVE_TEXT_SEGMENTATION() {
      ...
      return (
        Object.defineProperty(N, "SUPPORT_NATIVE_TEXT_SEGMENTATION", {
          value: e,
        }),
        e
      );
              ...
              o.forEach(function (w) {
                (n.push(
                  new ie(
                    ...
                    cA.fromDOMRectList(
                      e,
                      _t(r, Q + s, w.length).getClientRects(),
                    ),
                  ),
                ),
                  (Q += w.length));
        ...
        n = function () {
          if (B.value) {
            ...
            (i.forEach(function (o) {
              uo.indexOf(o) === -1
                ? (a += S(o))
                : (a.length && r.push(a), r.push(S(o)), (a = ""));
            }),
              a.length && r.push(a));
          }
        };
  ...
  fo = (function () {
    function e(A, t, r) {
      ((this.text = Uo(t.data, r.textTransform)),
        (this.textBounds = go(A, this.text, r, t)));
    }
    return e;
  })(),
  Uo = function (e, A) {
  ...
  VB = (function (e) {
    ...
    function A(t, r) {
      ...
      return (
        ...
        (B.svg =
          "data:image/svg+xml," + encodeURIComponent(n.serializeToString(r))),
  ...
  Ho = [{ type: 16, flags: 0, number: 50 }],
  po = function (e) {
    return e.width > e.height
      ? new cA(e.left + (e.width - e.height) / 2, e.top, e.height, e.height)
      : e.width < e.height
        ? new cA(e.left, e.top + (e.height - e.width) / 2, e.width, e.width)
        : e;
  },
  Io = function (e) {
  ...
  tt = (function (e) {
    ...
    function A(t, r) {
      var B = e.call(this, t, r) || this;
      switch (
        ((B.type = r.type.toLowerCase()),
        (B.checked = r.checked),
        (B.value = Io(r)),
        (B.type === Pe || B.type === ke) &&
          ((B.styles.backgroundColor = 3739148031),
          (B.styles.borderTopColor =
            B.styles.borderRightColor =
            B.styles.borderBottomColor =
            B.styles.borderLeftColor =
              2779096575),
          (B.styles.borderTopWidth =
            B.styles.borderRightWidth =
            B.styles.borderBottomWidth =
            B.styles.borderLeftWidth =
              1),
          (B.styles.borderTopStyle =
            B.styles.borderRightStyle =
            B.styles.borderBottomStyle =
            B.styles.borderLeftStyle =
              1),
          (B.styles.backgroundClip = [0]),
          (B.styles.backgroundOrigin = [0]),
          (B.bounds = po(B.bounds))),
        B.type)
      ) {
        case Pe:
          B.styles.borderTopRightRadius =
            B.styles.borderTopLeftRadius =
            B.styles.borderBottomRightRadius =
            B.styles.borderBottomLeftRadius =
              Eo;
          break;
        case ke:
          B.styles.borderTopRightRadius =
    ...
    function A(t, r) {
      ...
      try {
        if (
          ...
          var n = r.contentWindow.document.documentElement
              ? se(
                  t,
    ...
    for (var B = A.firstChild, n = void 0; B; B = n)
      if (((n = B.nextSibling), YB(B) && B.data.trim().length > 0))
        ...
        if (jB(B) && B.assignedNodes)
          ...
          var s = PB(e, B);
          s.styles.isVisible() &&
            (Ko(B, s, r) ? (s.flags |= 4) : mo(s.styles) && (s.flags |= 2),
            yo.indexOf(B.tagName) !== -1 && (s.flags |= 8),
            t.elements.push(s),
            B.slot,
            B.shadowRoot
              ? Ve(e, B.shadowRoot, s, r)
              : !Ye(B) && !WB(B) && !We(B) && Ve(e, B, s, r));
        }
  },
  PB = function (e, A) {
    return Wr(A)
        ...
        r !== null &&
          r.forEach(function (i) {
            ...
            a &&
              ...
              ((n = !1),
              a.length || a.push(1),
              (a[Math.max(0, a.length - 1)] += i.increment));
          });
        var s = [];
        return (
          n &&
  ...
  GA = function (e, A, t, r, B, n) {
    return e < A || e > t
      ? we(e, B, n.length > 0)
      : r.integers.reduce(function (s, i, a) {
  ...
  $t = (function () {
    ...
    return (
      (e.prototype.toIFrame = function (A, t) {
            ...
            return P(r, void 0, void 0, function () {
              ...
              return _(this, function (w) {
                switch (w.label) {
                  case 0:
                    return (
                      this.scrolledElements.forEach(Po),
                      i &&
        ...
        return (
          a.open(),
          a.write(_o(document.doctype) + "<html></html>"),
          Jo(this.referenceElement.ownerDocument, n, s),
        ...
        return (
          Wr(t) &&
            (Wr(A) &&
              A.currentSrc &&
              A.currentSrc !== A.src &&
              ((t.src = A.currentSrc), (t.srcset = "")),
            t.loading === "lazy" && (t.loading = "eager")),
          Yt(t) ? this.createCustomElementClone(t) : t
        );
      }),
      ...
      (e.prototype.createStyleClone = function (A) {
        try {
          ...
          if (
            (this.context.logger.error("Unable to access cssRules property", n),
            n.name !== "SecurityError")
          )
            throw n;
        }
        ...
        try {
          ...
          if (s)
            if (!this.options.allowTaint && n)
              ...
              var i =
                (t = A.getContext("webgl2")) !== null && t !== void 0
                  ? t
                  : A.getContext("webgl");
              if (i) {
      ...
      (e.prototype.appendChildNode = function (A, t, r) {
        (!_A(t) ||
          ...
          (!this.options.copyStyles || !_A(t) || !kt(t)) &&
      ...
      (e.prototype.cloneNode = function (A, t) {
        ...
        if (r && _A(A) && (Yr(A) || Ne(A))) {
          ...
          (this.referenceElement === A &&
            ...
            Bt(B) && Wo(B));
          var a = this.counters.parse(new Lt(this.context, n)),
            o = this.resolvePseudoContent(A, B, s, oe.BEFORE);
          (Yt(A) && (t = !0),
            Pt(A) || this.cloneChildNodes(A, B, t),
            o && B.insertBefore(o, B.firstChild));
          var Q = this.resolvePseudoContent(A, B, i, oe.AFTER);
          return (
            Q && B.appendChild(Q),
            this.counters.pop(a),
            ((n && (this.options.copyStyles || Ne(A)) && !qB(A)) || t) &&
              Ir(n, B),
            (A.scrollTop !== 0 || A.scrollLeft !== 0) &&
              this.scrolledElements.push([B, A.scrollLeft, A.scrollTop]),
            (Ye(A) || We(A)) && (Ye(B) || We(B)) && (B.value = A.value),
            B
          );
        }
        return A.cloneNode(!1);
      ...
      (e.prototype.resolvePseudoContent = function (A, t, r, B) {
        ...
        if (r) {
          ...
          if (
            ...
            var a = new mi(this.context, r),
              o = i.createElement("html2canvaspseudoelement");
            (Ir(r, o),
              a.content.forEach(function (g) {
                if (g.type === 0) o.appendChild(i.createTextNode(g.value));
                  ...
                  if (g.name === "attr") {
                    ...
                    f.length &&
                      o.appendChild(
                        i.createTextNode(A.getAttribute(f[0].value) || ""),
                      );
                  } else if (g.name === "counter") {
                    var c = g.values.filter(PA),
                      C = c[0],
                      H = c[1];
                    if (C && D(C)) {
                      var h = n.counters.getCounterValue(C.value),
                        F = H && D(H) ? _r.parse(n.context, H.value) : 3;
                      o.appendChild(i.createTextNode(we(h, F, !1)));
                    }
                  } else if (g.name === "counters") {
                    var K = g.values.filter(PA),
                      C = K[0],
                      p = K[1],
                      H = K[2];
                    if (C && D(C)) {
                      var d = n.counters.getCounterValues(C.value),
                        l = H && D(H) ? _r.parse(n.context, H.value) : 3,
                  ...
                  switch (g.value) {
                    case "open-quote":
                      o.appendChild(
                        i.createTextNode(mt(a.quotes, n.quoteDepth++, !0)),
                      );
                      break;
                    case "close-quote":
                      o.appendChild(
                        i.createTextNode(mt(a.quotes, --n.quoteDepth, !1)),
                      );
                      break;
                    default:
            ...
            return (
              Ne(t) ? (t.className.baseValue += Q) : (t.className += Q),
              o
            );
          }
        }
...
var Go = function (e, A) {
  ...
  ko = ":before",
  Yo = ":after",
  Zr = "___html2canvas___pseudoelement_before",
  qr = "___html2canvas___pseudoelement_after",
  AB = `{
    content: "" !important;
  ...
  An = (function () {
    ...
    return (
      (e.getOrigin = function (A) {
        var t = e._link;
        return t
          ? ((t.href = A), (t.href = t.href), t.protocol + t.hostname + t.port)
          : "about:blank";
      }),
    ...
    return (
                  ...
                  [
                    ...
                    new Promise(function (a, o) {
                      ...
                      ((Q.onload = function () {
                        ...
                        (Q.onerror = o),
                        (eQ(n) || r) && (Q.crossOrigin = "anonymous"),
                        (Q.src = n),
                        Q.complete === !0 &&
                          setTimeout(function () {
                            return a(Q);
      ...
      (e.prototype.proxy = function (A) {
        ...
        return new Promise(function (n, s) {
          var i = N.SUPPORT_RESPONSE_TYPE ? "blob" : "text",
  ...
  Te = (function () {
    ...
    return (
      (e.prototype.subdivide = function (A, t) {
        var r = RA(this.start, this.startControl, A),
          B = RA(this.startControl, this.endControl, A),
          n = RA(this.endControl, this.end, A),
          s = RA(r, B, A),
          i = RA(B, n, A),
          a = RA(s, i, A);
  ...
  tQ = (function () {
    function e(A) {
      var t = A.styles,
        r = A.bounds,
        B = re(t.borderTopLeftRadius, r.width, r.height),
        n = B[0],
        s = B[1],
        i = re(t.borderTopRightRadius, r.width, r.height),
        a = i[0],
        o = i[1],
        Q = re(t.borderBottomRightRadius, r.width, r.height),
        g = Q[0],
        w = Q[1],
        f = re(t.borderBottomLeftRadius, r.width, r.height),
        c = f[0],
        C = f[1],
        H = [];
      (H.push((n + a) / r.width),
      ...
      var F = r.width - a,
        ...
        E = t.borderLeftWidth,
        O = b(t.paddingTop, A.bounds.width),
        k = b(t.paddingRight, A.bounds.width),
        q = b(t.paddingBottom, A.bounds.width),
        L = b(t.paddingLeft, A.bounds.width);
      ((this.topLeftBorderDoubleOuterBox =
        n > 0 || s > 0
          ? x(r.left + E / 3, r.top + l / 3, n - E / 3, s - l / 3, m.TOP_LEFT)
          : new u(r.left + E / 3, r.top + l / 3)),
        (this.topRightBorderDoubleOuterBox =
          n > 0 || s > 0
            ? x(r.left + F, r.top + l / 3, a - v / 3, o - l / 3, m.TOP_RIGHT)
            : new u(r.left + r.width - v / 3, r.top + l / 3)),
        (this.bottomRightBorderDoubleOuterBox =
          g > 0 || w > 0
            ? x(r.left + p, r.top + K, g - v / 3, w - y / 3, m.BOTTOM_RIGHT)
            : new u(r.left + r.width - v / 3, r.top + r.height - y / 3)),
        (this.bottomLeftBorderDoubleOuterBox =
          c > 0 || C > 0
            ? x(r.left + E / 3, r.top + d, c - E / 3, C - y / 3, m.BOTTOM_LEFT)
            : new u(r.left + E / 3, r.top + r.height - y / 3)),
        (this.topLeftBorderDoubleInnerBox =
          n > 0 || s > 0
            ...
            : new u(r.left + (E * 2) / 3, r.top + (l * 2) / 3)),
        (this.topRightBorderDoubleInnerBox =
          n > 0 || s > 0
            ...
            : new u(r.left + r.width - (v * 2) / 3, r.top + (l * 2) / 3)),
        ...
        (this.bottomLeftBorderDoubleInnerBox =
          c > 0 || C > 0
            ...
            : new u(r.left + (E * 2) / 3, r.top + r.height - (y * 2) / 3)),
        (this.topLeftBorderStroke =
          n > 0 || s > 0
            ? x(r.left + E / 2, r.top + l / 2, n - E / 2, s - l / 2, m.TOP_LEFT)
            : new u(r.left + E / 2, r.top + l / 2)),
        (this.topRightBorderStroke =
          n > 0 || s > 0
            ? x(r.left + F, r.top + l / 2, a - v / 2, o - l / 2, m.TOP_RIGHT)
            : new u(r.left + r.width - v / 2, r.top + l / 2)),
        (this.bottomRightBorderStroke =
          g > 0 || w > 0
            ? x(r.left + p, r.top + K, g - v / 2, w - y / 2, m.BOTTOM_RIGHT)
            : new u(r.left + r.width - v / 2, r.top + r.height - y / 2)),
        (this.bottomLeftBorderStroke =
          c > 0 || C > 0
            ? x(r.left + E / 2, r.top + d, c - E / 2, C - y / 2, m.BOTTOM_LEFT)
            : new u(r.left + E / 2, r.top + r.height - y / 2)),
        (this.topLeftBorderBox =
          n > 0 || s > 0
            ? x(r.left, r.top, n, s, m.TOP_LEFT)
            : new u(r.left, r.top)),
        (this.topRightBorderBox =
          a > 0 || o > 0
            ? x(r.left + F, r.top, a, o, m.TOP_RIGHT)
            : new u(r.left + r.width, r.top)),
        (this.bottomRightBorderBox =
          g > 0 || w > 0
            ? x(r.left + p, r.top + K, g, w, m.BOTTOM_RIGHT)
            : new u(r.left + r.width, r.top + r.height)),
        (this.bottomLeftBorderBox =
          c > 0 || C > 0
            ? x(r.left, r.top + d, c, C, m.BOTTOM_LEFT)
        ...
        (this.topLeftPaddingBox =
          n > 0 || s > 0
            ...
            : new u(r.left + E, r.top + l)),
        (this.topRightPaddingBox =
          a > 0 || o > 0
            ? x(
                r.left + Math.min(F, r.width - v),
                r.top + l,
                F > r.width + v ? 0 : Math.max(0, a - v),
                Math.max(0, o - l),
                m.TOP_RIGHT,
              )
            : new u(r.left + r.width - v, r.top + l)),
        (this.bottomRightPaddingBox =
          g > 0 || w > 0
            ? x(
                r.left + Math.min(p, r.width - E),
                r.top + Math.min(K, r.height - y),
                Math.max(0, g - v),
                Math.max(0, w - y),
                m.BOTTOM_RIGHT,
              )
            : new u(r.left + r.width - v, r.top + r.height - y)),
        (this.bottomLeftPaddingBox =
          c > 0 || C > 0
            ? x(
                r.left + E,
                r.top + Math.min(d, r.height - y),
                Math.max(0, c - E),
                Math.max(0, C - y),
                m.BOTTOM_LEFT,
              )
            : new u(r.left + E, r.top + r.height - y)),
        (this.topLeftContentBox =
          n > 0 || s > 0
            ...
            : new u(r.left + E + L, r.top + l + O)),
        (this.topRightContentBox =
          a > 0 || o > 0
            ? x(
                r.left + Math.min(F, r.width + E + L),
                r.top + l + O,
                F > r.width + E + L ? 0 : a - E + L,
                o - (l + O),
                m.TOP_RIGHT,
              )
            : new u(r.left + r.width - (v + k), r.top + l + O)),
        (this.bottomRightContentBox =
          g > 0 || w > 0
            ? x(
                r.left + Math.min(p, r.width - (E + L)),
                r.top + Math.min(K, r.height + l + O),
                Math.max(0, g - (v + k)),
                w - (y + q),
                m.BOTTOM_RIGHT,
              )
            : new u(r.left + r.width - (v + k), r.top + r.height - (y + q))),
        (this.bottomLeftContentBox =
          c > 0 || C > 0
            ...
            : new u(r.left + E + L, r.top + r.height - (y + q))));
    }
    return e;
  })(),
  m;
...
var x = function (e, A, t, r, B) {
  ...
  tn = (function () {
    function e(A, t) {
      if (
        ...
        (this.parent = t),
        (this.effects = []),
        (this.curves = new tQ(this.container)),
        this.container.styles.opacity < 1 &&
          this.effects.push(new sQ(this.container.styles.opacity)),
      ...
      if (this.container.styles.overflowX !== 0) {
        var s = Ze(this.curves),
          i = qe(this.curves);
        eB(s, i)
          ? this.effects.push(new Se(s, 6))
          : (this.effects.push(new Se(s, 2)), this.effects.push(new Se(i, 4)));
      }
    }
    return (
  ...
  jr = function (e, A, t, r) {
    e.container.elements.forEach(function (B) {
      ...
      var a = G(B.flags, 8) ? [] : r;
      if (n || s) {
        var o = n || B.styles.isPositioned() ? t : A,
          Q = new rn(i);
        if (
          ...
          if (g < 0) {
            ...
            (o.negativeZIndex.some(function (c, C) {
              return g > c.element.container.styles.zIndex.order
                ? ((w = C), !1)
                : w > 0;
            }),
          ...
          B.styles.isFloating()
            ? o.nonPositionedFloats.push(Q)
            : o.nonPositionedInlineLevel.push(Q);
        jr(i, Q, n ? Q : t, a);
      } else
        (B.styles.isInlineLevel()
          ? A.inlineLevel.push(i)
          : A.nonInlineLevel.push(i),
          jr(i, A, t, a));
      G(B.flags, 8) && Bn(B, a);
    });
  },
  Bn = function (e, A) {
    for (
      var t = e instanceof kr ? e.start : 1,
        r = e instanceof kr ? e.reversed : !1,
        B = 0;
      B < A.length;
      B++
    ) {
      var n = A[B];
      (n.container instanceof NB &&
        typeof n.container.value == "number" &&
        n.container.value !== 0 &&
        (t = n.container.value),
        (n.listValue = we(t, n.container.styles.listStyleType, !0)),
        (t += r ? -1 : 1));
    }
  },
  QQ = function (e) {
  ...
  Oe = function (e, A) {
    var t = [];
    return (
      $(e) ? t.push(e.subdivide(0.5, !1)) : t.push(e),
      $(A) ? t.push(A.subdivide(0.5, !0)) : t.push(A),
      t
    );
  },
  eA = function (e, A, t, r) {
    var B = [];
    return (
      $(e) ? B.push(e.subdivide(0.5, !1)) : B.push(e),
      $(t) ? B.push(t.subdivide(0.5, !0)) : B.push(t),
      $(r) ? B.push(r.subdivide(0.5, !0).reverse()) : B.push(r),
      $(A) ? B.push(A.subdivide(0.5, !1).reverse()) : B.push(A),
      B
    );
  },
  nn = function (e) {
  ...
  je = function (e) {
    var A = e.styles,
      t = e.bounds,
      r = b(A.paddingLeft, t.width),
      B = b(A.paddingRight, t.width),
      n = b(A.paddingTop, t.width),
      s = b(A.paddingBottom, t.width);
    return t.add(
      r + A.borderLeftWidth,
      n + A.borderTopWidth,
      -(A.borderRightWidth + A.borderLeftWidth + r + B),
      -(A.borderTopWidth + A.borderBottomWidth + n + s),
    );
  },
  CQ = function (e, A) {
  ...
  Kr = function (e, A, t) {
    var r = CQ(XA(e.styles.backgroundOrigin, A), e),
      B = uQ(XA(e.styles.backgroundClip, A), e),
      n = lQ(XA(e.styles.backgroundSize, A), t, r),
      s = n[0],
      i = n[1],
      a = re(XA(e.styles.backgroundPosition, A), r.width - s, r.height - i),
      o = fQ(XA(e.styles.backgroundRepeat, A), a, n, r, B),
      Q = Math.round(r.left + a[0]),
      g = Math.round(r.top + a[1]);
    return [o, Q, g, s, i];
  },
  VA = function (e) {
  ...
  lQ = function (e, A, t) {
    ...
    if (a) {
      var h = 0,
        F = 0;
      return (
        M(s) ? (h = b(s, t.width)) : M(i) && (F = b(i, t.height)),
        VA(s) ? (h = F * n) : (!i || VA(i)) && (F = h / n),
        [h, F]
      );
    }
    var K = null,
      p = null;
    if (
      (M(s) ? (K = b(s, t.width)) : i && M(i) && (p = b(i, t.height)),
      K !== null && (!i || VA(i)) && (p = Q && g ? (K / r) * B : t.height),
      p !== null && VA(s) && (K = Q && g ? (p / B) * r : t.width),
      K !== null && p !== null)
    )
      return [K, p];
    ...
    return (
      (e.prototype.parseMetrics = function (A, t) {
        ...
        ((r.style.visibility = "hidden"),
          ...
          (n.style.margin = "0"),
          (n.style.padding = "0"),
          n.appendChild(this._document.createTextNode(tB)),
          r.appendChild(n),
          r.appendChild(B));
        var i = B.offsetTop - n.offsetTop + 2;
        (r.removeChild(n),
          r.appendChild(this._document.createTextNode(tB)),
      ...
      (e.prototype.getMetrics = function (A, t) {
        ...
        return (
          typeof this._data[r] > "u" &&
            (this._data[r] = this.parseMetrics(A, t)),
          this._data[r]
        );
      }),
      e
  ...
  dQ = (function (e) {
    ...
    return (
      ...
      (A.prototype.applyEffect = function (t) {
        (this.ctx.save(),
          iQ(t) && (this.ctx.globalAlpha = t.opacity),
          aQ(t) &&
            ...
            this.ctx.translate(-t.offsetX, -t.offsetY)),
          en(t) && (this.path(t.path), this.ctx.clip()),
      ...
      (A.prototype.renderTextWithLetterSpacing = function (t, r, B) {
        ...
        if (r === 0) this.ctx.fillText(t.text, t.bounds.left, t.bounds.top + B);
          ...
          s.reduce(function (i, a) {
            return (
              n.ctx.fillText(a, i, t.bounds.top + B),
              i + n.ctx.measureText(a).width
            );
          }, t.bounds.left);
        }
      }),
        ...
        return P(this, void 0, void 0, function () {
          ...
          return _(this, function (f) {
            return (
              ...
              (a = this.fontMetrics.getMetrics(s, i)),
              (o = a.baseline),
              (Q = a.middle),
              (g = r.paintOrder),
              t.textBounds.forEach(function (c) {
                g.forEach(function (C) {
                  switch (C) {
                    case 0:
                      ((w.ctx.fillStyle = R(r.color)),
                        w.renderTextWithLetterSpacing(c, r.letterSpacing, o));
                      var H = r.textShadow;
                      (H.length &&
                        c.text.trim().length &&
                        (H.slice(0)
                          .reverse()
                          .forEach(function (h) {
                            ((w.ctx.shadowColor = R(h.color)),
                              (w.ctx.shadowOffsetX =
                                h.offsetX.number * w.options.scale),
                              (w.ctx.shadowOffsetY =
                                h.offsetY.number * w.options.scale),
                              (w.ctx.shadowBlur = h.blur.number),
                    ...
                    case 1:
                      (r.webkitTextStrokeWidth &&
                        c.text.trim().length &&
                        ((w.ctx.strokeStyle = R(r.webkitTextStrokeColor)),
        ...
        return P(this, void 0, void 0, function () {
          ...
          return _(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                return s < i.length
                  ? ((a = i[s]), [4, this.renderTextNode(a, n)])
                  : [3, 4];
              case 2:
                (l.sent(), (l.label = 3));
              case 3:
              ...
              case 6:
                return (
                  (F = l.sent()),
                  this.renderReplacedElement(r, B, F),
                  [3, 8]
                );
              case 7:
                return (
              ...
              case 8:
                if (
                  (r instanceof RB &&
                    this.renderReplacedElement(r, B, r.canvas),
                  !(r instanceof VB))
                )
                  return [3, 12];
                l.label = 9;
              ...
              case 14:
                if (
                  (r instanceof tt &&
                    ((g = Math.min(r.bounds.width, r.bounds.height)),
                    r.type === Pe
                      ? r.checked &&
                        (this.ctx.save(),
                        this.path([
                          new u(
                            r.bounds.left + g * 0.39363,
                            r.bounds.top + g * 0.79,
                          ),
                          new u(
                            r.bounds.left + g * 0.16,
                            r.bounds.top + g * 0.5549,
                          ),
                          new u(
                            r.bounds.left + g * 0.27347,
                            r.bounds.top + g * 0.44071,
                          ),
                          new u(
                            r.bounds.left + g * 0.39694,
                            r.bounds.top + g * 0.5649,
                          ),
                          new u(
                            r.bounds.left + g * 0.72983,
                            r.bounds.top + g * 0.23,
                          ),
                          new u(
                            r.bounds.left + g * 0.84,
                            r.bounds.top + g * 0.34085,
                          ),
                          new u(
                            r.bounds.left + g * 0.39363,
                            r.bounds.top + g * 0.79,
                  ...
                  switch (
                    ((w = this.createFontStyle(n)),
                    (p = w[0]),
                    (f = w[1]),
                    (c = this.fontMetrics.getMetrics(p, f).baseline),
                    (this.ctx.font = p),
                    (this.ctx.fillStyle = R(n.color)),
                    (this.ctx.textBaseline = "alphabetic"),
                    (this.ctx.textAlign = pQ(r.styles.textAlign)),
                    (d = je(r)),
                    (C = 0),
                    r.styles.textAlign)
                  ) {
              ...
              case 15:
                return (
                  l.trys.push([15, 17, , 18]),
                  [4, this.context.cache.match(K)]
                );
              case 16:
                return (
                  (F = l.sent()),
              ...
              case 17:
                return (
                  l.sent(),
                  this.context.logger.error(
                    "Error loading list-style-image " + K,
                  ),
                  [3, 18]
                );
              case 18:
              ...
              case 19:
                (t.listValue &&
                  ...
                  (d = new cA(
                    r.bounds.left,
                    r.bounds.top + b(r.styles.paddingTop, r.bounds.width),
                    r.bounds.width,
                    yt(n.lineHeight, n.fontSize.number) / 2 + 1,
                  )),
                  this.renderTextWithLetterSpacing(
                    new ie(t.listValue, d),
                    n.letterSpacing,
                    yt(n.lineHeight, n.fontSize.number) / 2 + 2,
                  ),
        ...
        return P(this, void 0, void 0, function () {
          ...
          return _(this, function (F) {
            switch (F.label) {
              ...
              case 22:
                ((f = 0),
                  (c = t.zeroOrAutoZIndexOrTransformedOrOpacity),
                  (F.label = 23));
              case 23:
                return f < c.length
                  ? ((h = c[f]), [4, this.renderStack(h)])
                  : [3, 26];
              case 24:
                (F.sent(), (F.label = 25));
              case 25:
      ...
      (A.prototype.formatPath = function (t) {
        ...
        t.forEach(function (B, n) {
          var s = $(B) ? B.start : B;
          (n === 0 ? r.ctx.moveTo(s.x, s.y) : r.ctx.lineTo(s.x, s.y),
            $(B) &&
              r.ctx.bezierCurveTo(
                B.startControl.x,
                B.startControl.y,
      ...
      (A.prototype.resizeImage = function (t, r, B) {
        ...
        var s =
            (n = this.canvas.ownerDocument) !== null && n !== void 0
              ? n
              : document,
          i = s.createElement("canvas");
                        ...
                        case 4:
                          return (
                            g &&
                              ...
                              (L = f[3]),
                              (V = f[4]),
                              (y = n.ctx.createPattern(
                                n.resizeImage(g, L, V),
                                "repeat",
                              )),
                              n.renderRepeat(O, y, Y, W)),
                            [3, 6]
                          );
                        case 5:
                          (sa(Q)
                            ? ((c = Kr(t, r, [null, null, null])),
                              (O = c[0]),
                              (Y = c[1]),
                              (W = c[2]),
                              (L = c[3]),
                              ...
                              (d.height = V),
                              (l = d.getContext("2d")),
                              (v = l.createLinearGradient(h, K, F, p)),
                              It(Q.stops, H).forEach(function (YA) {
                              ...
                              L > 0 &&
                                V > 0 &&
                                ((y = n.ctx.createPattern(d, "repeat")),
                                n.renderRepeat(O, y, Y, W)))
                            : aa(Q) &&
                              ((E = Kr(t, r, [null, null, null])),
                              (O = E[0]),
                              (k = E[1]),
                              (q = E[2]),
                              (L = E[3]),
                              (V = E[4]),
                              (CA =
                                Q.position.length === 0 ? [$r] : Q.position),
                              (Y = b(CA[0], L)),
                              (W = b(CA[CA.length - 1], V)),
                              (IA = ra(Q, Y, W, L, V)),
                              (BA = IA[0]),
                              (uA = IA[1]),
                              BA > 0 &&
                                uA > 0 &&
                                ((vA = n.ctx.createRadialGradient(
                                  k + Y,
                                  q + W,
                                  0,
                                  k + Y,
                                ...
                                It(Q.stops, BA * 2).forEach(function (YA) {
                                ...
                                BA !== uA
                                  ? ((yA =
                                    ...
                                    (iA = t.bounds.top + 0.5 * t.bounds.height),
                                    (KA = uA / BA),
                                    (oA = 1 / KA),
                                    n.ctx.save(),
                                    n.ctx.translate(yA, iA),
                                    n.ctx.transform(1, 0, 0, KA, 0, 0),
                                    n.ctx.translate(-yA, -iA),
                                    n.ctx.fillRect(
                                      k,
                                      oA * (q - iA) + iA,
            ...
            switch (w.label) {
              case 0:
                return (
                  ...
                  (B = !HA(r.backgroundColor) || r.backgroundImage.length),
                  (n = [
                    {
                  ...
                  (s = HQ(XA(r.backgroundClip, 0), t.curves)),
                  B || r.boxShadow.length
                    ? (this.ctx.save(),
                      this.path(s),
                      this.ctx.clip(),
                      HA(r.backgroundColor) ||
                        ((this.ctx.fillStyle = R(r.backgroundColor)),
                        this.ctx.fill()),
                  ...
                  r.boxShadow
                    ...
                    .forEach(function (f) {
                      ...
                      var c = Ze(t.curves),
                        ...
                        H = oQ(
                          c,
                          -C + (f.inset ? 1 : -1) * f.spread.number,
                          (f.inset ? 1 : -1) * f.spread.number,
                          f.spread.number * (f.inset ? -2 : 2),
                          f.spread.number * (f.inset ? -2 : 2),
                        );
                      (f.inset
                        ? (g.path(c), g.ctx.clip(), g.mask(H))
                        : (g.mask(c), g.ctx.clip(), g.path(H)),
                        (g.ctx.shadowOffsetX = f.offsetX.number + C),
                        (g.ctx.shadowOffsetY = f.offsetY.number),
                        (g.ctx.shadowColor = R(f.color)),
                        (g.ctx.shadowBlur = f.blur.number),
                        (g.ctx.fillStyle = f.inset
                          ? R(f.color)
                          : "rgba(0,0,0,1)"),
                        g.ctx.fill(),
                        g.ctx.restore());
              ...
              case 3:
                return a < o.length
                  ? ((Q = o[a]),
                    Q.style !== 0 && !HA(Q.color) && Q.width > 0
                      ? Q.style !== 2
                        ? [3, 5]
                        : [
                            4,
              ...
              case 7:
                return Q.style !== 4
                  ? [3, 9]
                  : [4, this.renderDoubleBorder(Q.color, Q.width, i, t.curves)];
              case 8:
                return (w.sent(), [3, 11]);
              case 9:
        ...
        return P(this, void 0, void 0, function () {
          ...
          return _(this, function (v) {
            return (
              ...
              $(a[0])
                ? ((o = a[0].start.x), (Q = a[0].start.y))
                : ((o = a[0].x), (Q = a[0].y)),
              $(a[1])
                ? ((g = a[1].end.x), (w = a[1].end.y))
                : ((g = a[1].x), (w = a[1].y)),
              B === 0 || B === 2
                ? (f = Math.abs(o - g))
                : (f = Math.abs(Q - w)),
              this.ctx.beginPath(),
              s === 3 ? this.formatPath(i) : this.formatPath(a.slice(0, 2)),
              (c = r < 3 ? r * 3 : r * 2),
              (C = r < 3 ? r * 2 : r),
              s === 3 && ((c = r), (C = r)),
              (H = !0),
              f <= c * 2
                ...
                : f <= c * 2 + C
                  ? ((h = f / (2 * c + C)), (c *= h), (C *= h))
                  : ((F = Math.floor((f + C) / (c + C))),
                    (K = (f - F * c) / (F - 1)),
                    (p = (f - (F + 1) * c) / F),
                    (C = p <= 0 || Math.abs(C - K) < Math.abs(C - p) ? K : p)),
              H &&
                (s === 3
                  ? this.ctx.setLineDash([0, c + C])
                  : this.ctx.setLineDash([c, C])),
              s === 3
                ? ((this.ctx.lineCap = "round"), (this.ctx.lineWidth = r))
                : (this.ctx.lineWidth = r * 2 + 1.1),
              (this.ctx.strokeStyle = R(t)),
              this.ctx.stroke(),
              ...
              s === 2 &&
                ($(a[0]) &&
                  ...
                  this.ctx.beginPath(),
                  this.formatPath([
                    new u(d.end.x, d.end.y),
                    new u(l.start.x, l.start.y),
                  ]),
                  this.ctx.stroke()),
                $(a[1]) &&
                  ((d = a[1]),
              ...
              case 0:
                return (
                  this.options.backgroundColor &&
                    ((this.ctx.fillStyle = R(this.options.backgroundColor)),
                    this.ctx.fillRect(
                      this.options.x,
                      this.options.y,
                      this.options.width,
  ...
  EQ = function (e) {
    return e instanceof _B || e instanceof XB
      ? !0
      : e instanceof tt && e.type !== ke && e.type !== Pe;
  },
  HQ = function (e, A) {
    switch (e) {
      case 0:
    ...
    return (
      ...
      (e.prototype.info = function () {
        ...
        this.enabled &&
          ...
          console.info.apply(console, ue([this.id, this.getTime() + "ms"], A));
      }),
  ...
  LQ = (function () {
    function e(A, t) {
      ...
      ((this.windowBounds = t),
        ...
        (this.logger = new mQ({ id: this.instanceName, enabled: A.logging })),
        (this.cache =
          (r = A.cache) !== null && r !== void 0 ? r : new qo(this, A)));
    }
...
var DQ = function (e, A) {
        ...
        switch (oA.label) {
          case 0:
            ...
            return (
              (B = {
                allowTaint:
                  (y = A.allowTaint) !== null && y !== void 0 ? y : !1,
                imageTimeout:
                  (E = A.imageTimeout) !== null && E !== void 0 ? E : 15e3,
                proxy: A.proxy,
                useCORS: (O = A.useCORS) !== null && O !== void 0 ? O : !1,
              }),
              (n = Lr(
                {
                  logging: (k = A.logging) !== null && k !== void 0 ? k : !0,
                  cache: A.cache,
                },
                B,
              )),
              (s = {
                windowWidth:
                  (q = A.windowWidth) !== null && q !== void 0
                    ? q
                    : r.innerWidth,
                windowHeight:
                  (L = A.windowHeight) !== null && L !== void 0
                    ? L
                    : r.innerHeight,
                scrollX:
                  (V = A.scrollX) !== null && V !== void 0 ? V : r.pageXOffset,
                scrollY:
                  (CA = A.scrollY) !== null && CA !== void 0
                    ? CA
                    : r.pageYOffset,
              }),
              (i = new cA(s.scrollX, s.scrollY, s.windowWidth, s.windowHeight)),
              (a = new LQ(n, i)),
              (o =
                (Y = A.foreignObjectRendering) !== null && Y !== void 0
                  ? Y
                  : !1),
              (Q = {
                allowTaint:
                  (W = A.allowTaint) !== null && W !== void 0 ? W : !1,
                onclone: A.onclone,
          ...
          case 1:
            return (
              (f = oA.sent()),
              (c = Bt(w) || xo(w) ? an(w.ownerDocument) : ze(a, w)),
              (C = c.width),
              (H = c.height),
              (h = c.left),
              (F = c.top),
              (K = bQ(a, w, A.backgroundColor)),
              (p = {
                canvas: A.canvas,
                backgroundColor: K,
                scale:
                  (BA =
                    (IA = A.scale) !== null && IA !== void 0
                      ? IA
                      : r.devicePixelRatio) !== null && BA !== void 0
                    ? BA
                    : 1,
                x: ((uA = A.x) !== null && uA !== void 0 ? uA : 0) + h,
                y: ((vA = A.y) !== null && vA !== void 0 ? vA : 0) + F,
                width:
                  (yA = A.width) !== null && yA !== void 0 ? yA : Math.ceil(C),
                height:
                  (iA = A.height) !== null && iA !== void 0 ? iA : Math.ceil(H),
              }),
              o
                ? (a.logger.debug(
          ...
          case 3:
            return (
              ...
              (l = kB(a, w)),
              K === l.styles.backgroundColor &&
                (l.styles.backgroundColor = wA.TRANSPARENT),
              a.logger.debug(
          ...
          case 5:
            return (
              (!((KA = A.removeContainer) !== null && KA !== void 0) || KA) &&
                ($t.destroy(f) ||
                  a.logger.error(
  ...
  bQ = function (e, A, t) {
    var r = A.ownerDocument,
      B = r.documentElement
        ? se(e, getComputedStyle(r.documentElement).backgroundColor)
        : wA.TRANSPARENT,
      n = r.body
        ? se(e, getComputedStyle(r.body).backgroundColor)
        : wA.TRANSPARENT,
      s =
        typeof t == "string"
          ? se(e, t)
