...
import { A as c, f as d } from "./index-D5xLbTBZ.js";
...
function fe() {
  const { user: L, isLoading: $ } = te(),
    [f, me] = Q.useState(3e4),
    {
      ...
      queryFn: async () => {
        const r = await fetch("/api/security/metrics", {
          credentials: "include",
        });
        if (!r.ok) throw new Error("Failed to fetch security metrics");
        return r.json();
      },
      refetchInterval: f,
    }),
    {
      ...
      queryFn: async () => {
        const r = await fetch("/api/security/behavioral-alerts", {
          credentials: "include",
        });
    ...
    }),
    {
      ...
      queryFn: async () => {
        const r = await fetch("/api/security/anomaly-detection", {
          credentials: "include",
        });
        if (!r.ok) throw new Error("Failed to detect anomalies");
        return r.json();
      },
      refetchInterval: f,
    }),
    {
      ...
      queryFn: async () => {
        const r = await fetch("/api/security/pentest-results", {
          credentials: "include",
        });
        if (!r.ok) throw new Error("Failed to fetch pentest results");
        return r.json();
      },
    }),
    U = (r) => {
    ...
    _ = (r) => {
      const m = Math.floor(r / 86400),
        b = Math.floor((r % 86400) / 3600),
        o = Math.floor((r % 3600) / 60);
      return m > 0 ? `${m}d ${b}h` : b > 0 ? `${b}h ${o}m` : `${o}m`;
    },
    N = (r) => {
      const m = new Date(r),
        o = new Date().getTime() - m.getTime(),
        v = Math.floor(o / 6e4),
        w = Math.floor(o / 36e5),
            ...
            "div",
            {
              ...
              children: [
                e.jsxDEV(
                  ...
                  {
                    fileName:
                      "/home/runner/workspace/client/src/pages/admin/SecurityDashboard.tsx",
                    lineNumber: 223,
                    columnNumber: 11,
                  },
                  this,
                ...
                e.jsxDEV(
                  "p",
                  {
                    ...
                    children: "Running security checks…",
                  },
                  void 0,
                  !1,
                  {
                                ...
                                u,
                                {
                                  ...
                                  children: [
                                    e.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "w-3 h-3 mr-1 animate-pulse text-green-600",
                                      },
                                      void 0,
                                      !1,
                                      {
                                  ...
                                  children: [
                                    ...
                                    e.jsxDEV(
                                      "p",
                                      {
                                        ...
                                        children: "Fetching security metrics…",
                                      },
                                      void 0,
                                      !1,
                                      {
                                ...
                                e.Fragment,
                                {
                                  children: [
                                    e.jsxDEV(
                                      a,
                                      {
                                        className: `border-l-4 ${U(s.systemHealth.status)}`,
                                        children: e.jsxDEV(
                                          i,
                                          {
                                            className: "p-4",
                                                    ...
                                                    e.jsxDEV(
                                                      "p",
                                                      {
                                                        className:
                                                          "text-3xl font-bold",
                                                        children:
                                                          s.authentication.successRate.toFixed(
                                                            1,
                                                          ),
                                                      },
                                                      void 0,
                                    ...
                                    e.jsxDEV(
                                      a,
                                      {
                                        className: `border-l-4 ${s.authentication.failedLogins > 10 ? "border-l-yellow-500" : "border-l-green-200"}`,
                                        children: e.jsxDEV(
                                          i,
                                          {
                                            className: "p-4",
                                    ...
                                    e.jsxDEV(
                                      a,
                                      {
                                        className: `border-l-4 ${s.threats.suspiciousActivity > 5 ? "border-l-red-500" : "border-l-green-200"}`,
                                        children: e.jsxDEV(
                                          i,
                                          {
                                            className: "p-4",
                                                ...
                                                "div",
                                                {
                                                  ...
                                                  children: [
                                                    e.jsxDEV(
                                                      ...
                                                      {
                                                        className:
                                                          "w-12 h-12 mx-auto mb-4 text-green-500",
                                                      },
                                                      void 0,
                                                      !1,
                                                      {
                                                            ...
                                                            "div",
                                                            {
                                                              ...
                                                              children: [
                                                                ...
                                                                e.jsxDEV(
                                                                  ...
                                                                  {
                                                                    className:
                                                                      "grid grid-cols-2 gap-3 text-sm bg-white/50 dark:bg-gray-800/50 p-3 rounded",
                                                                    children: [
                                                                      e.jsxDEV(
                                                                        "div",
                                                                        {
                                                            ...
                                                            n.vulnerabilities.map(
                                                              (r) =>
                                                                e.jsxDEV(
                                                                  a,
                                                                  {
                                                                    className: `border-l-4 ${r.severity === "critical" ? "border-l-red-500" : r.severity === "high" ? "border-l-orange-500" : r.severity === "medium" ? "border-l-yellow-500" : "border-l-blue-500"}`,
                                                                    children:
                                                                      e.jsxDEV(
                                                                        i,
                                                                        {
