import { r as p, f as e } from "./vendor-react-31oK5L0i.js";
import {
  o as g,
  p as y,
  r as h,
...
import { u as f } from "./index-D5xLbTBZ.js";
...
function V({ open: i, onOpenChange: a }) {
  const c = p.useRef(null);
  f(c, i, () => a(!1));
  const t = m.reduce(
    (o, s) => (o[s.category] || (o[s.category] = []), o[s.category].push(s), o),
    {},
  );
  return e.jsxDEV(
    g,
              ...
              h,
              {
                children: [
                  e.jsxDEV(
                    ...
                    {
                      fileName:
                        "/home/runner/workspace/client/src/components/dialogs/KeyboardShortcutsDialog.tsx",
                      lineNumber: 103,
                      columnNumber: 11,
                    },
                    this,
            ...
            e.jsxDEV(
              x,
              {
                ...
                children: e.jsxDEV(
                  ...
                  {
                    className: "space-y-6",
                    children: Object.entries(t).map(([o, s]) =>
                      e.jsxDEV(
                        "div",
                        {
                          className: "space-y-3",
                          children: [
                                ...
                                children: s.map((r, d) =>
                                  e.jsxDEV(
                                    "div",
                                    {
                                      ...
                                      role: "group",
                                      "aria-label": `${r.description}: ${r.keys.join(" + ")}`,
                                      children: [
                                        e.jsxDEV(
                                          "span",
                                          {
                                                ...
                                                "span",
                                                {
                                                  ...
                                                  children: [
                                                    e.jsxDEV(
                                                      ...
                                                      {
                                                        className:
                                                          "px-2 py-1 bg-background border rounded text-xs font-mono min-w-[32px] text-center",
                                                        children: u,
                                                      },
                                                      void 0,
                                                      !1,
                            ...
                            o !== Object.keys(t)[Object.keys(t).length - 1] &&
                              e.jsxDEV(
                                k,
                                { className: "mt-4" },
                                void 0,
              ...
              "div",
              {
                ...
                children: [
                  e.jsxDEV(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        " Most shortcuts work globally unless you're typing in a text field",
                      ],
                    },
                    void 0,
                    !0,
                  ...
                  e.jsxDEV(
                    ...
                    {
                      variant: "outline",
                      children: [m.length, " total shortcuts"],
                    },
                    void 0,
                    !0,
                    {
...
export { V as KeyboardShortcutsDialog };
