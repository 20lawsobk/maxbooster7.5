import { ct as x } from "./vendor-react-31oK5L0i.js";
var I = {};
var F;
function G() {
  return (
          ...
          g.prototype = {
                ...
                for (var n = 0; n < t._howls.length; n++)
                  if (!t._howls[n]._webAudio)
                    for (
                      ...
                      var l = t._howls[n]._soundById(o[u]);
            ...
            _setupCodecs: function () {
              ...
              var n = t.canPlayType("audio/mpeg;").replace(/^no$/, ""),
                ...
                u = o.match(/OPR\/(\d+)/g),
                l = u && parseInt(u[0].split("/")[1], 10) < 33,
                ...
                var t = function (n) {
                  ...
                  for (var u = 0; u < e._howls.length; u++)
                    if (!e._howls[u]._webAudio)
                      for (
                        var l = e._howls[u]._getSoundIds(), a = 0;
                        a < l.length;
                        a++
                      ) {
                        var f = e._howls[u]._soundById(l[a]);
                        f &&
                          f._node &&
                          !f._node._unlocked &&
          ...
          _.prototype = {
            ...
            play: function (e, t) {
              ...
              if (typeof e == "number") ((o = e), (e = null));
                ...
                if (typeof e > "u" && ((e = "__default"), !n._playLock)) {
                  for (var u = 0, l = 0; l < n._sounds.length; l++)
                    n._sounds[l]._paused &&
                      !n._sounds[l]._ended &&
                      (u++, (o = n._sounds[l]._id));
                  u === 1 ? (e = null) : (o = null);
              ...
              var m = Math.max(
                  0,
                  a._seek > 0 ? a._seek : n._sprite[e][0] / 1e3,
                ),
              ...
              if (n._webAudio) {
                var H = function () {
                  ((n._playLock = !1), k(), n._refreshBuffer(a));
                  var T = a._muted || n._muted ? 0 : a._volume;
                  (v.gain.setValueAtTime(T, r.ctx.currentTime),
                  ...
                  try {
                    ...
                    if (
                      ...
                      (T instanceof Promise || typeof T.then == "function")
                        ...
                        : t ||
                          ((n._playLock = !1), k(), n._emit("play", a._id)),
                      (v.playbackRate = a._rate),
                      v.paused)
                    ) {
                      n._emit(
                  ...
                  ((a = e._soundById(o[f])),
                    a &&
                      ...
                      e._webAudio && a._node && !a._muted
                        ...
                        : a._node &&
                          !a._muted &&
                          (a._node.volume = n * r.volume()),
                      e._emit("volume", a._id)));
              } else
                return (
                  (a = o ? e._soundById(o) : e._sounds[0]),
                  a ? a._volume : 0
                );
              return e;
            },
            fade: function (e, t, n, o) {
              ...
              ((e = Math.min(Math.max(0, parseFloat(e)), 1)),
                ...
                (n = parseFloat(n)),
                u.volume(e, o));
              for (var l = u._getSoundIds(o), a = 0; a < l.length; a++) {
                var f = u._soundById(l[a]);
                if (f) {
                  if ((o || u._stopFade(l[a]), u._webAudio && !f._muted)) {
                  ...
                  u._startFadeInterval(f, e, t, n, l[a], typeof o > "u");
                }
              }
              return u;
            },
            _startFadeInterval: function (e, t, n, o, u, l) {
              var a = this,
                f = t,
                m = n - t,
                y = Math.abs(m / 0.01),
            ...
            loop: function () {
              ...
              if (t.length === 1)
                if (typeof t[0] == "boolean") ((n = t[0]), (e._loop = n));
                  ...
                  return (
                    (u = e._soundById(parseInt(t[0], 10))),
                    u ? u._loop : !1
                  );
              ...
              if (typeof n == "number") {
                ...
                for (var f = 0; f < o.length; f++)
                  if (((a = e._soundById(o[f])), a)) {
                    ...
                    var m = e.seek(o[f]),
                      y =
                        (e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) /
                          1e3 -
                        m,
                      w = (y * 1e3) / Math.abs(a._rate);
                    ((e._endTimers[o[f]] || !a._paused) &&
                      (e._clearTimer(o[f]),
                      (e._endTimers[o[f]] = setTimeout(
                        e._ended.bind(e, a),
                        w,
                      ))),
                      e._emit("rate", a._id));
            ...
            _emit: function (e, t, n) {
              for (
                var o = this, u = o["_on" + e], l = u.length - 1;
                l >= 0;
                l--
              )
                (!u[l].id || u[l].id === t || e === "load") &&
                  (setTimeout(
                    function (a) {
                      a.call(this, t, n);
                    }.bind(o, u[l].fn),
                  ...
                  u[l].once && o.off(e, u[l].fn, u[l].id));
          ...
          var c = {},
            ...
            p = function (e, t) {
              var n = function () {
                ...
                o = function (u) {
                  u && t._sounds.length > 0 ? ((c[t._src] = u), s(t, u)) : n();
                };
        ...
        (function () {
          ((HowlerGlobal.prototype._pos = [0, 0, 0]),
            ...
            (HowlerGlobal.prototype.stereo = function (r) {
              ...
              for (var i = _._howls.length - 1; i >= 0; i--)
                _._howls[i].stereo(r);
              return _;
            }),
            (HowlerGlobal.prototype.pos = function (r, _, i) {
              var c = this;
              if (!c.ctx || !c.ctx.listener) return c;
              if (
                ((_ = typeof _ != "number" ? c._pos[1] : _),
            ...
            (HowlerGlobal.prototype.orientation = function (r, _, i, c, d, h) {
              var p = this;
              if (!p.ctx || !p.ctx.listener) return p;
              var s = p._orientation;
              if (
                ((_ = typeof _ != "number" ? s[1] : _),
                ...
                ((p._orientation = [r, _, i, c, d, h]),
                  typeof p.ctx.listener.forwardX < "u"
                    ...
                    : p.ctx.listener.setOrientation(r, _, i, c, d, h));
              else return s;
              return p;
            }),
            (Howl.prototype.init = (function (r) {
              return function (_) {
                var i = this;
                return (
                  (i._orientation = _.orientation || [1, 0, 0]),
                  (i._stereo = _.stereo || null),
                  (i._pos = _.pos || null),
                  (i._pannerAttr = {
                    coneInnerAngle:
                      typeof _.coneInnerAngle < "u" ? _.coneInnerAngle : 360,
                    coneOuterAngle:
                      typeof _.coneOuterAngle < "u" ? _.coneOuterAngle : 360,
                    coneOuterGain:
                      typeof _.coneOuterGain < "u" ? _.coneOuterGain : 0,
                    distanceModel:
                      typeof _.distanceModel < "u"
                        ? _.distanceModel
                        : "inverse",
                    maxDistance:
                      typeof _.maxDistance < "u" ? _.maxDistance : 1e4,
                    panningModel:
                      typeof _.panningModel < "u" ? _.panningModel : "HRTF",
                    refDistance: typeof _.refDistance < "u" ? _.refDistance : 1,
                    rolloffFactor:
                      typeof _.rolloffFactor < "u" ? _.rolloffFactor : 1,
                  }),
                  (i._onstereo = _.onstereo ? [{ fn: _.onstereo }] : []),
                  (i._onpos = _.onpos ? [{ fn: _.onpos }] : []),
                  (i._onorientation = _.onorientation
                    ? [{ fn: _.onorientation }]
                    : []),
                  r.call(this, _)
                );
            ...
            (Howl.prototype.stereo = function (r, _) {
              var i = this;
              ...
              for (var d = i._getSoundIds(_), h = 0; h < d.length; h++) {
            ...
            (Howl.prototype.pos = function (r, _, i, c) {
              var d = this;
              ...
              if (
                ((_ = typeof _ != "number" ? 0 : _),
                (i = typeof i != "number" ? -0.5 : i),
                typeof c > "u")
              )
                if (typeof r == "number") d._pos = [r, _, i];
                else return d._pos;
                    ...
                    ((s._pos = [r, _, i]),
                      s._node &&
                        ...
                        typeof s._panner.positionX < "u"
                          ...
                          : s._panner.setPosition(r, _, i)),
                      d._emit("pos", s._id));
                  else return s._pos;
              }
              return d;
            }),
            (Howl.prototype.orientation = function (r, _, i, c) {
              var d = this;
              if (!d._webAudio) return d;
              if (d._state !== "loaded")
                return (
                  d._queue.push({
                    event: "orientation",
                    action: function () {
                      d.orientation(r, _, i, c);
                    },
                  }),
                  d
                );
              if (
                ((_ = typeof _ != "number" ? d._orientation[1] : _),
                (i = typeof i != "number" ? d._orientation[2] : i),
                typeof c > "u")
              )
                if (typeof r == "number") d._orientation = [r, _, i];
                else return d._orientation;
              for (var h = d._getSoundIds(c), p = 0; p < h.length; p++) {
                var s = d._soundById(h[p]);
                if (s)
                  if (typeof r == "number")
                    ((s._orientation = [r, _, i]),
                      s._node &&
                        (s._panner ||
                          (s._pos || (s._pos = d._pos || [0, 0, -0.5]),
                          g(s, "spatial")),
                        typeof s._panner.orientationX < "u"
                          ...
                          : s._panner.setOrientation(r, _, i)),
            ...
            (Howl.prototype.pannerAttr = function () {
              ...
              if (_.length === 0) return r._pannerAttr;
              if (_.length === 1)
                if (typeof _[0] == "object")
                  ...
                  return (
                    (d = r._soundById(parseInt(_[0], 10))),
                    d ? d._pannerAttr : r._pannerAttr
                  );
              else _.length === 2 && ((i = _[0]), (c = parseInt(_[1], 10)));
            ...
            (Sound.prototype.init = (function (r) {
              return function () {
                var _ = this,
                  i = _._parent;
                ((_._orientation = i._orientation),
                  (_._stereo = i._stereo),
                  (_._pos = i._pos),
                  (_._pannerAttr = i._pannerAttr),
                  r.call(this),
                  _._stereo
                    ? i.stereo(_._stereo)
                    : _._pos && i.pos(_._pos[0], _._pos[1], _._pos[2], _._id));
              };
              ...
              return function () {
                ...
                return (
                  ...
                  _._stereo
                    ? i.stereo(_._stereo)
                    : _._pos
                      ? i.pos(_._pos[0], _._pos[1], _._pos[2], _._id)
                      : _._panner &&
                        (_._panner.disconnect(0),
                        (_._panner = void 0),
                        i._refreshBuffer(_)),
                  r.call(this)
                );
