function q(e, t, r, i, n) {
  i = i || {};
  var a = 1.15,
    s = n.internal.scaleFactor,
    h = n.internal.getFontSize() / s,
    f = n.getLineHeightFactor ? n.getLineHeightFactor() : a,
    o = h * f,
    l = /\r\n|\r|\n/g,
    g = "",
    u = 1;
  if (
    ((i.valign === "middle" ||
      ...
      i.halign === "center" ||
      i.halign === "right") &&
      ((g = typeof e == "string" ? e.split(l) : e), (u = g.length || 1)),
    (r += h * (2 - a)),
    i.valign === "middle"
      ? (r -= (u / 2) * o)
      : i.valign === "bottom" && (r -= u * o),
    i.halign === "center" || i.halign === "right")
  ) {
    var v = h;
  ...
  return (
    i.halign === "justify"
      ? n.text(e, t, r, { maxWidth: i.maxWidth || 100, align: "justify" })
      : n.text(e, t, r),
    n
  );
}
var M = {},
  P = (function () {
    ...
    return (
      (e.setDefaults = function (t, r) {
        (r === void 0 && (r = null),
          r ? (r.__autoTableDocumentDefaults = t) : (M = t));
      }),
      ...
      (e.prototype.applyStyles = function (t, r) {
        ...
        (r === void 0 && (r = !1),
          t.fontStyle &&
            ...
            this.jsPDFDocument.setFontStyle(t.fontStyle));
        var s = this.jsPDFDocument.internal.getFont(),
          h = s.fontStyle,
          f = s.fontName;
        if ((t.font && (f = t.font), t.fontStyle)) {
          ...
          o &&
            o.indexOf(h) === -1 &&
            this.jsPDFDocument.setFontStyle &&
            (this.jsPDFDocument.setFontStyle(o[0]), (h = o[0]));
        }
        if (
          (this.jsPDFDocument.setFont(f, h),
          t.fontSize && this.jsPDFDocument.setFontSize(t.fontSize),
          !r)
        ) {
          var l = e.unifyColor(t.fillColor);
          (l && (i = this.jsPDFDocument).setFillColor.apply(i, l),
            (l = e.unifyColor(t.textColor)),
            l && (n = this.jsPDFDocument).setTextColor.apply(n, l),
            (l = e.unifyColor(t.lineColor)),
            l && (a = this.jsPDFDocument).setDrawColor.apply(a, l),
            typeof t.lineWidth == "number" &&
              this.jsPDFDocument.setLineWidth(t.lineWidth));
        }
      }),
...
function U(e, t, r, i) {
  var n = t.settings.tableLineWidth,
    a = t.settings.tableLineColor;
...
function F(e, t) {
  ...
  return typeof e == "object"
    ? (typeof e.vertical == "number" &&
        ((e.top = e.vertical), (e.bottom = e.vertical)),
      typeof e.horizontal == "number" &&
        ((e.right = e.horizontal), (e.left = e.horizontal)),
      {
...
function ot(e, t, r, i, n) {
  ...
  var o = ht(i, r);
  o && (a.cellPadding = o);
  var l = "borderTopColor",
    g = s * r,
    u = i.borderTopWidth;
  if (
    i.borderBottomWidth === u &&
    i.borderRightWidth === u &&
    i.borderLeftWidth === u
  ) {
  ...
  (m.indexOf(i.textAlign) !== -1 && (a.halign = i.textAlign),
    (m = ["middle", "bottom", "top"]),
    m.indexOf(i.verticalAlign) !== -1 && (a.valign = i.verticalAlign));
...
function st(e) {
  ...
  return (
    (e.fontWeight === "bold" ||
      e.fontWeight === "bolder" ||
      parseInt(e.fontWeight) >= 700) &&
      (t = "bold"),
    (e.fontStyle === "italic" || e.fontStyle === "oblique") && (t += "italic"),
    t
  );
}
function b(e, t) {
  ...
  var n = [parseInt(i[1]), parseInt(i[2]), parseInt(i[3])],
    a = parseInt(i[4]);
  return a === 0 || isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) ? null : n;
}
function X(e, t) {
  var r = t(e);
  return r === "rgba(0, 0, 0, 0)" ||
    r === "transparent" ||
    r === "initial" ||
    r === "inherit"
...
function ht(e, t) {
  var r = [e.paddingTop, e.paddingRight, e.paddingBottom, e.paddingLeft],
    i = 96 / (72 / t),
    n = (parseInt(e.lineHeight) - parseInt(e.fontSize)) / t / 2,
    a = r.map(function (h) {
...
function Z(e, t, r, i, n) {
  ...
  var f = Object.keys(e.getFontList()),
    o = e.scaleFactor(),
    l = [],
    g = [],
    u = [];
  if (!h)
    return (
      ...
      { head: l, body: g, foot: u }
    );
  for (var v = 0; v < h.rows.length; v++) {
    var d = h.rows[v],
      m =
        (s =
          (a = d?.parentElement) === null || a === void 0
            ? void 0
...
function ft(e, t, r, i, n, a) {
  ...
  if (s.length > 0 && (n || g.display !== "none")) return s;
}
function lt(e) {
  var t = e.cloneNode(!0);
  return (
    (t.innerHTML = t.innerHTML.replace(/\n/g, "").replace(/ +/g, " ")),
    (t.innerHTML = t.innerHTML.split(/<br.*?>/).map(function (r) {
      return r.trim();
    }).join(`
`)),
...
function gt(e, t, r) {
  for (var i = 0, n = [e, t, r]; i < n.length; i++) {
    ...
    (a &&
      typeof a != "object" &&
      console.error(
        "The options parameter should be of type object, is: " + typeof a,
      ),
      a.startY &&
        typeof a.startY != "number" &&
        (console.error("Invalid value for startY option", a.startY),
        delete a.startY));
  }
}
...
function B(e, t) {
  var r = new P(e),
    i = r.getDocumentOptions(),
    n = r.getGlobalOptions();
  gt(n, i, t);
  var a = w({}, n, i, t),
    s;
...
function vt(e, t, r) {
  for (
    ...
    var h = s[a];
    (h.didParseCell && n.didParseCell.push(h.didParseCell),
      h.willDrawCell && n.willDrawCell.push(h.willDrawCell),
      h.didDrawCell && n.didDrawCell.push(h.didDrawCell),
      h.willDrawPage && n.willDrawPage.push(h.willDrawPage),
      h.didDrawPage && n.didDrawPage.push(h.didDrawPage));
  }
  return n;
}
function dt(e, t) {
  var r,
    ...
    u,
    v,
    d = F(t.margin, 40 / e.scaleFactor()),
    m = (r = pt(e, t.startY)) !== null && r !== void 0 ? r : d.top,
    p;
  t.showFoot === !0
    ? (p = "everyPage")
    : t.showFoot === !1
      ? (p = "never")
      : (p = (i = t.showFoot) !== null && i !== void 0 ? i : "everyPage");
  var y;
  t.showHead === !0
    ? (y = "everyPage")
    : t.showHead === !1
      ? (y = "never")
      : (y = (n = t.showHead) !== null && n !== void 0 ? n : "everyPage");
  var x = (a = t.useCss) !== null && a !== void 0 ? a : !1,
    c = t.theme || (x ? "plain" : "striped"),
    C = !!t.horizontalPageBreak,
    rt = (s = t.horizontalPageBreakRepeat) !== null && s !== void 0 ? s : null;
  return {
    includeHiddenHtml:
      (h = t.includeHiddenHtml) !== null && h !== void 0 ? h : !1,
    useCss: x,
    theme: c,
    startY: m,
    margin: d,
    ...
    horizontalPageBreakBehaviour:
      (v = t.horizontalPageBreakBehaviour) !== null && v !== void 0
        ? v
        : "afterAllRows",
  };
}
function pt(e, t) {
  var r = e.getLastAutoTable(),
    i = e.scaleFactor(),
    n = e.pageNumber(),
    a = !1;
  ...
  return (
    Object.keys(i)
      ...
      .forEach(function (a) {
        var s = 1,
          h;
        (Array.isArray(i) ? (h = i[parseInt(a)]) : (h = i[a]),
          typeof h == "object" && !Array.isArray(h) && (s = h?.colSpan || 1));
        for (var f = 0; f < s; f++) {
          var o = void 0;
          Array.isArray(i)
            ? (o = n.length)
...
var A = (function () {
  ...
  wt = (function () {
    ...
    return (
      (e.prototype.getHeadHeight = function (t) {
  ...
  V = (function () {
    ...
    return (
      (e.prototype.getMaxCellHeight = function (t) {
        var r = this;
        return t.reduce(function (i, n) {
          var a;
          return Math.max(
            i,
            ((a = r.cells[n.index]) === null || a === void 0
              ? void 0
              : a.height) || 0,
          );
        }, 0);
      ...
      (e.prototype.getMinimumRowHeight = function (t, r) {
        ...
        return t.reduce(function (n, a) {
          ...
          if (!s) return 0;
          var h = r.getLineHeight(s.styles.fontSize),
            f = s.padding("vertical"),
            o = f + h;
          return o > n ? o : n;
        }, 0);
      }),
  ...
  tt = (function () {
    function e(t, r, i) {
      ...
      t != null && typeof t == "object" && !Array.isArray(t)
        ? ((this.rowSpan = t.rowSpan || 1),
          ...
          (a = (n = t.content) !== null && n !== void 0 ? n : t),
    ...
    return (
      (e.prototype.getTextPos = function () {
        var t;
        if (this.styles.valign === "top") t = this.y + this.padding("top");
        ...
        } else i = this.x + this.padding("left");
        return { x: i, y: t };
      }),
      (e.prototype.getContentHeight = function (t, r) {
        r === void 0 && (r = 1.15);
        var i = Array.isArray(this.text) ? this.text.length : 1,
          n = (this.styles.fontSize / t) * r,
          a = i * n + this.padding("vertical");
  ...
  St = (function () {
    ...
    return (
      (e.prototype.getMaxCustomCellWidth = function (t) {
        for (var r = 0, i = 0, n = t.allRows(); i < n.length; i++) {
          var a = n[i],
            s = a.cells[this.index];
          s &&
            typeof s.styles.cellWidth == "number" &&
            (r = Math.max(r, s.styles.cellWidth));
        }
        return r;
      }),
      e
...
function xt(e, t) {
  ...
  t.columns.forEach(function (a) {
    ...
    (s ? (a.width = s) : ((a.width = a.wrappedWidth), r.push(a)),
      (i += a.width));
  });
  ...
  (n &&
    ...
    (n = Math.abs(n)),
    !t.settings.horizontalPageBreak &&
      n > 0.1 / e.scaleFactor() &&
      ((n = n < 1 ? n : Math.round(n)),
      console.log(
        "Of the table content, ".concat(n, " units width could not fit page"),
      )),
    Ht(t),
    Dt(t, e),
    Pt(t));
...
function Ct(e, t) {
  var r = e.scaleFactor(),
    i = t.settings.horizontalPageBreak,
    n = Q(e, t);
  (t.allRows().forEach(function (a) {
    for (var s = 0, h = t.columns; s < h.length; s++) {
      ...
      if (o) {
        ...
        if (
          ((o.minReadableWidth = u + o.padding("horizontal")),
          typeof o.styles.cellWidth == "number")
        )
          ((o.minWidth = o.styles.cellWidth),
            (o.wrappedWidth = o.styles.cellWidth));
        else if (o.styles.cellWidth === "wrap" || i === !0)
          o.contentWidth > n
            ? ((o.minWidth = n), (o.wrappedWidth = n))
            : ((o.minWidth = o.contentWidth),
              (o.wrappedWidth = o.contentWidth));
        else {
          var v = 10 / r;
          ((o.minWidth = o.styles.minCellWidth || v),
            (o.wrappedWidth = o.contentWidth),
            o.minWidth > o.wrappedWidth && (o.wrappedWidth = o.minWidth));
        }
      }
    }
  }),
    t.allRows().forEach(function (a) {
      for (var s = 0, h = t.columns; s < h.length; s++) {
        var f = h[s],
          o = a.cells[f.index];
        if (o && o.colSpan === 1)
          ((f.wrappedWidth = Math.max(f.wrappedWidth, o.wrappedWidth)),
            (f.minWidth = Math.max(f.minWidth, o.minWidth)),
            (f.minReadableWidth = Math.max(
              f.minReadableWidth,
              o.minReadableWidth,
            )));
        else {
          var l =
              t.styles.columnStyles[f.dataKey] ||
              t.styles.columnStyles[f.index] ||
              {},
            g = l.cellWidth || l.minCellWidth;
          g && typeof g == "number" && ((f.minWidth = g), (f.wrappedWidth = g));
        }
        o &&
          (o.colSpan > 1 && !f.minWidth && (f.minWidth = o.minWidth),
          o.colSpan > 1 && !f.wrappedWidth && (f.wrappedWidth = o.minWidth));
      }
    }));
}
function j(e, t, r) {
...
function Pt(e) {
  for (var t = {}, r = 1, i = e.allRows(), n = 0; n < i.length; n++)
    for (var a = i[n], s = 0, h = e.columns; s < h.length; s++) {
      var f = h[s],
        o = t[f.index];
      if (r > 1) (r--, delete a.cells[f.index]);
      else if (o)
        ((o.cell.height += a.height),
          (r = o.cell.colSpan),
          delete a.cells[f.index],
          o.left--,
          o.left <= 1 && delete t[f.index]);
      else {
        var l = a.cells[f.index];
        if (!l) continue;
        if (((l.height = a.height), l.rowSpan > 1)) {
          var g = i.length - n,
            u = l.rowSpan > g ? g : l.rowSpan;
...
function Dt(e, t) {
  for (
    var r = { count: 0, height: 0 }, i = 0, n = e.allRows();
    i < n.length;
    i++
  ) {
    for (var a = n[i], s = 0, h = e.columns; s < h.length; s++) {
      ...
      if (o) {
        ...
        if (o.styles.overflow === "linebreak")
          o.text = t.splitTextToSize(o.text, l + 1 / t.scaleFactor(), {
        ...
        o.contentHeight = o.getContentHeight(
          t.scaleFactor(),
          t.getLineHeightFactor(),
        );
        var u = o.contentHeight / o.rowSpan;
        (o.rowSpan > 1 && r.count * r.height < u * o.rowSpan
          ? (r = { height: u, count: o.rowSpan })
          : r && r.count > 0 && r.height > u && (u = r.height),
          u > a.height && (a.height = u));
      }
    }
    r.count--;
  }
...
function Wt(e, t, r, i, n) {
  ...
  if (((t = Math.ceil(t * a) / a), t >= D(e, r, i))) return e;
      ...
      for (var l = 0, g = {}, u = 0, v = 0, d = 0, m = r; d < m.length; d++) {
        ...
        if (s[p.index] == null || s[p.index].left === 0)
          if (v === 0) {
            ...
            var c = Tt(e, p, o, n, i, a, x),
              C = new tt(y, c, e);
            ((g[p.dataKey] = C),
              (g[p.index] = C),
              (v = C.colSpan - 1),
              (s[p.index] = { left: C.rowSpan - 1, times: v }));
          } else (v--, u++);
        else (s[p.index].left--, (v = s[p.index].times), l++);
      }
...
function bt(e, t) {
  if (e === "head") {
    if (typeof t == "object") return t.header || null;
...
function kt(e) {
  return e.map(function (t, r) {
    ...
    return (
      typeof t == "object"
        ? (n = (i = t.dataKey) !== null && i !== void 0 ? i : r)
        : (n = r),
      new St(n, t, r)
    );
  });
...
function Tt(e, t, r, i, n, a, s) {
  ...
  e === "head"
    ...
    : e === "body"
      ? (f = n.bodyStyles)
      : e === "foot" && (f = n.footStyles);
  var o = w({}, h.table, h[e], n.styles, f),
    l = n.columnStyles[t.dataKey] || n.columnStyles[t.index] || {},
    g = e === "body" ? l : {},
    u =
      e === "body" && r % 2 === 0
        ? w({}, h.alternateRow, n.alternateRowStyles)
        : {},
    v = nt(a),
    d = w({}, v, o, u, g);
  return w(d, s);
...
function Rt(e, t, r) {
  ...
  var n = Q(e, t),
    ...
    h = [],
    f = [];
  (Array.isArray(t.settings.horizontalPageBreakRepeat)
    ? (f = t.settings.horizontalPageBreakRepeat)
    : (typeof t.settings.horizontalPageBreakRepeat == "string" ||
        typeof t.settings.horizontalPageBreakRepeat == "number") &&
      (f = [t.settings.horizontalPageBreakRepeat]),
  ...
  for (
    ...
    if (o || n >= g) ((o = !1), s.push(l), h.push(t.columns[l]), (n -= g));
    else break;
    l++;
  }
...
function E(e, t) {
  var r = t.settings,
    ...
    n = r.margin,
    a = { x: n.left, y: i },
    s = t.getHeadHeight(t.columns) + t.getFootHeight(t.columns),
    h = i + n.bottom + s;
  if (r.pageBreak === "avoid") {
    var f = t.body,
      o = f.reduce(function (u, v) {
        return u + v.height;
      }, 0);
    h += o;
  }
  var l = new P(e);
  ((r.pageBreak === "always" ||
    (r.startY != null && h > l.pageSize().height)) &&
    (it(l), (a.y = n.top)),
    t.callWillDrawPageHooks(l, a));
  var g = w({}, a);
  ((t.startPageNumber = l.pageNumber()),
    r.horizontalPageBreak
      ? At(l, t, g, a)
      : (l.applyStyles(l.userStyles),
        (r.showHead === "firstPage" || r.showHead === "everyPage") &&
          t.head.forEach(function (u) {
            return S(l, t, u, a, t.columns);
          }),
        l.applyStyles(l.userStyles),
        t.body.forEach(function (u, v) {
          var d = v === t.body.length - 1;
          W(l, t, u, d, g, a, t.columns);
        }),
        l.applyStyles(l.userStyles),
        (r.showFoot === "lastPage" || r.showFoot === "everyPage") &&
          t.foot.forEach(function (u) {
            return S(l, t, u, a, t.columns);
          })),
    U(l, t, g, a),
    t.callEndPageHooks(l, a),
    (t.finalY = a.y),
    (e.lastAutoTable = t),
    l.applyStyles(l.userStyles));
}
  ...
  if (a.horizontalPageBreakBehaviour === "afterAllRows")
    n.forEach(function (o, l) {
      (e.applyStyles(e.userStyles),
        l > 0 ? H(e, t, r, i, o.columns, !0) : Y(e, t, i, o.columns),
        jt(e, t, r, i, o.columns),
        T(e, t, i, o.columns));
    });
  else
    for (
      var s = -1,
        ...
        f = function () {
          ...
          (n.slice(1).forEach(function (u) {
            (e.applyStyles(e.userStyles),
              H(e, t, r, i, u.columns, !0),
              I(e, t, s + 1, i, u.columns, g),
              T(e, t, i, u.columns));
          }),
            (s = o));
        };
...
function Y(e, t, r, i) {
  var n = t.settings;
  (e.applyStyles(e.userStyles),
    (n.showHead === "firstPage" || n.showHead === "everyPage") &&
      t.head.forEach(function (a) {
        return S(e, t, a, r, i);
      }));
}
function jt(e, t, r, i, n) {
  (e.applyStyles(e.userStyles),
    t.body.forEach(function (a, s) {
...
function I(e, t, r, i, n, a) {
  ...
  var s = Math.min(r + a, t.body.length),
    h = -1;
  return (
    t.body.slice(r, s).forEach(function (f, o) {
      var l = r + o === t.body.length - 1,
        g = et(e, t, l, i);
...
function T(e, t, r, i) {
  var n = t.settings;
  (e.applyStyles(e.userStyles),
    (n.showFoot === "lastPage" || n.showFoot === "everyPage") &&
      t.foot.forEach(function (a) {
        return S(e, t, a, r, i);
      }));
}
function Bt(e, t, r) {
  var i = r.getLineHeight(e.styles.fontSize),
    n = e.padding("vertical"),
    a = Math.floor((t - n) / i);
  return Math.max(0, a);
}
function Lt(e, t, r, i) {
  ...
  for (var a = 0, s = 0, h = r.columns; s < h.length; s++) {
    ...
    if (o) {
      ...
      var u = i.scaleFactor(),
        v = i.getLineHeightFactor();
      ((o.contentHeight = o.getContentHeight(u, v)),
        o.contentHeight >= t &&
          ((o.contentHeight = t), (l.styles.minCellHeight -= t)),
        o.contentHeight > e.height && (e.height = o.contentHeight),
        (l.contentHeight = l.getContentHeight(u, v)),
        l.contentHeight > a && (a = l.contentHeight),
        (n[f.index] = l));
    }
  }
...
function Et(e, t, r, i) {
  var n = e.pageSize().height,
    a = i.settings.margin,
    s = a.top + a.bottom,
    h = n - s;
  t.section === "body" &&
    (h -= i.getHeadHeight(i.columns) + i.getFootHeight(i.columns));
  var f = t.getMinimumRowHeight(i.columns, e),
    o = f < r;
  if (f > h)
    return (
      console.log(
  ...
  if (!o) return !1;
  var l = t.hasRowSpan(i.columns),
    g = t.getMaxCellHeight(i.columns) > h;
  return g
    ? (l &&
        console.log(
      ...
      !0)
    : !(l || i.settings.rowPageBreak === "avoid");
}
function W(e, t, r, i, n, a, s) {
  var h = et(e, t, i, a);
  if (r.canEntireRowFit(h, s)) S(e, t, r, a, s);
  else if (Et(e, r, h, t)) {
    var f = Lt(r, h, t, e);
    (S(e, t, r, a, s), H(e, t, n, a, s), W(e, t, f, i, n, a, s));
  } else (H(e, t, n, a, s), W(e, t, r, i, n, a, s));
}
function S(e, t, r, i, n) {
  ...
  for (var a = 0, s = n; a < s.length; a++) {
    ...
    (q(
      ...
      t.callCellHooks(e, t.hooks.didDrawCell, f, r, h, i),
      (i.x += h.width));
  }
  i.y += r.height;
}
function Mt(e, t, r) {
  var i = t.styles;
  if (
    (e.getDocument().setFillColor(e.getDocument().getFillColor()),
    typeof i.lineWidth == "number")
  ) {
    var n = $(i.lineWidth, i.fillColor);
    n && e.rect(t.x, r.y, t.width, t.height, n);
  } else
    typeof i.lineWidth == "object" &&
      (i.fillColor && e.rect(t.x, r.y, t.width, t.height, "F"),
      Nt(e, t, r, i.lineWidth));
}
function Nt(e, t, r, i) {
  var n, a, s, h;
  (i.top &&
...
function et(e, t, r, i) {
  var n = t.settings.margin.bottom,
    a = t.settings.showFoot;
  return (
    (a === "everyPage" || (a === "lastPage" && r)) &&
      (n += t.getFootHeight(t.columns)),
    e.pageSize().height - i.y - n
  );
}
function H(e, t, r, i, n, a) {
  (n === void 0 && (n = []),
    a === void 0 && (a = !1),
    e.applyStyles(e.userStyles),
    t.settings.showFoot === "everyPage" &&
      !a &&
      t.foot.forEach(function (h) {
        return S(e, t, h, i, n);
      }),
  ...
  (U(e, t, r, i),
    ...
    (i.y = s.top),
    (r.y = s.top),
    t.callWillDrawPageHooks(e, i),
    t.settings.showHead === "everyPage" &&
...
function Ot(e) {
  ((e.API.autoTable = function () {
    ...
    (e.API.lastAutoTable = !1),
    (e.API.autoTableText = function (t, r, i, n) {
      q(t, r, i, n, this);
    }),
...
try {
  if (typeof window < "u" && window) {
    var K = window,
      _ =
        K.jsPDF || ((R = K.jspdf) === null || R === void 0 ? void 0 : R.jsPDF);
    _ && Ot(_);
  }
} catch (e) {
