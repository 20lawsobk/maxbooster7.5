...
import { L as k } from "./Logo-DS4JhmIC.js";
import { S as v, a as w, b as P, c as D, d as j } from "./sheet-DTRVkwak.js";
        ...
        e.jsxDEV(
          "nav",
          {
            ...
            children: e.jsxDEV(
                            ...
                            i,
                            {
                              ...
                              children: [
                                e.jsxDEV(
                                  ...
                                  {
                                    fileName:
                                      "/home/runner/workspace/client/src/pages/Pricing.tsx",
                                    lineNumber: 131,
                                    columnNumber: 17,
                                  },
                                  this,
                          ...
                          children: [
                            e.jsxDEV(
                              s,
                              {
                                ...
                                children: e.jsxDEV(
                                  i,
                                  { variant: "ghost", children: "Features" },
                                  void 0,
                                  !1,
                                  {
                                    fileName:
              ...
              !1,
              {
                fileName: "/home/runner/workspace/client/src/pages/Pricing.tsx",
                lineNumber: 127,
                columnNumber: 9,
              },
              this,
          ...
          "div",
          {
            ...
            children: [
              e.jsxDEV(
                "div",
                {
                  ...
                  children: e.jsxDEV(
                    ...
                    {
                      className:
                        "bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-700 rounded-2xl p-6 shadow-lg",
                      children: e.jsxDEV(
                        "div",
                        {
                          className:
                          ...
                          children: [
                            e.jsxDEV(
                              ...
                              {
                                className:
                                  "h-12 w-12 text-green-600 dark:text-green-400 flex-shrink-0",
                              },
                              void 0,
                              !1,
                              {
                                ...
                                children: [
                                  ...
                                  e.jsxDEV(
                                    "p",
                                    {
                                      ...
                                      children:
                                        "Purchase Max Booster with confidence. If you're not completely satisfied within 90 days, you'll receive a 100% refund of your payment—no questions asked.",
                                    },
                                    void 0,
                                    !1,
                                    {
                ...
                "div",
                {
                  ...
                  children: [
                    e.jsxDEV(
                      ...
                      {
                        className:
                          "mb-6 bg-primary/10 text-primary border-primary/20",
                        children: [
                          e.jsxDEV(
                            f,
                    ...
                    e.jsxDEV(
                      ...
                      {
                        className:
                          "text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8",
                        children:
                          "Replace $45,000+/year in tools and labor. Get professional AI studio, autonomous autopilots for social media & advertising, marketplace, analytics, and distribution.",
                      },
                      void 0,
                      !1,
                      {
                    ...
                    e.jsxDEV(
                      ...
                      {
                        className:
                          "flex items-center justify-center space-x-4 flex-wrap gap-2",
                        children: [
                          e.jsxDEV(
                            "div",
                            {
                              className:
                                "flex items-center text-sm text-gray-600 dark:text-gray-300 font-medium",
                              children: [
                                e.jsxDEV(
                                  c,
                ...
                "div",
                {
                  ...
                  children: d.map((r) =>
                    e.jsxDEV(
                      o,
                      {
                        className: `relative dark:bg-gray-900 dark:border-gray-700 ${r.popular ? "border-primary shadow-2xl scale-105 z-10" : "shadow-lg hover:shadow-xl"} transition-all duration-300`,
                        children: [
                          r.popular &&
                            e.jsxDEV(
                              l,
                              {
                                className:
                                  "absolute -top-3 left-1/2 transform -translate-x-1/2 bg-primary px-6 py-1",
                                ...
                                e.jsxDEV(
                                  "div",
                                  {
                                    ...
                                    children: e.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 border-green-200 dark:border-green-700 px-3 py-1",
                                        children: [
                                          e.jsxDEV(
                                            c,
                                            { className: "h-4 w-4 mr-2" },
                                          ...
                                          "div",
                                          {
                                            ...
                                            children: [
                                              ...
                                              e.jsxDEV(
                                                ...
                                                {
                                                  className:
                                                    "text-green-600 dark:text-green-400 ml-2 font-medium",
                                                  children: [
                                                    "Save $",
                                                    (r.originalPrice -
                                                      r.price) *
                            ...
                            m,
                            {
                              ...
                              children: [
                                ...
                                e.jsxDEV(
                                  s,
                                  {
                                    href: `/register/payment/${r.id}`,
                                    children: e.jsxDEV(
                                      i,
                                      {
                                        className: `w-full py-3 ${r.popular ? "bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90" : ""}`,
                                        variant: r.popular
                                          ? "default"
                                          : "outline",
                                        size: "lg",
                                ...
                                e.jsxDEV(
                                  ...
                                  {
                                    className:
                                      "text-center text-xs text-gray-500 dark:text-gray-400 mt-3",
                                    children:
                                      r.period === "once"
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    e.jsxDEV(
                      ...
                      {
                        className:
                          "bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden dark:border dark:border-gray-700",
                        children: e.jsxDEV(
                          "div",
                          {
                                        ...
                                        "tr",
                                        {
                                          children: [
                                            e.jsxDEV(
                                              ...
                                              {
                                                className:
                                                  "text-left p-6 font-semibold text-gray-900 dark:text-white",
                                                children: "Features",
                                              },
                                              void 0,
                                              !1,
                                            ...
                                            e.jsxDEV(
                                              ...
                                              {
                                                className:
                                                  "text-center p-6 font-semibold text-gray-900 dark:text-white",
                                                children: "Monthly",
                                              },
                                              void 0,
                                              !1,
                                            ...
                                            e.jsxDEV(
                                              ...
                                              {
                                                className:
                                                  "text-center p-6 font-semibold text-gray-900 dark:text-white bg-primary/5",
                                                children: [
                                                  "Yearly",
                                                  e.jsxDEV(
                                                    l,
                                  ...
                                  e.jsxDEV(
                                    "tbody",
                                    {
                                      ...
                                      children: [
                                        ...
                                        {
                                          feature:
                                            "Advertisement Autopilot (Zero Cost)",
                                          monthly: !0,
                                          yearly: !0,
                                          lifetime: !0,
                                        },
                                          ...
                                          "tr",
                                          {
                                            children: [
                                              e.jsxDEV(
                                                ...
                                                {
                                                  className:
                                                    "p-6 font-medium text-gray-900 dark:text-white",
                                                  children: r.feature,
                                                },
                                                void 0,
                                                !1,
              ...
              e.jsxDEV(
                ...
                {
                  className:
                    "text-center mt-20 p-12 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl text-white",
                  children: [
                    e.jsxDEV(
                      "h2",
                      {
                        className: "text-3xl font-bold mb-4",
                        children: "Ready to Boost Your Music Career?",
                      },
                      void 0,
                      !1,
                      {
