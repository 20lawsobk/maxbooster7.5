...
let { freeze: S, seal: b, create: ne } = Object,
...
Ue ||
  (Ue = function (o, l) {
    for (
      var a = arguments.length, c = new Array(a > 2 ? a - 2 : 0), O = 2;
      O < a;
      O++
    )
      c[O - 2] = arguments[O];
...
Fe ||
  (Fe = function (o) {
    for (
      var l = arguments.length, a = new Array(l > 1 ? l - 1 : 0), c = 1;
      c < l;
      c++
    )
      a[c - 1] = arguments[c];
...
const Z = R(Array.prototype.forEach),
...
function Jt(s) {
  for (let o = 0; o < s.length; o++) C(s, o) || (s[o] = null);
  return s;
}
function M(s) {
  const o = ne(null);
...
function St() {
  ...
  if (
    ((o.version = "3.4.0"),
    (o.removed = []),
    !s || !s.document || s.document.nodeType !== te.document || !s.Element)
  )
  ...
  const Wt = l.createElement("form"),
    ...
    ye = function () {
      ...
      if (!(W && W === e)) {
        if (
          ...
          (e = M(e)),
          (K =
            zt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? Gt : e.PARSER_MEDIA_TYPE),
          (p = K === "application/xhtml+xml" ? Me : Ee),
          (T = C(e, "ALLOWED_TAGS") ? r({}, e.ALLOWED_TAGS, p) : We),
          (d = C(e, "ALLOWED_ATTR") ? r({}, e.ALLOWED_ATTR, p) : Be),
          (be = C(e, "ALLOWED_NAMESPACES")
            ? r({}, e.ALLOWED_NAMESPACES, Me)
            : Ft),
          (De = C(e, "ADD_URI_SAFE_ATTR")
            ? r(M(Ze), e.ADD_URI_SAFE_ATTR, p)
            : Ze),
          (qe = C(e, "ADD_DATA_URI_TAGS")
            ? r(M(Ke), e.ADD_DATA_URI_TAGS, p)
            : Ke),
          (I = C(e, "FORBID_CONTENTS") ? r({}, e.FORBID_CONTENTS, p) : Oe),
          (V = C(e, "FORBID_TAGS") ? r({}, e.FORBID_TAGS, p) : M({})),
          (le = C(e, "FORBID_ATTR") ? r({}, e.FORBID_ATTR, p) : M({})),
          (z = C(e, "USE_PROFILES") ? e.USE_PROFILES : !1),
          (Ye = e.ALLOW_ARIA_ATTR !== !1),
          (he = e.ALLOW_DATA_ATTR !== !1),
          ...
          (Se = e.FORCE_BODY || !1),
          (Ve = e.SANITIZE_DOM !== !1),
          ($e = e.SANITIZE_NAMED_PROPS || !1),
          (Re = e.KEEP_CONTENT !== !1),
          (q = e.IN_PLACE || !1),
          (Ge = e.ALLOWED_URI_REGEXP || ht),
          (G = e.NAMESPACE || N),
          (pe = e.MATHML_TEXT_INTEGRATION_POINTS || pe),
          (Te = e.HTML_INTEGRATION_POINTS || Te),
          (u = e.CUSTOM_ELEMENT_HANDLING || ne(null)),
          e.CUSTOM_ELEMENT_HANDLING &&
            Je(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
            (u.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
          e.CUSTOM_ELEMENT_HANDLING &&
            Je(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
          ...
          z &&
            ((T = r({}, pt)),
            (d = ne(null)),
            z.html === !0 && (r(T, mt), r(d, Tt)),
            z.svg === !0 && (r(T, xe), r(d, ve), r(d, de)),
            z.svgFilters === !0 && (r(T, Pe), r(d, ve), r(d, de)),
            z.mathMl === !0 && (r(T, ke), r(d, dt), r(d, de))),
          (x.tagCheck = null),
          (x.attributeCheck = null),
          e.ADD_TAGS &&
            (typeof e.ADD_TAGS == "function"
              ? (x.tagCheck = e.ADD_TAGS)
              : (T === We && (T = M(T)), r(T, e.ADD_TAGS, p))),
          e.ADD_ATTR &&
            (typeof e.ADD_ATTR == "function"
              ? (x.attributeCheck = e.ADD_ATTR)
              : (d === Be && (d = M(d)), r(d, e.ADD_ATTR, p))),
          e.ADD_URI_SAFE_ATTR && r(De, e.ADD_URI_SAFE_ATTR, p),
          e.FORBID_CONTENTS &&
            (I === Oe && (I = M(I)), r(I, e.FORBID_CONTENTS, p)),
          e.ADD_FORBID_CONTENTS &&
            (I === Oe && (I = M(I)), r(I, e.ADD_FORBID_CONTENTS, p)),
          Re && (T["#text"] = !0),
          v && r(T, ["html", "head", "body"]),
          T.table && (r(T, ["tbody"]), delete V.tbody),
          ...
          (g === void 0 && (g = un(oe, c)),
            g !== null && typeof j == "string" && (j = g.createHTML("")));
        (S && S(e), (W = e));
      }
    },
    Qe = r({}, [...xe, ...Pe, ...Qt]),
    ...
    Bt = function (e) {
      let t = ie(e);
      (!t || !t.tagName) && (t = { namespaceURI: G, tagName: "template" });
      const n = Ee(e.tagName),
        f = Ee(t.tagName);
          ...
          : e.namespaceURI === ue
            ? t.namespaceURI === N
              ...
              : t.namespaceURI === me
                ...
                : !!et[n]
            : e.namespaceURI === N
              ? (t.namespaceURI === me && !Te[f]) ||
                (t.namespaceURI === ue && !pe[f])
                ? !1
                : !et[n] && (Ht[n] || !Qe[n])
              : !!(K === "application/xhtml+xml" && be[e.namespaceURI])
        : !1;
    },
    y = function (e) {
    ...
    tt = function (e) {
      ...
      return (
        e && n && _.insertBefore(l.createTextNode(n), _.childNodes[0] || null),
        G === N ? Mt.call(t, v ? "html" : "body")[0] : v ? t.documentElement : _
      );
    },
    nt = function (e) {
      return It.call(
        ...
        Y.SHOW_ELEMENT |
          Y.SHOW_COMMENT |
          Y.SHOW_TEXT |
          Y.SHOW_PROCESSING_INSTRUCTION |
          Y.SHOW_CDATA_SECTION,
        null,
      );
    },
    Ce = function (e) {
  ...
  const ot = function (e) {
      let t = null;
      if ((w(h.beforeSanitizeElements, e, null), Ce(e))) return (y(e), !0);
      const n = p(e.nodeName);
      if (
        (w(h.uponSanitizeElement, e, { tagName: n, allowedTags: T }),
        ($ &&
          e.hasChildNodes() &&
          ...
          ($ &&
            ...
            n === "style" &&
            Ie(e.firstElementChild)) ||
          e.nodeType === te.progressingInstruction ||
          ($ && e.nodeType === te.comment && A(/<[/\w]/g, e.data)))
      )
        return (y(e), !0);
      if (
        V[n] ||
        (!(x.tagCheck instanceof Function && x.tagCheck(n)) && !T[n])
      ) {
        if (
          !V[n] &&
          at(n) &&
          ((u.tagNameCheck instanceof RegExp && A(u.tagNameCheck, n)) ||
            (u.tagNameCheck instanceof Function && u.tagNameCheck(n)))
        )
          return !1;
        if (Re && !I[n]) {
          const f = ie(e) || e.parentNode,
            _ = Ct(e) || e.childNodes;
          if (_ && f) {
            const m = _.length;
            for (let D = m - 1; D >= 0; --D) {
              const L = Lt(_[D], !0);
              ((L.__removalCount = (e.__removalCount || 0) + 1),
                f.insertBefore(L, yt(e)));
            }
          }
        }
        return (y(e), !0);
      }
      return (e instanceof He && !Bt(e)) ||
        ...
        : (k &&
            ...
            e.textContent !== t &&
              (J(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
          w(h.afterSanitizeElements, e, null),
          !1);
    },
    it = function (e, t, n) {
      ...
      if (!(he && !le[t] && A(xt, t))) {
        if (!(Ye && A(Pt, t))) {
          if (
            !(x.attributeCheck instanceof Function && x.attributeCheck(t, e))
          ) {
            if (!d[t] || le[t]) {
              if (
                !(
                  (at(e) &&
                    ((u.tagNameCheck instanceof RegExp &&
                      A(u.tagNameCheck, e)) ||
    ...
    rt = function (e) {
      ...
      for (; f--; ) {
        const _ = t[f],
          { name: m, namespaceURI: D, value: L } = _,
          P = p(m),
          Ne = L;
        ...
        if (
          ...
          w(h.uponSanitizeAttribute, e, n),
          (E = n.attrValue),
          $e && (P === "id" || P === "name") && (U(m, e), (E = Ut + E)),
          $ &&
            A(
        ...
        if (
          g &&
          typeof oe == "object" &&
          typeof oe.getAttributeType == "function" &&
          !D
        )
        ...
        if (E !== Ne)
          try {
            (D ? e.setAttributeNS(D, m, E) : e.setAttribute(m, E),
              Ce(e) ? y(e) : ut(o.removed));
          } catch {
            U(m, e);
          }
      }
    ...
    st = function (e) {
      ...
      for (w(h.beforeSanitizeShadowDOM, e, null); (t = n.nextNode()); )
        (w(h.uponSanitizeShadowNode, t, null),
          ot(t),
          rt(t),
          t.content instanceof O && st(t.content));
  ...
  return (
    (o.sanitize = function (i) {
      ...
      if (
        (Ae || ye(e), (o.removed = []), typeof i == "string" && (q = !1), q)
      ) {
        if (i.nodeName) {
        ...
        ((t = tt("<!---->")),
          ...
          (n.nodeType === te.element && n.nodeName === "BODY") ||
          n.nodeName === "HTML"
            ? (t = n)
            : t.appendChild(n));
      else {
        if (!H && !k && !v && i.indexOf("<") === -1)
          return g && fe ? g.createHTML(i) : i;
        if (((t = tt(i)), !t)) return H ? null : fe ? j : "";
      }
      t && Se && y(t.firstChild);
      const m = nt(q ? i : t);
      for (; (f = m.nextNode()); )
      ...
      if (H) {
        ...
        return (
          (d.shadowroot || d.shadowrootmode) && (_ = wt.call(a, _, !0)),
          _
        );
      }
      ...
      return (
        v &&
          ...
          A(At, t.ownerDocument.doctype.name) &&
          (D =
            "<!DOCTYPE " +
            t.ownerDocument.doctype.name +
            `>
