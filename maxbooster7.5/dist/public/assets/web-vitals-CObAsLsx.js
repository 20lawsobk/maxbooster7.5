...
const p = (t) => {
    ...
    return (a) => {
      e.value >= 0 &&
        ...
        (s || r === void 0) &&
          ...
          (e.delta = s),
          (e.rating = ((o, c) =>
            o > c[1] ? "poor" : o > c[0] ? "needs-improvement" : "good")(
            e.value,
            i,
          )),
          t(e)));
  ...
  C = new WeakMap();
function w(t, e) {
  return (C.get(t) || C.set(t, new e()), C.get(t));
}
class _ {
  t;
  i = 0;
...
const O = new Set(),
  ...
  b = (t) => {
    if (document.visibilityState === "hidden") {
      if (t.type === "visibilitychange") for (const e of O) e();
      isFinite(m) ||
        ((m = t.type === "visibilitychange" ? t.timeStamp : 0),
      ...
      ((m =
        (document.prerendering
          ...
          : globalThis.performance
              ...
              .find((i) => i.name === "hidden" && i.startTime >= t)
              ?.startTime) ?? M()),
        ...
        for (const o of a)
          o.name === "first-contentful-paint" &&
            ...
            o.startTime < i.firstHiddenTime &&
              ((r.value = Math.max(o.startTime - f(), 0)),
              r.entries.push(o),
              n(!0)));
      });
      s &&
        ((n = d(t, r, F, e.reportAllChanges)),
        p((a) => {
          ((r = u("FCP")),
            (n = d(t, r, F, e.reportAllChanges)),
            P(() => {
...
let S;
const B = () => (S ? $ : (performance.interactionCount ?? 0)),
  z = () => {
    "interactionCount" in performance ||
      S ||
      (S = v("event", j, { durationThreshold: 0 }));
  };
let H = 0;
class G {
  l = [];
  ...
  p;
  v() {
    ((H = B()), (this.l.length = 0), this.u.clear());
  }
  T() {
    const e = Math.min(this.l.length - 1, Math.floor((B() - H) / 50));
    return this.l[e];
  }
  h(e) {
    ...
    if (n || this.l.length < 10 || e.duration > i.L) {
      if (
        (n
          ? e.duration > n.L
            ? ((n.entries = [e]), (n.L = e.duration))
            : e.duration === n.L &&
              e.startTime === n.entries[0].startTime &&
              n.entries.push(e)
          : ((n = { id: e.interactionId, entries: [e], L: e.duration }),
            this.u.set(n.id, n),
            this.l.push(n)),
        this.l.sort((r, s) => s.L - r.L),
        this.l.length > 10)
      ) {
        const r = this.l.splice(10);
        for (const s of r) this.u.delete(s.id);
      }
      this.p?.(n);
    }
  }
  ...
  Q = (t, e = {}) => {
    ...
    y(() => {
      ...
      const s = w(e, G),
        a = (c) => {
          D(() => {
            for (const h of c) s.h(h);
            const l = s.T();
            l &&
              l.L !== r.value &&
              ((r.value = l.L), (r.entries = l.entries), n());
          });
        },
        o = v("event", a, { durationThreshold: e.durationThreshold ?? 40 });
      ((n = d(t, r, x, e.reportAllChanges)),
        o &&
          ...
          p(() => {
            (s.v(), (r = u("INP")), (n = d(t, r, x, e.reportAllChanges)));
          })));
    });
  };
class J {
    ...
    y(() => {
      ...
      const s = w(e, J),
        a = (c) => {
          ...
          for (const l of c)
            (s.h(l),
              l.startTime < i.firstHiddenTime &&
                ((r.value = Math.max(l.startTime - f(), 0)),
                (r.entries = [l]),
                n()));
        },
        o = v("largest-contentful-paint", a);
      if (o) {
        n = d(t, r, q, e.reportAllChanges);
        const c = A(() => {
            (a(o.takeRecords()), o.disconnect(), n(!0));
          }),
          l = (h) => {
            h.isTrusted &&
              (D(c), removeEventListener(h.type, l, { capture: !0 }));
          };
        for (const h of ["keydown", "click", "visibilitychange"])
          addEventListener(h, l, { capture: !0 });
        p((h) => {
          ((r = u("LCP")),
            (n = d(t, r, q, e.reportAllChanges)),
            P(() => {
              ((r.value = performance.now() - h.timeStamp), n(!0));
            }));
        });
      }
    });
  ...
  E = (t) => {
    document.prerendering
      ...
      : document.readyState !== "complete"
        ? addEventListener("load", () => E(t), !0)
        : setTimeout(t);
  },
  V = (t, e = {}) => {
    let i = u("TTFB"),
      n = d(t, i, N, e.reportAllChanges);
    E(() => {
      const r = I();
      r &&
        ((i.value = Math.max(r.responseStart - f(), 0)),
        (i.entries = [r]),
        n(!0),
        p(() => {
          ((i = u("TTFB", 0)), (n = d(t, i, N, e.reportAllChanges)), n(!0));
        }));
    });
  };
export {
