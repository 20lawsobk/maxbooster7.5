...
- Built-in Authoritative DNS Server (`server/services/dnsServer.ts`) using `dns2`. Handles A, AAAA, NS, SOA, CNAME, MX, TXT, and **CAA** (type 257) records. RFC 8482-compliant ANY response.
