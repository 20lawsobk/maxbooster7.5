...
export class KeyframeStyleSelector extends BaseModel {
  ...
  public async selectStyle(
    input: KeyframeSelectorInput,
  ...
  public static makeSyntheticSamples(count: number): {
    ...
    const styleAffinities: Array<{
      condition: (i: KeyframeSelectorInput) => boolean;
      styles: VideoStyle[];
    }> = [
      {
        condition: (i) =>
          i.tone === "high_energy" &&
          (i.aesthetic === "neon_glitch" || i.aesthetic === "futuristic"),
      ...
      {
        condition: (i) =>
          i.emotionalGoal === "excitement" || i.emotionalGoal === "action",
      ...
      {
        condition: (i) =>
          i.aesthetic === "urban" || i.emotionalGoal === "connection",
