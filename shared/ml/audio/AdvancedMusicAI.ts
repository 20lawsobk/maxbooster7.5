...
const GENRE_KNOWLEDGE: Record<string, {
  ...
  hardtechno: {
    ...
    era: '1990s-present',
    instruments: ['distorted-kick', 'acid-bass', 'synth', 'industrial-percussion'],
  },
  idm: {
    tempo: [100, 160],
    swing: 0.3,
  ...
  hyperpop: {
    ...
    era: '2015s-present',
    instruments: ['glitched-synth', 'distorted-808', 'vocal-processing', 'kick'],
  },
  latinpop: {
    tempo: [90, 120],
    swing: 0.1,
...
const MOOD_SEMANTICS: Record<string, MoodVector> = {
  happy: { valence: 0.9, arousal: 0.6, dominance: 0.6, tension: 0.1, brightness: 0.85 },
  sad: { valence: -0.8, arousal: -0.4, dominance: -0.5, tension: 0.3, brightness: 0.2 },
  dark: { valence: -0.5, arousal: 0.2, dominance: 0.5, tension: 0.6, brightness: 0.15 },
  bright: { valence: 0.6, arousal: 0.5, dominance: 0.4, tension: 0.1, brightness: 0.9 },
  aggressive: { valence: -0.3, arousal: 0.9, dominance: 0.9, tension: 0.85, brightness: 0.5 },
  soft: { valence: 0.3, arousal: -0.6, dominance: -0.4, tension: 0.05, brightness: 0.4 },
  warm: { valence: 0.5, arousal: 0.1, dominance: 0.3, tension: 0.1, brightness: 0.45 },
  cold: { valence: -0.2, arousal: -0.2, dominance: 0.2, tension: 0.3, brightness: 0.6 },
  ethereal: { valence: 0.4, arousal: -0.3, dominance: -0.2, tension: 0.1, brightness: 0.55 },
  punchy: { valence: 0.3, arousal: 0.8, dominance: 0.7, tension: 0.4, brightness: 0.6 },
  chill: { valence: 0.5, arousal: -0.5, dominance: 0.0, tension: 0.05, brightness: 0.4 },
  hype: { valence: 0.7, arousal: 0.95, dominance: 0.8, tension: 0.6, brightness: 0.75 },
  mellow: { valence: 0.4, arousal: -0.4, dominance: -0.1, tension: 0.05, brightness: 0.35 },
  intense: { valence: 0.0, arousal: 0.9, dominance: 0.8, tension: 0.8, brightness: 0.55 },
  dreamy: { valence: 0.5, arousal: -0.5, dominance: -0.3, tension: 0.1, brightness: 0.5 },
  hard: { valence: -0.2, arousal: 0.85, dominance: 0.85, tension: 0.7, brightness: 0.45 },
  smooth: { valence: 0.5, arousal: -0.2, dominance: 0.2, tension: 0.05, brightness: 0.5 },
  gritty: { valence: -0.3, arousal: 0.5, dominance: 0.6, tension: 0.5, brightness: 0.3 },
  clean: { valence: 0.3, arousal: 0.1, dominance: 0.3, tension: 0.1, brightness: 0.7 },
  dirty: { valence: -0.2, arousal: 0.4, dominance: 0.5, tension: 0.4, brightness: 0.25 },
  nostalgic: { valence: 0.2, arousal: -0.3, dominance: -0.2, tension: 0.2, brightness: 0.35 },
  futuristic: { valence: 0.3, arousal: 0.4, dominance: 0.4, tension: 0.3, brightness: 0.7 },
  melancholic: { valence: -0.6, arousal: -0.3, dominance: -0.4, tension: 0.4, brightness: 0.25 },
  uplifting: { valence: 0.85, arousal: 0.7, dominance: 0.5, tension: 0.2, brightness: 0.8 },
  emotional: { valence: 0.0, arousal: 0.3, dominance: 0.0, tension: 0.5, brightness: 0.45 },
  powerful: { valence: 0.4, arousal: 0.85, dominance: 0.9, tension: 0.6, brightness: 0.6 },
  mysterious: { valence: 0.0, arousal: 0.1, dominance: 0.3, tension: 0.5, brightness: 0.3 },
  epic: { valence: 0.6, arousal: 0.9, dominance: 0.85, tension: 0.7, brightness: 0.65 },
  peaceful: { valence: 0.6, arousal: -0.7, dominance: -0.1, tension: 0.0, brightness: 0.5 },
  anxious: { valence: -0.5, arousal: 0.6, dominance: -0.3, tension: 0.9, brightness: 0.45 },
  hypnotic: { valence: 0.1, arousal: 0.2, dominance: 0.4, tension: 0.3, brightness: 0.4 },
  bouncy: { valence: 0.6, arousal: 0.7, dominance: 0.5, tension: 0.2, brightness: 0.65 },
  groovy: { valence: 0.6, arousal: 0.5, dominance: 0.5, tension: 0.15, brightness: 0.55 },
  spacey: { valence: 0.2, arousal: -0.3, dominance: 0.0, tension: 0.2, brightness: 0.5 },
  cinematic: { valence: 0.3, arousal: 0.6, dominance: 0.6, tension: 0.6, brightness: 0.5 },
  tribal: { valence: 0.3, arousal: 0.7, dominance: 0.6, tension: 0.4, brightness: 0.45 },
  minimal: { valence: 0.1, arousal: 0.0, dominance: 0.2, tension: 0.2, brightness: 0.5 },
  lush: { valence: 0.5, arousal: 0.1, dominance: 0.3, tension: 0.1, brightness: 0.55 },
  sparse: { valence: 0.0, arousal: -0.3, dominance: 0.1, tension: 0.2, brightness: 0.45 },
  dense: { valence: 0.1, arousal: 0.5, dominance: 0.5, tension: 0.5, brightness: 0.5 },
};

// Extended music theory knowledge
const SCALE_KNOWLEDGE: Record<string, {
  intervals: number[];
  mood: MoodVector;
  tension: number;
  brightness: number;
  ...
  major: {
    ...
    mood: { valence: 0.7, arousal: 0.3, dominance: 0.4, tension: 0.1, brightness: 0.7 },
    tension: 0.1,
    brightness: 0.7,
  ...
  minor: {
    ...
    mood: { valence: -0.4, arousal: 0.2, dominance: 0.3, tension: 0.3, brightness: 0.35 },
    tension: 0.3,
    brightness: 0.35,
  ...
  dorian: {
    ...
    mood: { valence: 0.1, arousal: 0.3, dominance: 0.4, tension: 0.2, brightness: 0.5 },
    tension: 0.2,
    brightness: 0.5,
  ...
  phrygian: {
    ...
    mood: { valence: -0.5, arousal: 0.4, dominance: 0.5, tension: 0.6, brightness: 0.25 },
    tension: 0.6,
    brightness: 0.25,
  ...
  lydian: {
    ...
    mood: { valence: 0.6, arousal: 0.2, dominance: 0.3, tension: 0.2, brightness: 0.8 },
    tension: 0.2,
    brightness: 0.8,
  ...
  mixolydian: {
    ...
    mood: { valence: 0.5, arousal: 0.4, dominance: 0.5, tension: 0.15, brightness: 0.6 },
    tension: 0.15,
    brightness: 0.6,
  ...
  harmonic_minor: {
    ...
    mood: { valence: -0.3, arousal: 0.5, dominance: 0.5, tension: 0.5, brightness: 0.4 },
    tension: 0.5,
    brightness: 0.4,
  ...
  melodic_minor: {
    ...
    mood: { valence: 0.0, arousal: 0.3, dominance: 0.4, tension: 0.35, brightness: 0.5 },
    tension: 0.35,
    brightness: 0.5,
  ...
  pentatonic_major: {
    intervals: [0, 2, 4, 7, 9],
    mood: { valence: 0.6, arousal: 0.3, dominance: 0.3, tension: 0.05, brightness: 0.65 },
    tension: 0.05,
    brightness: 0.65,
  ...
  pentatonic_minor: {
    ...
    mood: { valence: -0.2, arousal: 0.3, dominance: 0.4, tension: 0.1, brightness: 0.4 },
    tension: 0.1,
    brightness: 0.4,
  ...
  blues: {
    ...
    mood: { valence: -0.1, arousal: 0.4, dominance: 0.5, tension: 0.25, brightness: 0.4 },
    tension: 0.25,
    brightness: 0.4,
  ...
  chromatic: {
    ...
    mood: { valence: 0.0, arousal: 0.5, dominance: 0.5, tension: 0.7, brightness: 0.5 },
    tension: 0.7,
    brightness: 0.5,
  ...
  whole_tone: {
    ...
    mood: { valence: 0.2, arousal: 0.1, dominance: 0.2, tension: 0.4, brightness: 0.6 },
    tension: 0.4,
    brightness: 0.6,
...
class SemanticAnalyzer {
  ...
  private initializeEmbeddings(): void {
    ...
    const musicTerms = [
      'bass', '808', 'sub', 'kick', 'snare', 'hihat', 'clap', 'perc',
      'synth', 'lead', 'pad', 'pluck', 'arp', 'chord', 'melody',
      'piano', 'guitar', 'strings', 'brass', 'vocal', 'choir',
      'reverb', 'delay', 'distortion', 'compression', 'saturation',
      'filter', 'cutoff', 'resonance', 'envelope', 'attack', 'decay',
      'release', 'sustain', 'modulation', 'lfo', 'oscillator',
      'frequency', 'amplitude', 'phase', 'waveform', 'harmonic',
      'tempo', 'bpm', 'rhythm', 'groove', 'swing', 'shuffle',
      'beat', 'bar', 'measure', 'loop', 'pattern', 'sequence',
      'drop', 'build', 'breakdown', 'intro', 'outro', 'verse', 'chorus',
      'hook', 'bridge', 'fill', 'transition', 'riser', 'impact',
      'wide', 'narrow', 'stereo', 'mono', 'panning', 'spread',
      'high', 'low', 'mid', 'treble', 'bass', 'presence', 'air',
      'punchy', 'tight', 'loose', 'crisp', 'muddy', 'thin', 'fat',
      'rolling', 'triplet', 'straight', 'dotted', 'syncopated',
      'major', 'minor', 'sharp', 'flat', 'natural', 'octave',
    ];
  ...
  private extractDominantMood(tokens: string[], vectors: SemanticVector[]): MoodVector {
...
class MusicTheoryEngine {
  generateHarmonicContext(
    ...
    const chordProgression = this.generateChordProgression(key, scale, mood, genre);
...
class CreativeParameterSynthesizer {
  ...
  synthesizeFromText(text: string): CreativeParameters {
    ...
    const scaleResult = this.extractScale(text, analysis.dominantMood, genreResult.genre);
  ...
  private extractTempo(text: string, genre: string): { tempo: number; confidence: number } {
  ...
  private extractKey(text: string, genre: string): { key: string; confidence: number } {
    ...
    if (genreInfo?.typicalKeys.length) {
      const randomKey = genreInfo.typicalKeys[Math.floor(Math.random() * genreInfo.typicalKeys.length)];
  ...
  private extractScale(text: string, mood: MoodVector, genre: string): { scale: string; confidence: number } {
  ...
  private buildTimbreContext(
    ...
    return {
      brightness: (baseTimbre.brightness || 0.5) * (0.5 + mood.brightness * 0.5),
      ...
      attack: mood.arousal > 0 ? 0.3 - mood.arousal * 0.2 : 0.3 + Math.abs(mood.arousal) * 0.3,
  ...
  private buildProductionContext(mood: MoodVector, genre: string): ProductionContext {
    const genreInfo = GENRE_KNOWLEDGE[genre];
