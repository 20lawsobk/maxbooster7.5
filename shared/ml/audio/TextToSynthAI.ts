...
const INSTRUMENT_KEYWORDS: Record<InstrumentCategory, string[]> = {
  drums: [
    ...
    'acoustic kit', 'acoustic_kit', 'electronic kit', 'electronic_kit',
    '808 kit', '808_kit', '909 kit', '909_kit', 'trap kit', 'trap_kit',
    'jazz kit', 'jazz_kit', 'rock kit', 'rock_kit', 'metal kit', 'metal_kit',
    'lofi kit', 'lofi_kit', 'lo-fi kit', 'boombap kit', 'boombap_kit', 'boom bap kit',
    'drill kit', 'drill_kit', 'dnb kit', 'dnb_kit', 'd&b kit',
    'house kit', 'house_kit', 'techno kit', 'techno_kit',
    'uk garage kit', 'uk_garage_kit', 'indie kit', 'indie_kit',
    'vintage kit', 'vintage_kit', 'minimal kit', 'minimal_kit',
    'ambient kit', 'ambient_kit', 'world kit', 'world_kit',
  ],
  bass: [
    'bass', '808', 'sub', 'low', 'bottom', 'low-end', 'lowend',
    'bass electric', 'bass_electric', 'electric bass',
    'bass acoustic', 'bass_acoustic', 'acoustic bass', 'upright bass',
    'bass synth', 'bass_synth', 'synth bass',
    'bass 808', 'bass_808', '808 bass',
    'bass sub', 'bass_sub', 'sub bass',
    'bass guitar',
  ],
  synth: [
    'synth', 'synthesizer', 'lead', 'melody', 'melodic', 'hook',
    'synth lead', 'synth_lead', 'synth brass', 'synth_brass',
    'electric piano', 'electric_piano', 'organ',
    'vibraphone', 'marimba', 'xylophone', 'bells', 'kalimba', 'glockenspiel',
    'celesta', 'music box', 'music_box', 'harpsichord',
  ],
  pad: [
    'pad', 'ambient', 'atmosphere', 'atmospheric', 'texture', 'drone', 'sustained',
    'synth pad', 'synth_pad', 'strings ensemble', 'strings_ensemble', 'string ensemble',
    'vocal choir', 'vocal_choir', 'choir', 'vocal harmony', 'vocal_harmony',
    'vocal whisper', 'vocal_whisper', 'whisper',
  ],
  pluck: [
    'pluck', 'pizzicato', 'stab', 'stabs', 'key', 'keys', 'chord', 'chords',
    'piano', 'synth pluck', 'synth_pluck',
    'guitar', 'guitar acoustic', 'guitar_acoustic', 'acoustic guitar',
    'guitar electric', 'guitar_electric', 'electric guitar',
    'guitar nylon', 'guitar_nylon', 'nylon guitar', 'classical guitar',
    'guitar jazz', 'guitar_jazz', 'jazz guitar',
    'strings violin', 'strings_violin', 'violin',
    'strings viola', 'strings_viola', 'viola',
    'strings cello', 'strings_cello', 'cello',
    'strings', 'string',
    'brass trumpet', 'brass_trumpet', 'trumpet',
    'brass trombone', 'brass_trombone', 'trombone',
    'brass french horn', 'brass_french_horn', 'french horn',
    'brass tuba', 'brass_tuba', 'tuba',
    'brass', 'horn',
    'woodwind flute', 'woodwind_flute', 'flute',
    'woodwind clarinet', 'woodwind_clarinet', 'clarinet',
    'woodwind oboe', 'woodwind_oboe', 'oboe',
    'woodwind saxophone', 'woodwind_saxophone', 'saxophone', 'sax',
    'woodwind',
    'vocal lead', 'vocal_lead', 'vocals', 'vocal',
    'ethnic sitar', 'ethnic_sitar', 'sitar',
    'ethnic koto', 'ethnic_koto', 'koto',
    'ethnic erhu', 'ethnic_erhu', 'erhu',
    'ethnic oud', 'ethnic_oud', 'oud',
    'ethnic pan flute', 'ethnic_pan_flute', 'pan flute',
    'ethnic didgeridoo', 'ethnic_didgeridoo', 'didgeridoo',
    'ethnic balalaika', 'ethnic_balalaika', 'balalaika',
  ],
...
const PERCUSSION_KEYWORDS: string[] = [
  'percussion', 'perc',
  'congas', 'bongos', 'timbales', 'djembe', 'cajon',
  'tabla', 'shaker', 'tambourine', 'cowbell',
  'claves', 'guiro', 'cabasa', 'triangle', 'woodblock',
  'agogo', 'cuica', 'berimbau', 'pandeiro',
];
