...
// STUDIO TEMPLATES
// ============================================================================
export const studioTemplates = pgTable(
  "studio_templates",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdCategoryIdx: index("studio_templates_user_id_category_idx").on(
      t.userId,
      t.category,
    ),
...
export const insertStudioTemplateSchema = createInsertSchema(
  studioTemplates,
...
// STUDIO RECENT FILES
// ============================================================================
export const studioRecentFiles = pgTable(
  "studio_recent_files",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdAccessedAtIdx: index(
      "studio_recent_files_user_id_accessed_at_idx",
    ).on(t.userId, t.accessedAt),
  }),
);

export const insertStudioRecentFileSchema = createInsertSchema(
  studioRecentFiles,
).omit({ id: true, accessedAt: true });
export type InsertStudioRecentFile = z.infer<
  typeof insertStudioRecentFileSchema
>;
...
// ============================================================================
export const studioPinnedFolders = pgTable(
  "studio_pinned_folders",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export const insertStudioPinnedFolderSchema = createInsertSchema(
  studioPinnedFolders,
).omit({ id: true, createdAt: true });
export type InsertStudioPinnedFolder = z.infer<
  typeof insertStudioPinnedFolderSchema
>;
...
export const studioProjects = pgTable(
  ...
  (t) => ({
    userIdUpdatedAtIdx: index("studio_projects_user_id_updated_at_idx").on(
      t.userId,
      t.updatedAt,
    ),
    userIdStatusIdx: index("studio_projects_user_id_status_idx").on(
      t.userId,
      t.status,
    ),
  }),
...
export const insertStudioProjectSchema = createInsertSchema(
  studioProjects,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const campaigns = pgTable(
  ...
  (t) => ({
    userIdStatusIdx: index("campaigns_user_id_status_idx").on(
      t.userId,
      t.status,
    ),
    userIdCreatedAtIdx: index("campaigns_user_id_created_at_idx").on(
      t.userId,
      t.createdAt,
    ),
  }),
...
export const socialCampaigns = pgTable(
  ...
  (t) => ({
    userIdStatusIdx: index("social_campaigns_user_id_status_idx").on(
      t.userId,
      t.status,
    ),
    userIdScheduledAtIdx: index("social_campaigns_user_id_scheduled_at_idx").on(
      t.userId,
      t.scheduledAt,
    ),
  }),
...
export const insertSocialCampaignSchema = createInsertSchema(
  socialCampaigns,
).omit({ id: true, createdAt: true });
...
export const storefronts = pgTable(
  ...
  (t) => ({
    ...
    isActiveIsPublicIdx: index("storefronts_is_active_is_public_idx").on(
      t.isActive,
      t.isPublic,
    ),
  }),
...
// ============================================================================
export const dnsRecordCache = pgTable(
  "dns_record_cache",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    storefrontIdDomainIdx: index(
      "dns_record_cache_storefront_id_domain_idx",
    ).on(t.storefrontId, t.domain),
    domainRecordTypeIdx: index("dns_record_cache_domain_record_type_idx").on(
      t.domain,
      t.recordType,
    ),
  }),
...
export const insertDnsRecordCacheSchema = createInsertSchema(
  dnsRecordCache,
).omit({
  id: true,
  createdAt: true,
...
export const storefrontDomains = pgTable(
  ...
  (t) => ({
    storefrontIdStatusIdx: index(
      "storefront_domains_storefront_id_status_idx",
    ).on(t.storefrontId, t.status),
    storefrontIdIsPrimaryIdx: index(
      "storefront_domains_storefront_id_is_primary_idx",
    ).on(t.storefrontId, t.isPrimary),
  }),
);

export const insertStorefrontDomainSchema = createInsertSchema(
  storefrontDomains,
).omit({
  id: true,
  createdAt: true,
...
export type InsertStorefrontDomain = z.infer<
  typeof insertStorefrontDomainSchema
>;
...
export const storefrontHosts = pgTable("storefront_hosts", {
  ...
  certProvisionAttempts: integer("cert_provision_attempts")
    .notNull()
    .default(0),
...
export const insertStorefrontHostSchema = createInsertSchema(
  storefrontHosts,
).omit({
  createdAt: true,
  updatedAt: true,
...
// ============================================================================
export const dnsTemplates = pgTable(
  "dns_templates",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdIsGlobalIdx: index("dns_templates_user_id_is_global_idx").on(
      t.userId,
      t.isGlobal,
    ),
  }),
...
// ============================================================================
export const dnsProviderCredentials = pgTable(
  ...
  (t) => ({
    userIdProviderIdx: index("dns_provider_creds_user_id_provider_idx").on(
      t.userId,
      t.provider,
    ),
  }),
...
export const insertDnsProviderCredentialsSchema = createInsertSchema(
...
export type InsertDnsProviderCredentials = z.infer<
  typeof insertDnsProviderCredentialsSchema
>;
...
export const dnsZones = pgTable(
  "dns_zones",
  {
    ...
    isVerified: boolean("is_verified").default(false),
    nameserver1: text("nameserver1").default("ns1.max-booster.com"),
    nameserver2: text("nameserver2").default("ns2.max-booster.com"),
    notes: text("notes"),
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
  },
  (t) => ({
    userIdStatusIdx: index("dns_zones_user_id_status_idx").on(
      t.userId,
      t.status,
    ),
...
// ============================================================================
export const dnsZoneRecords = pgTable(
  "dns_zone_records",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    zoneIdTypeIdx: index("dns_zone_records_zone_id_type_idx").on(
      t.zoneId,
      t.type,
    ),
    userIdIdx: index("dns_zone_records_user_id_idx").on(t.userId),
    domainTypeIdx: index("dns_zone_records_domain_type_idx").on(
      t.domain,
      t.type,
    ),
  }),
...
export const insertDnsZoneRecordSchema = createInsertSchema(
  dnsZoneRecords,
).omit({
  id: true,
  createdAt: true,
...
export const membershipTiers = pgTable(
  ...
  (t) => ({
    storefrontIdIsActiveIdx: index(
      "membership_tiers_storefront_id_is_active_idx",
    ).on(t.storefrontId, t.isActive),
  }),
);
...
export const beats = pgTable(
  ...
  (t) => ({
    userIdIsPublishedIdx: index("beats_user_id_is_published_idx").on(
      t.userId,
      t.isPublished,
    ),
    isPublishedCreatedAtIdx: index("beats_is_published_created_at_idx").on(
      t.isPublished,
      t.createdAt,
    ),
    genreIsPublishedIdx: index("beats_genre_is_published_idx").on(
      t.genre,
      t.isPublished,
    ),
  }),
...
export const beatMoneyLoopCycles = pgTable(
  "beat_money_loop_cycles",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    statusStartedAtIdx: index("bml_cycles_status_started_at_idx").on(
      t.status,
      t.startedAt,
    ),
...
// HYPERFOLLOW PAGES
// ============================================================================
export const hyperFollowPages = pgTable(
  "hyperfollow_pages",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdCreatedAtIdx: index("hyperfollow_pages_user_id_created_at_idx").on(
      t.userId,
      t.createdAt,
    ),
  }),
...
// ============================================================================
export const distroReleases = pgTable(
  "distro_releases",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    artistIdStatusIdx: index("distro_releases_artist_id_status_idx").on(
      t.artistId,
      t.status,
    ),
    artistIdCreatedAtIdx: index("distro_releases_artist_id_created_at_idx").on(
      t.artistId,
      t.createdAt,
    ),
  }),
...
// DISTRIBUTION TRACKS
// ============================================================================
export const distroTracks = pgTable(
  "distro_tracks",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    releaseIdTrackNumberIdx: index(
      "distro_tracks_release_id_track_number_idx",
    ).on(t.releaseId, t.trackNumber),
  }),
);
...
export const customerMemberships = pgTable(
  ...
  (t) => ({
    customerIdStorefrontIdIdx: index(
      "customer_memberships_customer_id_storefront_id_idx",
    ).on(t.customerId, t.storefrontId),
    storefrontIdStatusIdx: index(
      "customer_memberships_storefront_id_status_idx",
    ).on(t.storefrontId, t.status),
    customerIdStatusIdx: index(
      "customer_memberships_customer_id_status_idx",
    ).on(t.customerId, t.status),
  }),
);

export const insertCustomerMembershipSchema = createInsertSchema(
  customerMemberships,
).pick({
  customerId: true,
  tierId: true,
...
// ============================================================================
export const statusPageIncidentServices = pgTable(
  "status_page_incident_services",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
// DMCA STRIKES
// ============================================================================
export const dmcaStrikes = pgTable(
  "dmca_strikes",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdCreatedAtIdx: index("dmca_strikes_user_id_created_at_idx").on(
      t.userId,
      t.createdAt,
    ),
    contentIdContentTypeIdx: index(
      "dmca_strikes_content_id_content_type_idx",
    ).on(t.contentId, t.contentType),
  }),
);
...
export const listings = pgTable(
  ...
  (t) => ({
    userIdStorefrontIdIdx: index("listings_user_id_storefront_id_idx").on(
      t.userId,
      t.storefrontId,
    ),
    storefrontIdIsPublishedIdx: index(
      "listings_storefront_id_is_published_idx",
    ).on(t.storefrontId, t.isPublished),
    isPublishedCategoryIdx: index("listings_is_published_category_idx").on(
      t.isPublished,
      t.category,
    ),
    userIdIsPublishedIdx: index("listings_user_id_is_published_idx").on(
      t.userId,
      t.isPublished,
    ),
  }),
...
// ============================================================================
export const listingLicenseTiers = pgTable(
  "listing_license_tiers",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    listingIdIsActiveIdx: index(
      "listing_license_tiers_listing_id_is_active_idx",
    ).on(t.listingId, t.isActive),
  }),
);
...
// ============================================================================
export const storefrontFollows = pgTable(
  "storefront_follows",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdStorefrontIdIdx: index(
      "storefront_follows_user_id_storefront_id_idx",
    ).on(t.userId, t.storefrontId),
    storefrontIdIdx: index("storefront_follows_storefront_id_idx").on(
      t.storefrontId,
    ),
  }),
);

export const storefrontLikes = pgTable(
  "storefront_likes",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdStorefrontIdIdx: index(
      "storefront_likes_user_id_storefront_id_idx",
    ).on(t.userId, t.storefrontId),
    storefrontIdIdx: index("storefront_likes_storefront_id_idx").on(
      t.storefrontId,
    ),
  }),
);

export const storefrontRatings = pgTable(
  "storefront_ratings",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdStorefrontIdIdx: index(
      "storefront_ratings_user_id_storefront_id_idx",
    ).on(t.userId, t.storefrontId),
    storefrontIdIdx: index("storefront_ratings_storefront_id_idx").on(
      t.storefrontId,
    ),
  }),
);
...
// ============================================================================
export const beatLikes = pgTable(
  "beat_likes",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdBeatIdIdx: index("beat_likes_user_id_beat_id_idx").on(
      t.userId,
      t.beatId,
    ),
...
export const licenseTemplates = pgTable(
  ...
  (t) => ({
    userIdIsActiveIdx: index("license_templates_user_id_is_active_idx").on(
      t.userId,
      t.isActive,
    ),
    userIdTypeIdx: index("license_templates_user_id_type_idx").on(
      t.userId,
      t.type,
    ),
  }),
...
export const storefrontOrders = pgTable(
  ...
  (t) => ({
    buyerIdStatusIdx: index("storefront_orders_buyer_id_status_idx").on(
      t.buyerId,
      t.status,
    ),
    storefrontIdStatusCreatedAtIdx: index(
      "storefront_orders_storefront_id_status_created_at_idx",
    ).on(t.storefrontId, t.status, t.createdAt),
    sellerIdStatusIdx: index("storefront_orders_seller_id_status_idx").on(
      t.sellerId,
      t.status,
    ),
    listingIdIdx: index("storefront_orders_listing_id_idx").on(t.listingId),
    stripeSessionIdIdx: index("storefront_orders_stripe_session_id_idx").on(
      t.stripeSessionId,
    ),
  }),
);
...
export const contractTemplates = pgTable(
  ...
  (t) => ({
    userIdCategoryIdx: index("contract_templates_user_id_category_idx").on(
      t.userId,
      t.category,
    ),
  }),
...
export const generatedContracts = pgTable(
  ...
  (t) => ({
    userIdStatusCreatedAtIdx: index(
      "generated_contracts_user_id_status_created_at_idx",
    ).on(t.userId, t.status, t.createdAt),
    userIdTypeIdx: index("generated_contracts_user_id_type_idx").on(
      t.userId,
      t.type,
    ),
  }),
...
export const marketplaceDisputes = pgTable(
  ...
  (t) => ({
    ...
    buyerIdStatusIdx: index("marketplace_disputes_buyer_id_status_idx").on(
      t.buyerId,
      t.status,
    ),
    sellerIdStatusIdx: index("marketplace_disputes_seller_id_status_idx").on(
      t.sellerId,
      t.status,
    ),
  }),
...
export const legalHolds = pgTable(
  ...
  (t) => ({
    userIdStatusIdx: index("legal_holds_user_id_status_idx").on(
      t.userId,
      t.status,
    ),
    contentIdContentTypeIdx: index(
      "legal_holds_content_id_content_type_idx",
    ).on(t.contentId, t.contentType),
  }),
);
...
// ============================================================================
export const statusPageUptimeMetrics = pgTable(
  "status_page_uptime_metrics",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    serviceIdDateIdx: index(
      "status_page_uptime_metrics_service_id_date_idx",
    ).on(t.serviceId, t.date),
  }),
);
...
export const catalogImportJobs = pgTable(
  ...
  (t) => ({
    artistIdStatusIdx: index("catalog_import_jobs_artist_id_status_idx").on(
      t.artistId,
      t.status,
    ),
  }),
...
export const catalogImportRows = pgTable(
  ...
  (t) => ({
    jobIdStatusIdx: index("catalog_import_rows_job_id_status_idx").on(
      t.jobId,
      t.status,
    ),
  }),
...
// ============================================================================
export const releaseWorkflowRequests = pgTable(
  "release_workflow_requests",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    releaseIdStatusIdx: index(
      "release_workflow_requests_release_id_status_idx",
    ).on(t.releaseId, t.status),
    requestedByStatusIdx: index(
      "release_workflow_requests_requested_by_status_idx",
    ).on(t.requestedBy, t.status),
  }),
);
...
// ============================================================================
export const releaseVersionHistory = pgTable(
  ...
  (t) => ({
    releaseIdVersionIdx: index(
      "release_version_history_release_id_version_idx",
    ).on(t.releaseId, t.version),
  }),
);
...
// ============================================================================
export const releaseScheduledActions = pgTable(
  "release_scheduled_actions",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    releaseIdStatusIdx: index(
      "release_scheduled_actions_release_id_status_idx",
    ).on(t.releaseId, t.status),
    statusScheduledForIdx: index(
      "release_scheduled_actions_status_scheduled_for_idx",
...
// ============================================================================
export const preSaveCampaigns = pgTable(
  "pre_save_campaigns",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    userIdStatusIdx: index("pre_save_campaigns_user_id_status_idx").on(
      t.userId,
      t.status,
    ),
...
export const insertPreSaveCampaignSchema = createInsertSchema(
  preSaveCampaigns,
).omit({ id: true, createdAt: true, updatedAt: true });
...
// ============================================================================
export const preSaveEntries = pgTable(
  "pre_save_entries",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    campaignIdPlatformIdx: index(
      "pre_save_entries_campaign_id_platform_idx",
    ).on(t.campaignId, t.platform),
    campaignIdCreatedAtIdx: index(
      "pre_save_entries_campaign_id_created_at_idx",
    ).on(t.campaignId, t.createdAt),
  }),
);

export const insertPreSaveEntrySchema = createInsertSchema(preSaveEntries).omit(
...
// ============================================================================
export const distributionSLAMetrics = pgTable(
  "distribution_sla_metrics",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    releaseIdPlatformIdx: index(
      "distribution_sla_metrics_release_id_platform_idx",
    ).on(t.releaseId, t.platform),
    statusDeliveryPhaseIdx: index(
      "distribution_sla_metrics_status_delivery_phase_idx",
    ).on(t.status, t.deliveryPhase),
  }),
);

export const insertDistributionSLAMetricSchema = createInsertSchema(
  distributionSLAMetrics,
).omit({ id: true, createdAt: true, updatedAt: true });
export type DistributionSLAMetric = typeof distributionSLAMetrics.$inferSelect;
export type InsertDistributionSLAMetric =
  typeof distributionSLAMetrics.$inferInsert;

// ============================================================================
// CONTENT ID REGISTRATIONS (YouTube monetization)
// ============================================================================
export const contentIdRegistrations = pgTable(
  "content_id_registrations",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    releaseIdTrackIdIdx: index(
      "content_id_registrations_release_id_track_id_idx",
    ).on(t.releaseId, t.trackId),
    userIdStatusIdx: index("content_id_registrations_user_id_status_idx").on(
      t.userId,
      t.status,
    ),
  }),
...
export const insertContentIdRegistrationSchema = createInsertSchema(
  contentIdRegistrations,
).omit({ id: true, createdAt: true, updatedAt: true });
export type ContentIdRegistration = typeof contentIdRegistrations.$inferSelect;
export type InsertContentIdRegistration =
  typeof contentIdRegistrations.$inferInsert;
...
export const insertSyncLicenseSchema = createInsertSchema(syncLicenses).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
// ============================================================================
export const syncLicenseInquiries = pgTable(
  "sync_license_inquiries",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    bySyncLicense: index("sync_license_inquiries_license_idx").on(
      t.syncLicenseId,
      t.createdAt,
    ),
...
export const insertSyncLicenseInquirySchema = createInsertSchema(
  syncLicenseInquiries,
).omit({ id: true, createdAt: true });
...
// ============================================================================
export const royaltySplits = pgTable(
  "royalty_splits",
  {
    id: varchar("id")
      .primaryKey()
...
// ============================================================================
export const royaltyTransactions = pgTable(
  ...
  (table) => ({
    ...
    createdAtIdx: index("royalty_transactions_created_at_idx").on(
      table.createdAt,
    ),
...
export const insertRoyaltyTransactionSchema = createInsertSchema(
  royaltyTransactions,
).omit({ id: true, createdAt: true });
...
export const ledgerEntries = pgTable(
  ...
  (t) => ({
    ...
    byReference: index("ledger_entries_reference_idx").on(
      t.referenceType,
      t.referenceId,
    ),
  }),
...
export const taxForms = pgTable(
  "tax_forms",
  {
    ...
    totalEarningsCents: bigint("total_earnings_cents", {
      mode: "number",
    }).default(0),
    status: text("status").default("pending"),
...
// ROYALTY DISPUTES
// ============================================================================
export const royaltyDisputes = pgTable(
  "royalty_disputes",
  {
    id: varchar("id")
      .primaryKey()
...
export const splitPayments = pgTable(
  ...
  (t) => ({
    ...
    byCollaborator: index("split_payments_collaborator_idx").on(
      t.collaboratorId,
      t.status,
    ),
  }),
...
export const notifications = pgTable(
  ...
  (t) => ({
    byUserCreated: index("notifications_user_created_idx").on(
      t.userId,
      t.createdAt,
    ),
...
export const supportTickets = pgTable(
  ...
  (t) => ({
    ...
    byAssigned: index("support_tickets_assigned_idx").on(
      t.assignedTo,
      t.status,
    ),
  }),
...
export const securityThreats = pgTable(
  ...
  (t) => ({
    bySourceIp: index("security_threats_source_ip_idx").on(
      t.sourceIp,
      t.detectedAt,
    ),
    bySeverityStatus: index("security_threats_severity_status_idx").on(
      t.severity,
      t.status,
    ),
...
export const insertSecurityThreatSchema = createInsertSchema(
  securityThreats,
).omit({ id: true, createdAt: true });
...
export const workspaceAuditLog = pgTable(
  ...
  (t) => ({
    byWorkspace: index("workspace_audit_log_workspace_idx").on(
      t.workspaceId,
      t.createdAt,
    ),
    byUser: index("workspace_audit_log_user_idx").on(t.userId, t.createdAt),
    byResource: index("workspace_audit_log_resource_idx").on(
      t.resourceType,
      t.resourceId,
    ),
  }),
...
export const insertWorkspaceAuditLogSchema = createInsertSchema(
  workspaceAuditLog,
).omit({ id: true, createdAt: true });
export type InsertWorkspaceAuditLog = z.infer<
  typeof insertWorkspaceAuditLogSchema
>;
...
// DSP ANALYTICS
// ============================================================================
export const dspAnalytics = pgTable(
  "dsp_analytics",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => ({
    byRelease: index("dsp_analytics_release_platform_date_idx").on(
      t.releaseId,
      t.platform,
      t.date,
    ),
...
export type StatusPageIncidentService =
  typeof statusPageIncidentServices.$inferSelect;
...
export type StatusPageIncidentUpdate =
  typeof statusPageIncidentUpdates.$inferSelect;
...
export type StatusPageUptimeMetric =
  typeof statusPageUptimeMetrics.$inferSelect;
...
export type ReleaseWorkflowRequest =
  typeof releaseWorkflowRequests.$inferSelect;
export type ReleaseVersionHistory = typeof releaseVersionHistory.$inferSelect;
export type ReleaseScheduledAction =
  typeof releaseScheduledActions.$inferSelect;
...
export const orders = pgTable(
  ...
  (t) => ({
    ...
    byStripeIntent: index("orders_stripe_intent_idx").on(
...
export const insertWarpMarkerSchema = createInsertSchema(warpMarkers).omit({
  id: true,
  createdAt: true,
});
...
export const insertWorkspaceCatalogSchema = createInsertSchema(
  workspaceCatalogs,
).omit({ id: true, createdAt: true });
export type InsertWorkspaceCatalog = z.infer<
  typeof insertWorkspaceCatalogSchema
>;
...
// ============================================================================
export const dspUserPlatformStatus = pgTable(
  "dsp_user_platform_status",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    userPlatformIdx: index("dsp_user_platform_status_user_platform_idx").on(
      t.userId,
      t.platform,
    ),
  }),
...
export type InsertDspUserPlatformStatus =
  typeof dspUserPlatformStatus.$inferInsert;
...
export const insertWorkspaceInvitationSchema = createInsertSchema(
...
export const insertPlaylistAttributionSchema = createInsertSchema(
  playlistAttributions,
).omit({ id: true, createdAt: true });
export type InsertPlaylistAttribution = z.infer<
  typeof insertPlaylistAttributionSchema
>;
...
export const contentCalendar = pgTable(
  ...
  (t) => [
    ...
    index("content_calendar_user_id_scheduled_at_idx").on(
      t.userId,
      t.scheduledAt,
    ),
...
export const insertContentCalendarSchema = createInsertSchema(
  contentCalendar,
).omit({ id: true, createdAt: true });
...
export const insertUserBrandVoiceSchema = createInsertSchema(
  userBrandVoices,
).omit({ id: true, createdAt: true });
...
export const insertHashtagResearchSchema = createInsertSchema(
  hashtagResearch,
).omit({ id: true, createdAt: true });
...
export const insertExplanationLogSchema = createInsertSchema(
  explanationLogs,
).omit({ id: true, createdAt: true });
...
export const insertBestPostingTimeSchema = createInsertSchema(
  bestPostingTimes,
).omit({ id: true, createdAt: true });
...
export const insertAiModelVersionSchema = createInsertSchema(
  aiModelVersions,
).omit({ id: true, createdAt: true });
...
export const insertUserTasteProfileSchema = createInsertSchema(
  userTasteProfiles,
).omit({ id: true, createdAt: true });
...
export const insertBeatInteractionSchema = createInsertSchema(
  beatInteractions,
).omit({ id: true, createdAt: true });
...
export const insertUserStorageFileSchema = createInsertSchema(
  userStorageFiles,
).omit({ id: true, createdAt: true });
...
export const insertPlaylistJourneySchema = createInsertSchema(
  playlistJourneys,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertSyncPlacementSchema = createInsertSchema(
  syncPlacements,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertHistoricalAnalyticSchema = createInsertSchema(
  historicalAnalytics,
).omit({ id: true, createdAt: true });
...
export const insertArDiscoverySchema = createInsertSchema(arDiscoveries).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertPlatformDataSourceSchema = createInsertSchema(
  platformDataSources,
).omit({ id: true, createdAt: true });
...
export const insertGlobalRankingSchema = createInsertSchema(
  globalRankings,
).omit({ id: true, createdAt: true });
...
export const insertNlpQueryLogSchema = createInsertSchema(nlpQueryLogs).omit({
  id: true,
  createdAt: true,
});
...
export const insertPreSavePageSchema = createInsertSchema(preSavePages).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertPromoCardSchema = createInsertSchema(promoCards).omit({
  id: true,
  createdAt: true,
});
...
export const insertMiniVideoSchema = createInsertSchema(miniVideos).omit({
  id: true,
  createdAt: true,
});
...
export const insertSpotifyCanvasSchema = createInsertSchema(
  spotifyCanvases,
).omit({ id: true, createdAt: true });
...
export const insertLyricsSyncSchema = createInsertSchema(lyricsSyncs).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertArtistScoreSchema = createInsertSchema(artistScores).omit({
  id: true,
  createdAt: true,
});
...
// ============================================================================
export const marketplaceRecommendations = pgTable(
...
export type MarketplaceRecommendation =
  typeof marketplaceRecommendations.$inferSelect;
export const insertMarketplaceRecommendationSchema = createInsertSchema(
  marketplaceRecommendations,
).omit({ id: true, createdAt: true });
export type InsertMarketplaceRecommendation =
  typeof marketplaceRecommendations.$inferInsert;
...
export const insertBeatPromotionSchema = createInsertSchema(
  beatPromotions,
).omit({ id: true, createdAt: true });
...
export const bogoPromotions = pgTable("bogo_promotions", {
  ...
  applicableListingIds: jsonb("applicable_listing_ids")
    .$type<string[]>()
    .default([]),
...
export const insertBogoPromotionSchema = createInsertSchema(
  bogoPromotions,
).omit({ id: true, createdAt: true, updatedAt: true, redemptionCount: true });
...
export const insertSocialAutopilotContentSchema = createInsertSchema(
  socialAutopilotContent,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertSocialAutopilotContent = z.infer<
  typeof insertSocialAutopilotContentSchema
>;
...
export const insertFanSegmentSchema = createInsertSchema(fanSegments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertMusicImpactMetricSchema = createInsertSchema(
  musicImpactMetrics,
).omit({ id: true, createdAt: true });
export type InsertMusicImpactMetric = z.infer<
  typeof insertMusicImpactMetricSchema
>;
...
export type SocialPatternAggregate =
  typeof socialPatternAggregates.$inferSelect;
export const insertSocialPatternAggregateSchema = createInsertSchema(
...
export const insertOrganicAssetSchema = createInsertSchema(organicAssets).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertOrganicChannelSchema = createInsertSchema(
  organicChannels,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertOrganicRoiSnapshotSchema = createInsertSchema(
  organicRoiSnapshots,
).omit({ id: true, createdAt: true });
export type InsertOrganicRoiSnapshot = z.infer<
  typeof insertOrganicRoiSnapshotSchema
>;
...
export type OrganicAssetLifetimeRecord =
  typeof organicAssetLifetime.$inferSelect;
export const insertOrganicAssetLifetimeSchema = createInsertSchema(
  organicAssetLifetime,
).omit({ id: true, createdAt: true });
export type InsertOrganicAssetLifetime = z.infer<
  typeof insertOrganicAssetLifetimeSchema
>;
...
export const insertAutopilotCrossInsightSchema = createInsertSchema(
  autopilotCrossInsights,
).omit({ id: true, createdAt: true });
export type InsertAutopilotCrossInsight = z.infer<
  typeof insertAutopilotCrossInsightSchema
>;
...
export const insertSocialMentionSchema = createInsertSchema(
  socialMentions,
).omit({ id: true, createdAt: true });
...
export const insertSocialKeywordSchema = createInsertSchema(
  socialKeywords,
).omit({ id: true, createdAt: true });
...
export const insertCompetitorProfileSchema = createInsertSchema(
  competitorProfiles,
).omit({ id: true, createdAt: true });
export type InsertCompetitorProfile = z.infer<
  typeof insertCompetitorProfileSchema
>;
...
export const insertSocialInboxMessageSchema = createInsertSchema(
  socialInboxMessages,
).omit({ id: true, createdAt: true });
...
export type ArtistProgressSnapshot =
  typeof artistProgressSnapshots.$inferSelect;
export const insertArtistProgressSnapshotSchema = createInsertSchema(
  artistProgressSnapshots,
).omit({ id: true, createdAt: true });
export type InsertArtistProgressSnapshot = z.infer<
  typeof insertArtistProgressSnapshotSchema
>;
...
// ============================================================================
export const careerCoachRecommendations = pgTable(
...
export type CareerCoachRecommendation =
  typeof careerCoachRecommendations.$inferSelect;
export const insertCareerCoachRecommendationSchema = createInsertSchema(
  careerCoachRecommendations,
).omit({ id: true, createdAt: true });
export type InsertCareerCoachRecommendation = z.infer<
  typeof insertCareerCoachRecommendationSchema
>;
...
export const insertEmailPreferenceSchema = createInsertSchema(
  emailPreferences,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertArtistConnectionSchema = createInsertSchema(
  artistConnections,
).omit({ id: true, createdAt: true });
export type InsertArtistConnection = z.infer<
  typeof insertArtistConnectionSchema
>;
...
export const insertCollaborationProjectSchema = createInsertSchema(
  collaborationProjects,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertCollaborationProject = z.infer<
  typeof insertCollaborationProjectSchema
>;
...
export const insertCollabSnapshotSchema = createInsertSchema(
  collabSnapshots,
).omit({ id: true, createdAt: true });
...
export const insertReleaseCountdownSchema = createInsertSchema(
  releaseCountdowns,
).omit({ id: true, createdAt: true });
export type InsertReleaseCountdown = z.infer<
  typeof insertReleaseCountdownSchema
>;
...
export const insertCountdownTaskSchema = createInsertSchema(
  countdownTasks,
).omit({ id: true, createdAt: true });
...
export const insertCountdownAnalyticSchema = createInsertSchema(
  countdownAnalytics,
).omit({ id: true, createdAt: true });
export type InsertCountdownAnalytic = z.infer<
  typeof insertCountdownAnalyticSchema
>;
...
export const insertAutopilotLearningDataSchema = createInsertSchema(
  autopilotLearningData,
).omit({ id: true, createdAt: true });
export type InsertAutopilotLearningData = z.infer<
  typeof insertAutopilotLearningDataSchema
>;
...
export const insertAutopilotInsightSchema = createInsertSchema(
  autopilotInsights,
).omit({ id: true, createdAt: true, generatedAt: true });
export type InsertAutopilotInsight = z.infer<
  typeof insertAutopilotInsightSchema
>;
...
export const insertAutopilotPreferenceSchema = createInsertSchema(
  autopilotPreferences,
).omit({ id: true, createdAt: true, lastUpdated: true });
export type InsertAutopilotPreference = z.infer<
  typeof insertAutopilotPreferenceSchema
>;
...
export const insertSplitSheetSchema = createInsertSchema(splitSheets).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertBatchTemplateSchema = createInsertSchema(
  batchTemplates,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertCollaborationCommentSchema = createInsertSchema(
  collaborationComments,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertCollaborationComment = z.infer<
  typeof insertCollaborationCommentSchema
>;
...
export const insertCollaborationVersionSchema = createInsertSchema(
  collaborationVersions,
).omit({ id: true, createdAt: true });
export type InsertCollaborationVersion = z.infer<
  typeof insertCollaborationVersionSchema
>;

// ============================================================================
// COLLABORATION ACCESS REQUESTS (project access permission requests)
// ============================================================================
export const collaborationAccessRequests = pgTable(
...
export type CollaborationAccessRequest =
  typeof collaborationAccessRequests.$inferSelect;
export const insertCollaborationAccessRequestSchema = createInsertSchema(
  collaborationAccessRequests,
).omit({ id: true, createdAt: true });
export type InsertCollaborationAccessRequest = z.infer<
  typeof insertCollaborationAccessRequestSchema
>;
...
export type MusicWorkflowAutomation =
  typeof musicWorkflowAutomations.$inferSelect;
export type InsertMusicWorkflowAutomation =
  typeof musicWorkflowAutomations.$inferInsert;

export const musicWorkflowExecutionLogs = pgTable(
  "music_workflow_execution_logs",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export type MusicWorkflowExecutionLog =
  typeof musicWorkflowExecutionLogs.$inferSelect;
...
export const artistProfiles = pgTable("artist_profiles", {
  ...
  verifiedAt: timestamp("verified_at"),
  verifiedPlatforms: jsonb("verified_platforms")
    .$type<string[]>()
    .default(sql`'[]'::jsonb`),
  ...
  fixerTargetPlatformIds: jsonb("fixer_target_platform_ids")
    .$type<Record<string, string>>()
    .default(sql`'{}'::jsonb`),
  fixerTargetPlatforms: jsonb("fixer_target_platforms")
    .$type<string[]>()
    .default(sql`'[]'::jsonb`),
...
export const insertArtistProfileSchema = createInsertSchema(
  artistProfiles,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const artistDnaSnapshots = pgTable("artist_dna_snapshots", {
  ...
  snapshotJson: jsonb("snapshot_json")
    .$type<Record<string, unknown>>()
    .notNull(),
  platformIdsAtSnapshot: jsonb("platform_ids_at_snapshot")
    .$type<Record<string, string>>()
    .default(sql`'{}'::jsonb`),
  isrcList: jsonb("isrc_list")
    .$type<string[]>()
    .default(sql`'[]'::jsonb`),
...
export const profileSplitEvents = pgTable("profile_split_events", {
  ...
  releaseTitle: text("release_title"),
  affectedIsrcs: jsonb("affected_isrcs")
    .$type<string[]>()
    .default(sql`'[]'::jsonb`),
...
// ============================================================================
export const distributorHistoryImports = pgTable(
  "distributor_history_imports",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
    ...
    isrcList: jsonb("isrc_list")
      .$type<string[]>()
      .default(sql`'[]'::jsonb`),
    upcList: jsonb("upc_list")
      .$type<string[]>()
      .default(sql`'[]'::jsonb`),
    status: varchar("status", { length: 50 }).default("pending"),
    discoveredPlatforms: jsonb("discovered_platforms")
      .$type<Record<string, string>>()
      .default(sql`'{}'::jsonb`),
...
export type DistributorHistoryImport =
  typeof distributorHistoryImports.$inferSelect;

// ============================================================================
// INSERT SCHEMAS FOR NEW TABLES (must be at end after all tables defined)
// ============================================================================
export const insertTakeGroupSchema = createInsertSchema(takeGroups).omit({
  id: true,
  createdAt: true,
});
...
export const insertTakeLaneSchema = createInsertSchema(takeLanes).omit({
  id: true,
  createdAt: true,
});
...
export const insertListenerCohortSchema = createInsertSchema(
  listenerCohorts,
).omit({ id: true, createdAt: true });
export const insertSocialAccountSchema = createInsertSchema(
  socialAccounts,
).omit({ id: true, createdAt: true });
export const insertTakeSegmentSchema = createInsertSchema(takeSegments).omit({
  id: true,
  createdAt: true,
});
export const insertWorkspaceRoleSchema = createInsertSchema(
  workspaceRoles,
).omit({ id: true, createdAt: true });
export const insertRevenueForecastSchema = createInsertSchema(
  revenueForecasts,
).omit({ id: true, createdAt: true });
...
export const insertApprovalWorkflowSchema = createInsertSchema(
  approvalWorkflows,
).omit({ id: true, createdAt: true });
...
export const fabricVolumes = pgTable("fabric_volumes", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  pocketId: varchar("pocket_id")
    .notNull()
    .references(() => fabricPockets.id, { onDelete: "cascade" }),
  name: varchar("name", { length: 255 }).notNull(),
...
export const fabricStorageNodes = pgTable("fabric_storage_nodes", {
  ...
  backendConfig: jsonb("backend_config")
    .notNull()
    .default(sql`'{}'`),
...
export const fabricObjects = pgTable("fabric_objects", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  volumeId: varchar("volume_id")
    .notNull()
    .references(() => fabricVolumes.id, { onDelete: "cascade" }),
...
export const insertFabricPocketSchema = createInsertSchema(fabricPockets).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
export const insertFabricVolumeSchema = createInsertSchema(fabricVolumes).omit({
  id: true,
  createdAt: true,
});
export const insertFabricStorageNodeSchema = createInsertSchema(
  fabricStorageNodes,
).omit({ id: true, lastHeartbeat: true });
export const insertFabricObjectSchema = createInsertSchema(fabricObjects).omit({
  id: true,
  createdAt: true,
});
export const insertFabricChunkSchema = createInsertSchema(fabricChunks).omit({
  createdAt: true,
});
...
export const customerHealthScores = pgTable(
  ...
  (t) => [
    ...
    index("customer_health_scores_days_since_last_login_idx").on(
      t.daysSinceLastLogin,
    ),
    index("customer_health_scores_re_engagement_sent_idx").on(
      t.reEngagementEmailSentAt,
    ),
  ],
);

export const insertCustomerHealthScoreSchema = createInsertSchema(
...
export const insertCancellationFeedbackSchema = createInsertSchema(
...
export const insertFeatureEventSchema = createInsertSchema(featureEvents).omit({
  id: true,
  createdAt: true,
});
export type FeatureEvent = typeof featureEvents.$inferSelect;

export const dunningState = pgTable(
  "dunning_state",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => [
    ...
    index("dunning_state_resolved_at_partial_idx")
      .on(t.resolvedAt)
...
export const insertDunningStateSchema = createInsertSchema(dunningState).omit({
  id: true,
  createdAt: true,
});
...
export const fanSubscribers = pgTable(
  "fan_subscribers",
  {
    id: varchar("id")
      .primaryKey()
...
export const fanMessages = pgTable(
  "fan_messages",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (t) => [index("fan_messages_user_id_idx").on(t.userId)],
);

export const insertFanSubscriberSchema = createInsertSchema(
  fanSubscribers,
).omit({ id: true, createdAt: true, joinedAt: true });
export const insertFanMessageSchema = createInsertSchema(fanMessages).omit({
  id: true,
  createdAt: true,
});
...
export const pressKits = pgTable(
  "press_kits",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertPressKitSchema = createInsertSchema(pressKits).omit({
  id: true,
  createdAt: true,
});
...
export const playlistPitches = pgTable(
  "playlist_pitches",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertPlaylistPitchSchema = createInsertSchema(
  playlistPitches,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const syncSubmissions = pgTable(
  "sync_submissions",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertSyncSubmissionSchema = createInsertSchema(
  syncSubmissions,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const publishingRights = pgTable(
  "publishing_rights",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertPublishingRightSchema = createInsertSchema(
  publishingRights,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const labelSubmissions = pgTable(
  "label_submissions",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertLabelSubmissionSchema = createInsertSchema(
  labelSubmissions,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const radioPitches = pgTable(
  "radio_pitches",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertRadioPitchSchema = createInsertSchema(radioPitches).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const venueContacts = pgTable(
  ...
  (t) => [index("venue_contacts_user_id_idx").on(t.userId)],
);

export const insertVenueContactSchema = createInsertSchema(venueContacts).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const projectBudgets = pgTable(
  ...
  (t) => [index("project_budgets_user_id_idx").on(t.userId)],
);

export const insertProjectBudgetSchema = createInsertSchema(
  projectBudgets,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const budgetLineItems = pgTable(
  ...
  (t) => [index("budget_line_items_budget_id_idx").on(t.budgetId)],
);
...
export const sampleClearances = pgTable(
  "sample_clearances",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertSampleClearanceSchema = createInsertSchema(
  sampleClearances,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const musicVideoProductions = pgTable(
  ...
  (t) => [index("music_video_productions_user_id_idx").on(t.userId)],
);

export const insertMusicVideoProductionSchema = createInsertSchema(
...
export const songwritingSessions = pgTable(
  ...
  (t) => [index("songwriting_sessions_user_id_idx").on(t.userId)],
);

export const insertSongwritingSessionSchema = createInsertSchema(
  songwritingSessions,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const fanCampaigns = pgTable(
  "fan_campaigns",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertFanCampaignSchema = createInsertSchema(fanCampaigns).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const customWorkflows = pgTable(
  "custom_workflows",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertCustomWorkflowSchema = createInsertSchema(
  customWorkflows,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const assistantConversations = pgTable(
  ...
  (t) => [index("assistant_conversations_user_id_idx").on(t.userId)],
);
...
export const assistantMessages = pgTable(
  ...
  (t) => [index("assistant_messages_conversation_id_idx").on(t.conversationId)],
);
...
export const insertPlatformRoyaltyRateSchema = createInsertSchema(
  platformRoyaltyRates,
).omit({ id: true, updatedAt: true });
export type PlatformRoyaltyRate = typeof platformRoyaltyRates.$inferSelect;
export type InsertPlatformRoyaltyRate =
  typeof platformRoyaltyRates.$inferInsert;
...
export const insertTaxTreatyRateSchema = createInsertSchema(
  taxTreatyRates,
).omit({ id: true, updatedAt: true });
...
export const insertStudioSampleSchema = createInsertSchema(studioSamples).omit({
  createdAt: true,
});
...
export const insertLabelSettingSchema = createInsertSchema(labelSettings).omit({
  id: true,
  updatedAt: true,
});
...
export const insertMobileDeviceTokenSchema = createInsertSchema(
  mobileDeviceTokens,
...
export type InsertMobileDeviceToken = z.infer<
  typeof insertMobileDeviceTokenSchema
>;
...
export const claimedDomains = pgTable("claimed_domains", {
  ...
  registrarName: varchar("registrar_name", { length: 64 }).default(
    "maxbooster",
  ),
  nameserver1: varchar("nameserver1", { length: 253 }).default(
    "ns1.max-booster.com",
  ),
  nameserver2: varchar("nameserver2", { length: 253 }).default(
    "ns2.max-booster.com",
  ),
  expiresAt: timestamp("expires_at"),
...
export const insertClaimedDomainSchema = createInsertSchema(
  claimedDomains,
).omit({
  id: true,
  createdAt: true,
...
export const domainContacts = pgTable("domain_contacts", {
  ...
  contactType: varchar("contact_type", { length: 16 })
    .notNull()
    .default("registrant"),
...
export const insertDomainContactSchema = createInsertSchema(
  domainContacts,
).omit({
  id: true,
  createdAt: true,
...
// ============================================================================
export const dnssecKeys = pgTable(
  "dnssec_keys",
  {
    id: varchar("id")
      .primaryKey()
...
export const hnsAuctions = pgTable(
  "hns_auctions",
  {
    id: varchar("id")
      .primaryKey()
