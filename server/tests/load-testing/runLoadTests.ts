...
const TEST_SUITES: TestSuite[] = [
  ...
  },
  {
    ...
    endpoint: "/api/reliability/status",
    method: "GET",
    requiresAuth: false,
  },
  {
    name: "Marketplace Beats",
    endpoint: "/api/marketplace/beats",
    method: "GET",
    requiresAuth: false,
  },
  {
    name: "Distribution Platforms",
    endpoint: "/api/distribution/platforms",
    method: "GET",
    requiresAuth: true,
  },
  {
  ...
  {
    name: "Toxicity Check",
    endpoint: "/api/ai/toxicity/analyze",
    method: "POST",
    body: {
  ...
  },
  {
    ...
    endpoint: "/api/ai/social/predict",
    method: "POST",
    body: {
      platform: "instagram",
