...
export const DISTRIBUTION_PLATFORMS = [
  ...
  // Electronic & DJ Platforms
  {
    ...
    metadata: {
      ...
      region: 'global',
      category: 'dj_pool',
      requirements: { isrc: true, upc: true, metadata: ['title', 'artist', 'bpm', 'key'], audioFormats: ['WAV', 'MP3'] },
    },
  },
  {
    name: 'BPM Supreme',
  ...
  },
  {
    ...
    metadata: {
      ...
      region: 'global',
      category: 'classical',
      requirements: { isrc: true, upc: true, metadata: ['title', 'artist', 'composer', 'album'], audioFormats: ['WAV', 'FLAC'] },
    },
  },
  {
    name: 'IDAGIO',
