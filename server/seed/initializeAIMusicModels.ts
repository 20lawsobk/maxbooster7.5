  ...
  try {
    const models = [
      ...
      },
      {
        ...
        description:
          "Genre-specific mixing and mastering presets (20+ professional genres)",
        version: "1.0.0",
        status: "active",
        capabilities: [
          "genre_detection",
      ...
      },
      {
        ...
        description:
          "Reference track matching with spectral analysis and mix recommendations",
        version: "1.0.0",
        status: "active",
        capabilities: [
          "spectral_analysis",
      ...
      },
      {
        ...
        description:
          "Music-informed creative planning — derives optimal beat count, hook weight, CTA urgency, and variant diversity from BPM, energy, and genre features",
        version: "1.0.0",
        status: "active",
        capabilities: [
          "beat_planning",
      ...
      },
      {
        ...
        modelType: "video_creative",
        description:
          "Per-beat scene cut timing locked to BPM, energy peaks, and section structure — ensures every scene change lands exactly on the music",
        version: "1.0.0",
        status: "active",
        capabilities: [
          "beat_sync",
      ...
      },
      {
        ...
        modelType: "video_creative",
        description:
          "Pre-flight engagement prediction — scores watch time, hook strength, and conversion probability before rendering (no wasted compute)",
        version: "1.0.0",
        status: "active",
        capabilities: [
      ...
      },
      {
        ...
        modelType: "video_creative",
        description:
          "Per-beat visual style selection from 13 music-industry styles — maps BPM, energy, genre, and emotional goal to the optimal visual style per scene",
        version: "1.0.0",
        status: "active",
        capabilities: [
          "style_selection",
