...
const TEMPLATES = [
  {
    ...
    description: 'Dark, professional theme built for beat sellers. Bold grid layout with purple & gold accents — maximises impulse purchases.',
    isPremium: false,
    configuration: {
      colors: {
        primary: '#7C3AED',
  ...
  },
  {
    ...
    description: 'Street-ready black & red aesthetic. Left-aligned layout with raw energy — perfect for trap, drill, and boom-bap producers.',
    isPremium: false,
    configuration: {
      colors: {
        primary: '#EF4444',
  ...
  },
  {
    name: 'Electronic / EDM',
    slug: 'electronic-edm',
    description: 'Neon-lit dark canvas with cyan & pink gradients. Four-column grid designed for high-volume electronic beat catalogues.',
    isPremium: false,
    configuration: {
      colors: {
        primary: '#06B6D4',
  ...
  },
  {
    name: 'R&B / Soul',
    slug: 'rnb-soul',
    description: 'Warm, intimate feel with deep brown tones and gold. Two-column layout that lets your music breathe and tell a story.',
    isPremium: false,
    configuration: {
      colors: {
        primary: '#D97706',
  ...
  },
  {
    name: 'Pop Commercial',
    slug: 'pop-commercial',
    description: 'Clean white canvas with vibrant hot-pink accents. Bright, chart-ready aesthetic that appeals to mainstream artists and labels.',
    isPremium: false,
    configuration: {
      colors: {
        primary: '#EC4899',
  ...
  },
  {
    name: 'Chill / Lo-Fi',
    slug: 'chill-lo-fi',
    description: 'Soft beige and terracotta tones with a vintage paper feel. Two-column layout perfect for lo-fi, jazz hop, and chill producers.',
    isPremium: false,
    configuration: {
      colors: {
        primary: '#C2714F',
  ...
  },
  {
    ...
    description: 'High-contrast dark gray with fiery orange. Three-column grid that conveys raw energy — ideal for rock, metal, and punk producers.',
    isPremium: false,
    configuration: {
      colors: {
        primary: '#F97316',
...
export async function seedStorefrontTemplates() {
  try {
    ...
    if (existing > 0) {
      logger.info(`Storefront templates already seeded (${existing} found) — skipping.`);
      return;
    }
