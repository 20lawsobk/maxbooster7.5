      ...
      marketplace: [
        {
          id: "preset_trap",
          name: "Trap Vibes",
          filters: { genre: "Trap", bpm_min: 130, bpm_max: 160 },
          isBuiltIn: true,
        },
        {
          id: "preset_chill",
          name: "Chill Lo-Fi",
          filters: { genre: "Lo-Fi", bpm_min: 70, bpm_max: 95 },
          isBuiltIn: true,
        },
        {
          id: "preset_drill",
          name: "UK Drill",
          filters: { genre: "Drill", bpm_min: 140, bpm_max: 145 },
          isBuiltIn: true,
        },
        {
          id: "preset_rnb",
          name: "Smooth R&B",
          filters: { genre: "R&B", bpm_min: 60, bpm_max: 100 },
          isBuiltIn: true,
        },
        {
          id: "preset_budget",
        ...
        },
        {
          ...
          filters: { price_min: 200, exclusive_only: true },
          isBuiltIn: true,
        },
      ],
      analytics: [
