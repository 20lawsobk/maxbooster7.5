...
> = {
  ...
  growth: {
    ...
    response:
      "Sustainable audience growth comes from a mix of organic discovery and targeted outreach. Submit to independent playlist curators on SubmitHub and Groover — even placements on smaller playlists (1,000-10,000 followers) add up. Collaborate with artists in adjacent genres to cross-pollinate audiences. Feature in music blogs and podcasts for credibility. On streaming platforms, release consistently — artists who drop every 4-6 weeks see 40% more algorithmic playlist consideration than those who release infrequently.",
  },
  brand: {
    keywords: [
      "brand",
    ...
    response:
      "Your artist brand is your first impression with industry gatekeepers and potential fans. Ensure your artist name, photo, bio, and visual style are consistent across all platforms. A professional press kit (EPK) with high-res photos, a concise bio, notable achievements, and streaming links is essential for booking shows and pitching to labels. Max Booster's Press Kit builder helps you create a shareable EPK in minutes. Update it with every major release or achievement.",
  },
  performance: {
    keywords: [
      "show",
