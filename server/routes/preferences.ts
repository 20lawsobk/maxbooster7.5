...
router.get('/smart-defaults', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ message: 'Failed to fetch smart defaults' });
  }
});
...
router.get('/scheduling-suggestions', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ message: 'Failed to fetch scheduling suggestions' });
  }
});
...
router.get('/platform-recommendations', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ message: 'Failed to fetch platform recommendations' });
  }
});
...
router.get('/genre-templates', async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ message: 'Failed to fetch genre templates' });
  }
});
...
router.get('/genre-templates/:genre', async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ message: 'Failed to fetch genre template' });
  }
});
