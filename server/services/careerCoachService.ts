...
const CAREER_COACH_PATTERNS: CoachPattern[] = [
  // ─── Release Strategy ────────────────────────────────────────────────────────
  {
    ...
    title: s => `Re-engage your audience — ${s.daysSinceRelease} days without a release`,
    description: s => `Streaming algorithms deprioritize artists who go silent for extended periods. After ${s.daysSinceRelease} days, your playlist placements and algorithmic reach have likely dropped. A new release — even a single — resets the algorithm clock.`,
    ...
    expectedImpact: '20–40% increase in algorithmic playlist adds within 14 days of release',
    timeframe: '7–14 days',
  },
  {
    ...
    description: () => 'The sweet spot for independent artists is releasing every 3–4 weeks. DSP algorithms reward consistency. You\'re approaching the window where your algorithmic reach starts to decline.',
    actionUrl: '/distribution',
    steps: [
    ...
    expectedImpact: 'Sustains your current algorithmic momentum and listener retention',
  ...
  },
  {
    ...
    severity: () => 'medium',
    title: () => 'Build your catalog — artists with 5+ releases get 3× more playlist placements',
    description: () => 'Industry data shows that Spotify, Apple Music, and Amazon Music\'s recommendation engines heavily favor artists with deep catalogs. With fewer than 3 releases, you\'re limiting your discoverability surface area.',
    actionUrl: '/studio',
    steps: [
    ...
    expectedImpact: '3× increase in algorithmic discovery once catalog reaches 5+ tracks',
  ...
  },
  {
    ...
    description: () => 'You\'ve built enough catalog depth for an EP or mini-album. Bundling your best-performing singles with 2–3 new tracks creates a major marketing moment and increases your chances of editorial features.',
    actionUrl: '/distribution',
    steps: [
    ...
    expectedImpact: 'EP releases typically generate 2–5× the streams of a single release week',
  ...
  // ─── Social Media & Content ───────────────────────────────────────────────
  {
    ...
    description: () => 'Social media is the #1 driver of organic music discovery in 2024. Without a connected account, Max Booster\'s autopilot, content generator, and analytics tools cannot work for you. Start with Instagram or TikTok — they drive the highest music streams per post.',
    ...
    expectedImpact: 'Artists with 2+ social accounts see 4× more discovery streams',
  ...
  },
  {
    ...
    severity: () => 'high',
    title: s => `Add a second social platform to ${s.socialAccounts[0] || 'your current one'}`,
    description: s => `You're on ${s.socialAccounts[0] || 'one platform'}, but cross-platform presence multiplies your reach. Each platform has a unique algorithm and audience — being on 2 platforms roughly doubles your organic reach ceiling.`,
    actionUrl: '/settings?tab=integrations',
    steps: [
    ...
    expectedImpact: 'Second social account typically adds 30–60% more organic streams',
  ...
  },
  {
    ...
    title: () => 'Your save rate is low — boost it to unlock algorithmic playlists',
    description: () => 'Spotify\'s algorithm heavily weights the save-to-stream ratio. A rate below 4% signals to Spotify that listeners aren\'t connecting with your music, leading to fewer Discover Weekly and Radio placements.',
    ...
    expectedImpact: 'Every 1% improvement in save rate can increase algorithmic reach by 15–25%',
    timeframe: '30 days',
  },
  {
    ...
    description: () => 'Social algorithms (Instagram, TikTok, YouTube) favor accounts that post 4–7 times per week. Inconsistent posting trains the algorithm to deprioritize your content.',
    actionUrl: '/social-media',
    steps: [
    ...
    expectedImpact: 'Consistent posting increases algorithmic reach by 40–70% over 30 days',
    timeframe: '30 days',
  },
  {
    ...
    description: () => 'Behind-the-scenes (BTS) content consistently outperforms promotional posts by 2–3× on engagement. Fans want to see the human behind the music — studio sessions, songwriting process, day-in-the-life.',
    actionUrl: '/social-media',
    steps: [
    ...
    expectedImpact: 'BTS content averages 2.3× more saves and comments than promotional posts',
  ...
  // ─── Platform & Distribution ──────────────────────────────────────────────
  {
    ...
    priority: 2,
    trigger: s => {
      const platforms = Object.entries(s.platformStreams).sort((a, b) => b[1] - a[1]);
      return platforms.length >= 2 && platforms[0][1] > platforms[1][1] * 3;
    },
    severity: () => 'medium',
    title: s => {
      const top = Object.entries(s.platformStreams).sort((a, b) => b[1] - a[1])[0];
    ...
    expectedImpact: 'Focused platform strategy can increase streams on your top platform by 25–50%',
  ...
  },
  {
    ...
    severity: () => 'high',
    title: () => 'Pitch your music to independent playlists — they\'re the fastest growth lever',
    description: () => 'Independent playlist placements are the single highest-ROI activity for growing streams. A single playlist with 10,000 followers can add 500–5,000 streams per week. Unlike editorial playlists, independent playlists respond quickly to artist outreach.',
    actionUrl: '/distribution',
    steps: [
    ...
    expectedImpact: '3–10 playlist placements can add 1,000–10,000 streams per month',
  ...
  },
  {
    ...
    description: () => 'Pre-saves are the digital equivalent of pre-orders. Spotify counts pre-saves as signals of demand — higher pre-saves can trigger editorial consideration and better first-day algorithmic placement. Even 50 pre-saves can meaningfully impact your release day performance.',
    actionUrl: '/distribution',
    steps: [
  ...
  // ─── Monetization ─────────────────────────────────────────────────────────
  {
    ...
    severity: () => 'medium',
    title: () => 'Diversify beyond streaming — beats, merch, and sync can 10× your revenue',
    description: () => 'Streaming revenue alone averages $0.003–0.005 per stream. At 5,000 streams/month, that\'s $15–25. Adding beat sales, merchandise, or sync licensing can realistically generate $500–2,000/month from the same fanbase.',
    ...
    expectedImpact: 'Artists with 3+ revenue streams earn 5–10× more than streaming-only artists',
  ...
  },
  {
    ...
    severity: () => 'medium',
    title: () => 'List beats on the marketplace — producers earn $200–2,000/month passively',
    description: () => 'Beat licensing is one of the most passive income streams in music. Once listed, beats sell while you sleep. Max Booster\'s marketplace has active buyers searching for new beats daily.',
    actionUrl: '/marketplace',
    steps: [
    ...
    expectedImpact: 'Active marketplace sellers average $200–800/month within 90 days',
  ...
  },
  {
    ...
    severity: () => 'low',
    title: () => 'Submit for sync licensing — one placement can pay more than 100,000 streams',
    description: () => 'Sync licensing (music in TV, film, ads, YouTube) is the highest per-use revenue in the music industry. A single TV sync can pay $500–50,000 depending on the usage. Your music doesn\'t need to be chart-topping to land syncs — mood and production quality matter more.',
    actionUrl: '/distribution',
    steps: [
    ...
    expectedImpact: '1–2 sync placements per quarter can add $500–5,000 in licensing income',
  ...
  // ─── Audience Building ────────────────────────────────────────────────────
  {
    ...
    description: s => `${s.topCity} is your strongest market. Local artists who invest in their top city see dramatically better live booking opportunities, local press coverage, and word-of-mouth growth. A concentrated local fanbase also signals to algorithms that you have genuine community support.`,
    ...
    expectedImpact: 'Local fanbase concentration leads to 2× higher engagement and live booking opportunities',
    timeframe: '30–60 days',
  },
  {
    ...
    description: () => 'Social media platforms can change their algorithms or suspend your account overnight. Your email list is the only direct, algorithm-free channel to reach your fans. Artists with email lists see 40–70% higher attendance at shows and 3× more merch sales.',
    actionUrl: '/social-media',
    steps: [
    ...
    expectedImpact: 'Email subscribers have 40× higher conversion rate than social followers for merch/shows',
  ...
  },
  {
    ...
    severity: () => 'medium',
    title: () => 'Collaborate with an artist at a similar level for mutual audience growth',
    description: () => 'Collaboration is the fastest organic growth hack in music. When you feature an artist with a similar audience size, you typically get 30–50% of their fanbase discovering you. Both artists win without paying for ads.',
    actionUrl: '/social-media',
    steps: [
    ...
    expectedImpact: 'A well-matched collaboration can add 15–30% new followers within 7 days of release',
  ...
  // ─── PR & Press ────────────────────────────────────────────────────────────
  {
    ...
    severity: () => 'low',
    title: () => 'Update your Electronic Press Kit (EPK) to attract press and booking agents',
    description: () => 'Journalists, bloggers, playlist curators, and venue bookers all require a professional EPK before covering or booking you. A polished EPK is often the difference between getting featured or being ignored.',
    actionUrl: '/analytics',
    steps: [
    ...
    expectedImpact: 'Artists with professional EPKs are 5× more likely to get blog features and playlist placements',
  ...
  },
  {
    ...
    severity: () => 'low',
    title: () => 'Pitch to music blogs and college radio — they\'re still powerful discovery channels',
    description: () => 'Music blogs and college radio stations reach dedicated music fans who actively seek new artists. A feature on a respected blog can drive 500–5,000 new streams and establishes credibility for future opportunities.',
    actionUrl: '/social-media',
    steps: [
    ...
    expectedImpact: 'Blog and radio coverage drives credibility and 500–2,000 new streams per feature',
  ...
  // ─── Career Milestones ────────────────────────────────────────────────────
  {
    ...
    severity: () => 'high',
    title: s => `${1000 - s.totalFollowers} followers away from your first milestone — push hard now`,
    description: () => '1,000 followers is the first major credibility threshold in music. It unlocks Instagram\'s swipe-up links, YouTube monetization eligibility, and signals to playlist curators and booking agents that you have a real fanbase. Many artists stall here — don\'t let that be you.',
    actionUrl: '/social-media',
    steps: [
    ...
    expectedImpact: 'With focused effort, reaching 1,000 followers typically takes 30–60 days',
    timeframe: '30–60 days',
  },
  {
    ...
    severity: () => 'high',
    title: s => `${Math.round(10000 - s.totalStreams).toLocaleString()} streams to your first major milestone — accelerate now`,
    description: () => '10,000 streams is the threshold where Spotify\'s algorithm begins to take an artist seriously for Discover Weekly and Release Radar placements. It\'s also the point where you start earning meaningful royalties and attracting curator attention.',
    actionUrl: '/distribution',
    steps: [
    ...
    expectedImpact: 'Reaching 10K streams can trigger Discover Weekly consideration, multiplying organic growth',
  ...
  },
  {
    ...
    description: () => 'Many artists leave money on the table by not properly registering with a PRO (Performing Rights Organization) and collecting publishing royalties. In addition to streaming royalties, you\'re entitled to sync, performance, and mechanical royalties.',
    actionUrl: '/analytics',
    steps: [
    ...
    expectedImpact: 'Proper royalty setup can recover 20–40% more income from existing streams',
  ...
  // ─── Verification & Presence ──────────────────────────────────────────────
  {
    ...
    description: () => 'Verified artist profiles on Spotify for Artists, Apple Music for Artists, and Amazon Music for Artists give you control over your image, access to streaming data, and the ability to pitch for editorial playlists. Unclaimed profiles miss out on all of these benefits.',
    actionUrl: '/distribution',
    steps: [
    ...
    expectedImpact: 'Optimized artist profiles receive 25–40% more profile visits and follows',
...
class CareerCoachService {
  ...
  async generateDailyRecommendations(userId: string): Promise<CareerCoachRecommendation[]> {
    try {
      ...
      const triggeredPatterns = CAREER_COACH_PATTERNS.filter(p => p.trigger(snapshot));
      ...
      if (recommendations.length === 0) {
        recommendations.push({
          ...
          description: "Your career metrics look solid. Focus on consistency: maintain your release cadence, keep engaging your audience, and explore new revenue streams to keep growing.",
          priority: 2,
          actionUrl: "/analytics",
          metadata: {
            ...
            expectedImpact: 'Sustained consistency leads to compounding growth over 3–6 months',
            timeframe: 'Ongoing',
          },
        });
      }
      ...
      logger.warn({ err: error }, `Error generating recommendations for user ${userId}:`);
      throw error;
    }
  }
  ...
  async createSmartGoal(userId: string, goalType: string): Promise<CareerGoal | null> {
    try {
      ...
      logger.warn({ err: error }, `Error creating SMART goal for user ${userId}:`);
      throw error;
    }
  }
  ...
  async dismissRecommendation(userId: string, recommendationId: string): Promise<boolean> {
    try {
      ...
      logger.warn({ err: error }, `Error dismissing recommendation ${recommendationId}:`);
      throw error;
    }
  }
  ...
  async completeRecommendation(userId: string, recommendationId: string): Promise<boolean> {
    try {
      ...
      logger.warn({ err: error }, `Error completing recommendation ${recommendationId}:`);
      throw error;
    }
  }
  ...
  private async getUserAnalyticsSnapshot(userId: string): Promise<UserAnalyticsSnapshot> {
    ...
    const daysSinceRelease = lastReleaseDate
      ? Math.floor((Date.now() - new Date(lastReleaseDate).getTime()) / (1000 * 60 * 60 * 24))
      : 999;
  ...
  private async suggestSmartGoal(userId: string, goalType: string): Promise<SmartGoalSuggestion | null> {
    ...
    const suggestions: Record<string, SmartGoalSuggestion> = {
      ...
      releases: {
        ...
        description: 'Maintain a regular release cadence to feed the algorithm and keep fans engaged',
        targetValue: snapshot.releaseCount + 4,
        unit: 'releases',
        deadlineDays: 90,
        reasoning: 'Industry data shows artists who release 4+ tracks per quarter receive significantly better algorithmic placement on Spotify, Apple Music, and Amazon Music.',
      },
      engagement: {
        goalType: 'engagement',
        title: 'Boost Save & Engagement Rate',
        description: 'Increase the save-to-stream ratio to unlock algorithmic playlist placements',
        targetValue: Math.max(snapshot.avgEngagementRate * 2, 0.05),
        unit: 'rate',
        deadlineDays: 30,
        reasoning: 'A save rate above 5% signals to Spotify that fans love your music, which triggers Discover Weekly and Radio placements.',
      },
      revenue: {
        goalType: 'revenue',
        title: 'Reach Your First Revenue Milestone',
        description: 'Diversify income streams through beat sales, sync, and merchandise',
      ...
      playlists: {
        ...
        description: 'Systematically pitch to independent curators to dramatically increase stream volume',
        targetValue: 10,
        unit: 'playlists',
        deadlineDays: 45,
        reasoning: '10 playlist placements across curators with 5K–50K followers can realistically add 2,000–20,000 streams per month.',
      },
    };
