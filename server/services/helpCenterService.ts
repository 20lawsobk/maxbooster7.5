...
const defaultFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Streaming platforms typically pay royalties 60-90 days after streams occur. We process payouts monthly once you reach the minimum threshold of $10. You can track your earnings in real-time on the Royalties page.",
    category: "royalties",
    helpful: 145,
    notHelpful: 8,
    isPublished: true,
...
export class HelpCenterService {
  ...
  async createFAQ(
    data: Omit<
      FAQItem,
      "id" | "helpful" | "notHelpful" | "createdAt" | "updatedAt"
    >,
  ): Promise<FAQItem> {
    const faq: FAQItem = {
      ...data,
