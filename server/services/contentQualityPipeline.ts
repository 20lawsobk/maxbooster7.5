...
export function getCurrentPressure(): number {
...
const CONTENT_FORMULA_LIBRARY: Record<
  string,
  {
    name: string;
    triggers: string[];
...
> = {
  curiosity_gap: {
    name: "Curiosity Gap",
    triggers: ["curiosity", "fomo"],
    bestFor: ["viral", "engagement"],
    hookSignals: [
      /nobody (told|shows|talks)/i,
      /they don't want/i,
      /the secret/i,
      /nobody expected/i,
    ],
  ...
  before_after: {
    name: "Before/After",
    triggers: ["inspiration", "transformation"],
    bestFor: ["awareness", "viral"],
    hookSignals: [
      /from .+ to/i,
      /before.*after/i,
      /used to.*now/i,
  ...
  social_proof: {
    ...
    triggers: ["fomo", "authority"],
    bestFor: ["conversions", "awareness"],
    hookSignals: [
      /\d+k? (streams|plays|followers)/i,
      /everyone is/i,
      /response has been/i,
    ],
    engagementBoost: 12,
  ...
  insider_secret: {
    name: "Insider Secret",
    triggers: ["exclusivity", "authority"],
    bestFor: ["awareness", "engagement"],
    hookSignals: [
      /nobody talks about/i,
      /secret to/i,
      /what they don't tell/i,
      /insider/i,
    ],
    engagementBoost: 15,
  },
  ...
  countdown: {
    ...
    bestFor: ["conversions", "awareness"],
    hookSignals: [
      /\d+ (days|hours|hours) (left|until|away)/i,
      /dropping/i,
      /coming soon/i,
      /launches/i,
    ],
  ...
  milestone: {
    ...
    triggers: ["social_proof", "community"],
    bestFor: ["awareness", "engagement"],
    hookSignals: [
      /(hit|reached|crossed) \d+/i,
      /milestone/i,
      /thank you for/i,
      /we made it/i,
    ],
  ...
  relatable_moment: {
    ...
    triggers: ["recognition", "humor"],
    bestFor: ["viral", "engagement"],
    hookSignals: [/pov:/i, /me when/i, /not me/i, /tell me why/i, /who else/i],
    engagementBoost: 14,
  },
  transformation: {
    name: "Transformation Story",
    triggers: ["inspiration", "hope"],
    bestFor: ["viral", "awareness"],
    hookSignals: [
      /this changed (everything|me)/i,
      /i was.*years old/i,
      /turning point/i,
    ],
    engagementBoost: 15,
  ...
  community_shoutout: {
    ...
    triggers: ["belonging", "gratitude"],
    bestFor: ["engagement", "awareness"],
    hookSignals: [
      /for my (fans|community|day ones|supporters)/i,
      /thank you.*community/i,
      /this one is for/i,
    ],
    engagementBoost: 9,
  },
  industry_truth: {
    name: "Industry Truth",
    triggers: ["validation", "empowerment"],
    bestFor: ["viral", "engagement"],
    hookSignals: [
      /industry/i,
      /label/i,
...
const PSYCHOLOGICAL_TRIGGER_LAYERS: Record<
  string,
  { triggers: string[]; scoreBoost: number }[]
> = {
  awareness: [
...
class ContentQualityPipeline {
  ...
  validatePlatformConstraints(
    ...
    const PLATFORM_LIMITS: Record<
      string,
      { maxChars: number; optimalHashtags: number; optimalEmojis: number }
    > = {
   ...
   */
  private scoreNarrativeAuthenticity(
    content: string,
    headline: string,
  ): number {
    let score = 50;
