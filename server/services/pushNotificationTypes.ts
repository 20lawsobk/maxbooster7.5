...
export function buildPushPayload(
  ...
  switch (type) {
    ...
    case 'social_like':
      return { ...base,
        title: '❤️ New Like',
        body: ctx.actorName ? `${ctx.actorName} liked your post${ctx.contentTitle ? `: "${ctx.contentTitle}"` : '.'}` : 'Someone liked your post.',
        url: ctx.url || '/social',
        tag: 'social_like',
        category: 'direct_interaction',
        actions: [{ action: 'open', title: 'View Post' }, { action: 'dismiss', title: 'Dismiss' }],
    ...
    case 'social_comment':
      return { ...base,
        ...
        tag: 'social_comment',
        category: 'direct_interaction',
        actions: [{ action: 'reply', title: 'Reply' }, { action: 'open', title: 'View' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'social_reply':
      return { ...base,
        ...
        tag: 'social_reply',
        category: 'direct_interaction',
        actions: [{ action: 'reply', title: 'Reply' }, { action: 'open', title: 'View Thread' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'social_follow':
      return { ...base,
        ...
        tag: 'social_follow',
        category: 'direct_interaction',
        actions: [{ action: 'open', title: 'View Profile' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'platform_suggested_account':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'Explore' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
        requireInteraction: false,
      };
    ...
    case 'platform_trending_topic':
      return { ...base,
        ...
        category: 'platform_generated',
        actions: [{ action: 'open', title: 'View Trend' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'platform_group_activity':
      return { ...base,
        ...
        tag: 'platform_group',
        category: 'platform_generated',
        actions: [{ action: 'open', title: 'View Group' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'platform_event_invite':
      return { ...base,
        ...
        tag: 'platform_event',
        category: 'platform_generated',
        actions: [{ action: 'accept', title: 'Accept' }, { action: 'open', title: 'View' }],
        vibrate: VIBRATE.normal,
        requireInteraction: true,
      };
    ...
    case 'platform_birthday_reminder':
      return { ...base,
        ...
        category: 'platform_generated',
        actions: [{ action: 'open', title: 'Send Message' }, { action: 'dismiss', title: 'Maybe Later' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'content_live_stream':
      return { ...base,
        ...
        category: 'content_based',
        actions: [{ action: 'open', title: 'Watch Now' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.alert,
        requireInteraction: true,
        renotify: true,
        image: ctx.imageUrl,
    ...
    case 'content_recommended':
      return { ...base,
        ...
        category: 'content_based',
        actions: [{ action: 'open', title: 'View' }, { action: 'dismiss', title: 'Not Interested' }],
        vibrate: VIBRATE.subtle,
        image: ctx.imageUrl,
      };
    ...
    case 'engagement_digest':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'View All' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'engagement_story_reaction':
      return { ...base,
        ...
        category: 'engagement_summary',
        actions: [{ action: 'open', title: 'View Story' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'security_new_login':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'Review' }, { action: 'dismiss', title: 'Was Me' }],
    ...
    case 'security_password_changed':
      return { ...base,
        ...
        category: 'account_security',
        actions: [{ action: 'open', title: 'Review Account' }, { action: 'dismiss', title: 'I Changed It' }],
        vibrate: VIBRATE.urgent,
        requireInteraction: true,
      };
    ...
    case 'security_suspicious_activity':
      return { ...base,
        ...
        category: 'account_security',
        actions: [{ action: 'open', title: 'Review Now' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.urgent,
        requireInteraction: true,
      };
    ...
    case 'security_2fa_enabled':
      return { ...base,
        ...
        tag: 'security_2fa',
        category: 'account_security',
        actions: [{ action: 'open', title: 'View Settings' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'security_2fa_disabled':
      return { ...base,
        ...
        tag: 'security_2fa',
        category: 'account_security',
        actions: [{ action: 'open', title: 'Re-enable 2FA' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.alert,
        requireInteraction: true,
      };
    ...
    case 'account_warning':
      return { ...base,
        ...
        body: ctx.contentPreview || 'Your account has received a notice. Please review it.',
        url: '/settings',
        tag: 'account_warning',
        category: 'account_security',
        actions: [{ action: 'open', title: 'Review' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.alert,
        requireInteraction: true,
      };
    ...
    case 'account_verified':
      return { ...base,
        ...
        category: 'account_security',
        actions: [{ action: 'open', title: 'View Profile' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'location_nearby_event':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'View on Map' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'location_trending_local':
      return { ...base,
        ...
        category: 'location_based',
        actions: [{ action: 'open', title: 'View Trends' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'release_live':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'View Release' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.alert,
        requireInteraction: true,
      };
    ...
    case 'stream_milestone':
      return { ...base,
        ...
        category: 'distribution',
        actions: [{ action: 'open', title: 'View Stats' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.alert,
      };
    ...
    case 'release_submitted':
      return { ...base,
        ...
        category: 'distribution',
        actions: [{ action: 'open', title: 'Track Status' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'release_processing':
      return { ...base,
        ...
        category: 'distribution',
        actions: [{ action: 'open', title: 'View Progress' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'upload_complete':
      return { ...base,
        ...
        tag: 'upload_complete',
        category: 'distribution',
        actions: [{ action: 'open', title: 'View File' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'ai_processing_complete':
      return { ...base,
        ...
        tag: 'ai_complete',
        category: 'distribution',
        actions: [{ action: 'open', title: 'View Result' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'payout_completed':
      return { ...base,
        ...
        category: 'royalties',
        actions: [{ action: 'open', title: 'View Earnings' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.alert,
      };
    ...
    case 'payment_failed':
      return { ...base,
        ...
        tag: 'payment_failed',
        category: 'royalties',
        actions: [{ action: 'open', title: 'Fix Now' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.urgent,
        requireInteraction: true,
      };
    ...
    case 'royalty_statement_ready':
      return { ...base,
        ...
        category: 'royalties',
        actions: [{ action: 'open', title: 'View Statement' }, { action: 'dismiss', title: 'Later' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'collaboration_invite':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'View Invite' }, { action: 'dismiss', title: 'Later' }],
        vibrate: VIBRATE.normal,
        requireInteraction: true,
      };
    ...
    case 'collaboration_accepted':
      return { ...base,
        ...
        tag: 'collab_accepted',
        category: 'collaboration',
        actions: [{ action: 'open', title: 'Start Collaborating' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'marketplace_purchase':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'View Purchase' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'marketplace_sale':
      return { ...base,
        ...
        category: 'marketplace',
        actions: [{ action: 'open', title: 'View Sale' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.alert,
      };
    ...
    case 'marketplace_offer':
      return { ...base,
        ...
        category: 'marketplace',
        actions: [{ action: 'open', title: 'View Offer' }, { action: 'dismiss', title: 'Later' }],
        vibrate: VIBRATE.normal,
        requireInteraction: true,
      };
    ...
    case 'marketplace_review':
      return { ...base,
        ...
        category: 'marketplace',
        actions: [{ action: 'open', title: 'View Review' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'beat_play_milestone':
      return { ...base,
        ...
        tag: 'beat_milestone',
        category: 'marketplace',
        actions: [{ action: 'open', title: 'View Beat' }, { action: 'dismiss', title: 'Dismiss' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'achievement_unlocked':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'View Achievement' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.alert,
      };
    ...
    case 'streak_milestone':
      return { ...base,
        ...
        tag: 'streak',
        category: 'achievements',
        actions: [{ action: 'open', title: 'View Streak' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'subscription_expiring':
      return { ...base,
        ...
        category: 'account_security',
        actions: [{ action: 'open', title: 'Renew Now' }, { action: 'dismiss', title: 'Remind Later' }],
        vibrate: VIBRATE.alert,
        requireInteraction: true,
      };
    ...
    case 'subscription_renewed':
      return { ...base,
        ...
        category: 'account_security',
        actions: [{ action: 'open', title: 'View Account' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'system_update':
      return { ...base,
        ...
        body: ctx.contentTitle || ctx.contentPreview || 'A new update is available on Max Booster.',
        url: '/dashboard',
        tag: 'system_update',
        category: 'system',
        actions: [{ action: 'open', title: 'Learn More' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'system_maintenance':
      return { ...base,
        ...
        body: ctx.contentTitle || 'Max Booster will undergo scheduled maintenance soon.',
        url: '/dashboard',
        tag: 'system_maintenance',
        category: 'system',
        actions: [{ action: 'open', title: 'View Details' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
        requireInteraction: true,
      };
    ...
    case 'storage_quota_warning':
      return { ...base,
        ...
        tag: 'storage_warning',
        category: 'system',
        actions: [{ action: 'open', title: 'Manage Storage' }, { action: 'dismiss', title: 'Later' }],
        vibrate: VIBRATE.alert,
        requireInteraction: true,
      };
    ...
    case 'social_post_scheduled':
      return { ...base,
        ...
        actions: [{ action: 'open', title: 'View Schedule' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.subtle,
      };
    ...
    case 'social_post_published':
      return { ...base,
        ...
        tag: 'post_published',
        category: 'social_media',
        actions: [{ action: 'open', title: 'View Post' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'ad_campaign_created':
      return { ...base,
        ...
        tag: 'ad_campaign',
        category: 'system',
        actions: [{ action: 'open', title: 'View Campaign' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
    ...
    case 'ad_campaign_milestone':
      return { ...base,
        ...
        tag: 'ad_milestone',
        category: 'system',
        actions: [{ action: 'open', title: 'View Stats' }, { action: 'dismiss', title: 'Got It' }],
        vibrate: VIBRATE.normal,
      };
...
export function buildSilentPayload(reason: 'feed_refresh' | 'message_sync' | 'count_update'): RichPushPayload {
  return {
    title: '',
    body: '',
    url: '/',
