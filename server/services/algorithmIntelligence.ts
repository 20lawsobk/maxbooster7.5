...
class AlgorithmIntelligenceService {
  ...
  private readonly platformAlgorithms: Record<
    string,
    PlatformAlgorithmProfile
  > = {
    tiktok: {
      platform: "tiktok",
      keyFactors: [
  ...
  private readonly platformBenchmarks: Record<
    string,
  ...
  async getAlgorithmInsights(
    ...
    const topActions: Array<{
      ...
      {
        action:
          "Use platform-specific engagement features (Collab, Duet, Stitch, etc)",
        expectedImpact: 22,
        effort: "medium",
      },
      {
        action:
          "Post during your top 3 optimal timing windows consistently for 30 days",
        expectedImpact: 14,
        effort: "low",
      },
      {
        action:
          'A/B test hook styles: curiosity gap vs POV vs "mistake" format',
        expectedImpact: 20,
        effort: "medium",
      },
      {
        action:
          "Create 1 highly save-worthy piece (value list, tips, resource) per week",
        expectedImpact: 28,
        effort: "high",
      },
      {
        action:
          "Cross-post native content to secondary platform for free reach multiplication",
        expectedImpact: 15,
        effort: "low",
      },
    ];
  ...
  private async detectAlerts(
    ...
    if (metrics?.reachTrend === "declining") {
      alerts?.push({
        ...
        detectedAt: new Date(),
        suggestedAction:
          "Run Algorithm Insights to identify the drop trigger and adapt content strategy",
        resolved: false,
      });
    }
      ...
      tiktok: [
        {
          ...
          impact: "positive",
          description:
            "TikTok 2025 Q3: Creator Music Library original audio now receives an extended algorithmic push window (up to 72h from prior 24h) when used by other creators.",
          adaptations: [
      ...
      instagram: [
        {
          ...
          impact: "positive",
          description:
            "Instagram 2025 H1: Broadcast Channels subscribers now boost post reach — creators with 1k+ subscribers see approximately 25% higher Reel distribution.",
          adaptations: [
        ...
        },
        {
          ...
          impact: "negative",
          description:
            "Instagram 2025 Q4: Hashtag reach declined further — algorithm now prioritizes topic/interest signals over hashtag text matching.",
          adaptations: [
      ...
      youtube: [
        {
          ...
          impact: "positive",
          description:
            "YouTube 2025 Q3: Shorts-to-long-form funnel strengthened — viewers who watch 3+ Shorts from a channel are now recommended long-form content from that same channel.",
          adaptations: [
      ...
      twitter: [
        {
          ...
          impact: "negative",
          description:
            "X/Twitter 2025: Non-Premium (unverified) accounts receive approximately 30% less algorithmic reach vs. X Premium subscribers in the For You feed.",
          adaptations: [
      ...
      facebook: [
        {
          ...
          impact: "positive",
          description:
            "Facebook 2025 Q2: Reels now distributed to non-followers by default; organic reach for Reels is 3-5× higher than static posts for Pages under 100k.",
          adaptations: [
      ...
      linkedin: [
        {
          ...
          impact: "positive",
          description:
            'LinkedIn 2025 Q3: Native documents (PDF carousels) now get 3× more impressions than single-image posts; algorithm specifically boosts "how-to" and "list" formatted documents.',
          adaptations: [
      ...
      spotify: [
        {
          ...
          impact: "positive",
          description:
            "Spotify 2025 Q2: Discovery Mode expanded — artists who opt in via Spotify for Artists see avg 40% increase in algorithmic playlist adds on opted-in tracks.",
          adaptations: [
      ...
      apple_music: [
        {
          ...
          impact: "positive",
          description:
            'Apple Music 2025: Dolby Atmos / Spatial Audio tracks receiving dedicated placement in Apple Music marketing, "Listen Now" carousels, and editorial features.',
          adaptations: [
      ...
      soundcloud: [
        {
          ...
          impact: "positive",
          description:
            "SoundCloud 2025 Q3: SoundCloud Repost Network expanded curator pool; tracks with 500+ organic plays in first 48h are auto-eligible for curator review.",
          adaptations: [
