...
class PromotionalToolsService {
  ...
  async updatePreSavePage(
    pageId: string,
    userId: string,
    updates: Partial<PreSavePage>,
  ): Promise<PreSavePage> {
  ...
  async startAutonomousPromotion(
    userId: string,
    releaseId: string,
  ): Promise<void> {
