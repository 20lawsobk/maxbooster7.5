...
const _KNOWLEDGE_BASE = {
  distribution: {
    ...
    responses: {
      howTo:
        'To distribute your music, go to the Distribution tab, click "New Release", upload your audio and artwork, fill in the metadata, and select your target platforms. Our system will validate everything and submit to all major streaming services.',
      timeline:
  ...
  royalties: {
    ...
    responses: {
      calculation:
        "Royalties are calculated based on streams from each platform. Different platforms pay different rates. You can view detailed breakdowns in the Royalties section, including per-stream rates by territory.",
      payout:
        "Payouts are processed monthly once you reach the minimum threshold ($25 USD). You can set up your payment method in Settings > Payments. We support bank transfer, PayPal, and more.",
      splits:
        "You can set up royalty splits with collaborators in the Splits section. Each release can have different split configurations. All parties receive their share automatically.",
    },
  },
  studio: {
    keywords: [
    ...
    responses: {
      overview:
        "The Max Booster Studio is a professional browser-based DAW. You can record, edit, mix, and master your music without any additional software. It supports multi-track recording, MIDI, and professional effects.",
      features:
        "Key features include: Multi-track recording, MIDI sequencing, built-in effects (EQ, compressor, reverb, delay), automation, stem rendering, and AI-powered mixing assistance.",
      export:
        "Export your projects in various formats: WAV, AIFF, FLAC, MP3, or AAC. You can also render individual stems for distribution or collaboration.",
    },
  },
  social: {
    keywords: [
    ...
    responses: {
      autopilot:
        "Our AI Autopilot can automatically generate and schedule content across all your social platforms. It analyzes optimal posting times and creates engaging content tailored to each platform's algorithm.",
      connect:
        "Connect your social accounts in Settings > Social Connections. We support Instagram, TikTok, Twitter/X, Facebook, YouTube, LinkedIn, and Threads.",
      organic:
        "Max Booster's Organic Growth AI achieves the same results as paid advertising through intelligent content optimization - saving you money while maximizing reach.",
    },
  },
  account: {
    keywords: [
    ...
    responses: {
      password:
        'To reset your password, go to the login page and click "Forgot Password". You\'ll receive an email with instructions to create a new password.',
      subscription:
        "You can manage your subscription in Settings > Subscription. Upgrade, downgrade, or cancel anytime. We offer monthly and yearly plans with different feature sets.",
      security:
        "Enable two-factor authentication in Settings > Security for extra protection. We recommend using an authenticator app for the best security.",
    },
  },
};
...
What would you like to know more about?`,
  ...
  private getSuggestedActions(category: string): string[] {
    const actions: Record<string, string[]> = {
      ...
      studio: ["Open the studio", "View tutorials", "Browse preset library"],
      social: ["Connect social accounts", "Enable autopilot", "View analytics"],
      account: ["Go to settings", "Enable 2FA", "Manage subscription"],
    };
  ...
  private getRelatedArticles(
    ...
    const articles: Record<string, { title: string; url: string }[]> = {
      distribution: [
        {
          title: "Distribution Quick Start Guide",
          url: "/help/distribution-guide",
        },
