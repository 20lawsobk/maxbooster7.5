    ...
    const recommendations: CampaignRecommendation[] = [
      {
        ...
        reasoning:
          "This campaign leverages the excitement around new releases with a multi-platform approach to maximize reach and engagement.",
      },
      {
        id: randomBytes(8).toString("hex"),
        ...
        reasoning:
          "Focus on viral-worthy content and community building to attract and retain new followers.",
      },
    ];
      ...
      pillars: [
        {
          ...
          examples: ["Production tips", "Industry insights", "How-to guides"],
        },
        {
        ...
        },
        {
          name: "Promotional",
          percentage: 20,
          description: "Share your music and achievements",
          examples: ["New releases", "Streaming milestones", "Announcements"],
        },
        {
          name: "Community",
          percentage: 20,
          description: "Engage with your fans",
          examples: ["Q&A sessions", "Fan features", "Challenges"],
        },
        {
          name: "Entertainment",
          percentage: 10,
          description: "Fun and viral content",
          examples: ["Trends", "Memes", "Collaborations"],
        },
      ],
      platformStrategies: [
        {
    ...
    const allTips: EngagementTip[] = [
      {
        ...
        description:
          "Vertical videos (9:16) get 40% more engagement on mobile-first platforms.",
        impact: "high",
        effort: "low",
        platforms: ["instagram", "tiktok", "youtube"],
        actionItems: [
          "Convert horizontal content to vertical",
      ...
      },
      {
        ...
        description:
          "Posting when your audience is most active increases visibility by up to 25%.",
        impact: "high",
        effort: "low",
        platforms: ["instagram", "twitter", "tiktok", "facebook"],
        actionItems: [
          "Check your analytics for peak times",
      ...
      },
      {
        ...
        description:
          "Responding to comments quickly boosts algorithm visibility.",
        impact: "high",
        effort: "medium",
      ...
      },
      {
        ...
        description:
          "Combine high-reach and niche hashtags for optimal discovery.",
        impact: "medium",
        effort: "low",
        platforms: ["instagram", "twitter", "tiktok"],
        actionItems: [
          "Use 3-5 high-reach hashtags",
          "Add 5-7 niche hashtags",
      ...
      },
      {
        ...
        description:
          "The first 3 seconds determine if viewers will keep watching.",
        impact: "high",
        effort: "medium",
        platforms: ["tiktok", "instagram", "youtube"],
        actionItems: [
          "Start with action",
          "Use compelling text overlay",
          "Create curiosity",
        ],
      ...
      },
      {
        ...
        actionItems: [
          ...
          "Tease content on other platforms",
    ...
    return [
      {
        ...
        description:
          "A sound related to your genre is trending on TikTok. Creating content with this sound could boost visibility.",
      ...
      },
      {
        ...
        description:
          "Your video posts get 3x more engagement than images. Consider shifting your content mix.",
      ...
      },
      {
        ...
        description:
          "BTS content is performing 40% better in your niche this month.",
