...
export const PLATFORM_SPECS: Record<SupportedPlatform, PlatformSpec> = {
  ...
  instagram: {
    ...
    supportedSlots: ['short_video', 'static_post', 'carousel', 'story', 'ad_video', 'ad_banner'],
    emojiSupported: true,
    linksInCaption: false,
    mentionFormat: '@username',
    hashtagFormat: '#tag',
    ...
    adFormats: ['Photo Ad', 'Video Ad', 'Carousel Ad', 'Stories Ad', 'Reels Ad'],
  },
  ...
  youtube: {
    ...
    adFormats: ['Skippable In-stream', 'Non-skippable In-stream', 'Bumper Ad', 'Discovery Ad'],
  },
  ...
  twitter: {
    ...
    supportedSlots: ['text_post', 'thread', 'static_post', 'short_video', 'ad_video', 'ad_banner'],
    emojiSupported: true,
    linksInCaption: true,
    mentionFormat: '@username',
    hashtagFormat: '#tag',
    ...
    adFormats: ['Promoted Tweet', 'Promoted Trend', 'Promoted Account', 'Twitter Amplify'],
  },
  ...
  facebook: {
    ...
    supportedSlots: ['static_post', 'long_video', 'short_video', 'carousel', 'ad_video', 'ad_banner'],
    emojiSupported: true,
    linksInCaption: true,
    ...
    adFormats: ['Image Ad', 'Video Ad', 'Carousel Ad', 'Collection Ad', 'Instant Experience'],
  },
  ...
  linkedin: {
    ...
    supportedSlots: ['text_post', 'static_post', 'long_video', 'carousel', 'ad_video', 'ad_banner'],
    emojiSupported: true,
    linksInCaption: true,
    mentionFormat: '@Name',
    hashtagFormat: '#tag',
 ...
 */
export function enforceCharLimit(text: string, platform: SupportedPlatform): string {
 ...
 */
export function enforceHashtagLimit(hashtags: string[], platform: SupportedPlatform): string[] {
  const spec = PLATFORM_SPECS[platform];
...
export function assembleCaption(
  ...
  const combined = spec.hashtagPosition === 'end'
    ? `${body}\n\n${tagString}`
    : body;
...
export const ALL_PLATFORMS: SupportedPlatform[] = Object.keys(PLATFORM_SPECS) as SupportedPlatform[];
