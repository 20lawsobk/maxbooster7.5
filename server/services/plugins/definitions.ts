...
export const BUILT_IN_INSTRUMENTS: PluginDefinition[] = [
    ...
    parameters: [
      {
        ...
        choices: ["acoustic", "electronic", "hip-hop", "rock", "jazz"],
        automatable: false,
      },
      {
        id: "punch",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Classic analog synthesizer with dual oscillators, ladder filter, and modulation",
    author: "Max Booster",
    grade: "A",
    oscillators: [
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "FM synthesis engine with 6 operators and 32 algorithms for complex harmonic content",
    author: "Max Booster",
    grade: "A",
    ...
    parameters: [
      {
        ...
        type: "choice",
        defaultValue: "basic",
        choices: ["basic", "digital", "vocal", "metallic", "organic", "chaos"],
        automatable: false,
      },
      {
        id: "wavePosition",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Professional sampler with multi-sample support and advanced playback",
    author: "Max Booster",
    grade: "A",
    oscillators: [],
...
export const BUILT_IN_EFFECTS: PluginDefinition[] = [
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "1/4",
        choices: ["1/1", "1/2", "1/4", "1/8", "1/16", "1/4T", "1/8T"],
        automatable: false,
      },
      {
        id: "syncNoteRight",
        ...
        type: "choice",
        defaultValue: "1/4D",
        choices: ["1/1", "1/2", "1/4", "1/8", "1/16", "1/4D", "1/8D"],
        automatable: false,
      },
      {
        id: "feedback",
  ...
  },
  {
    ...
    type: "distortion",
    version: "2.0.0",
    description: "All-purpose multi-mode distortion effect unit",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "sine",
        choices: ["sine", "triangle", "sample_hold"],
        automatable: false,
      },
      {
        id: "tempoSync",
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "1/4",
        choices: ["1/16", "1/8", "1/4", "1/2", "1/1", "2/1"],
        automatable: false,
      },
    ],
    defaultPreset: {
  ...
  // ─── REVERB VARIANTS (unlocked from DSP engine) ───────────────────────────
  {
    ...
    version: "1.0.0",
    description:
      "Classic EMT 140-style plate reverb — dense, smooth, and silky",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Vintage spring tank reverb — drip, twang, and surf-guitar character",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Ethereal shimmer reverb with pitch-shifted feedback — cinematic and evolving",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "+1oct",
        choices: ["+1oct", "+2oct", "+5th", "-1oct", "+har"],
        automatable: false,
      },
      {
        id: "feedback",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Infinite-sustain ambient reverb for drone and soundscape textures",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  // ─── COMPRESSOR CHARACTERS (unlocked from DSP engine) ────────────────────
  {
    ...
    version: "1.0.0",
    description:
      "Ultra-fast VCA compressor — punchy and precise, inspired by the 1176 classic",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Program-dependent optical compressor — smooth, musical gain riding inspired by LA-2A",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
      ...
      {
        id: "programRelease",
        name: "Program-Dependent Release",
        type: "bool",
        defaultValue: true,
        automatable: false,
      },
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Aggressive FET compressor — adds grit and excitement, perfect for drums and bus",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "4:1",
        choices: ["2:1", "4:1", "8:1", "12:1", "20:1", "Limit"],
        automatable: false,
      },
      {
        id: "attack",
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "auto",
        choices: ["50ms", "100ms", "200ms", "400ms", "800ms", "auto"],
        automatable: false,
      },
      {
        id: "character",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Warm tube compressor — gentle saturation and harmonic richness, inspired by the Fairchild",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "4-band multiband compressor for mastering and advanced mix shaping",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Smooth SSL-style bus compressor — glues the mix and adds punch",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "30ms",
        choices: ["0.1ms", "1ms", "3ms", "10ms", "30ms", "100ms", "300ms"],
        automatable: false,
      },
      {
        id: "release",
        ...
        type: "choice",
        defaultValue: "0.4s",
        choices: ["0.1s", "0.2s", "0.4s", "0.8s", "1.2s", "auto"],
        automatable: false,
      },
      {
        id: "makeup",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "API-style glue compressor — adds cohesion and energy to group buses",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Transparent mastering compressor with intelligent program detection",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
      ...
      },
      {
        ...
        choices: ["transparent", "warm", "punchy", "vintage"],
        automatable: false,
      },
      {
        id: "makeup",
  ...
  // ─── EQ VARIANTS (unlocked from DSP engine) ───────────────────────────────
  {
    ...
    version: "2.0.0",
    description:
      "8-band fully parametric EQ with HP/LP filters — professional mastering precision",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "4-band dynamic EQ — frequency-specific compression or expansion with full band control",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "M/S parametric EQ — independent mid and side channel sculpting for mastering",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Linear-phase EQ with zero phase distortion — ideal for mastering bus and mid-side work",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  // ─── DYNAMICS — standalone processors (unlocked from DSP engine) ──────────
  {
    ...
    version: "1.0.0",
    description:
      "Independent attack and sustain shaping — sculpt punch and tail without compression",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        choices: ["broadband", "split", "dynamic"],
        automatable: false,
      },
      {
        id: "listen",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Loudness maximizer with intelligent peak limiting and LUFS targeting",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
      ...
      },
      {
        ...
        type: "choice",
        defaultValue: "transparent",
        choices: ["transparent", "punchy", "warm", "excite"],
        automatable: false,
      },
      {
        id: "attack",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Automatic gain rider for consistent loudness over long passages",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Downward expander — reduces low-level signals for noise reduction and punch",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "2.0.0",
    description:
      "Advanced true-peak limiter with 8 limiting algorithms and LUFS metering",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "2.0.0",
    description:
      "Carrier-frequency ring modulation for metallic and robotic tones",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Leslie cabinet simulation — spinning speaker Doppler with fast/slow horn speeds",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    version: "2.0.0",
    description:
      "LFO auto-panning with stereo widening, shape and output control",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
  ...
  },
  {
    ...
    type: "ensemble",
    version: "2.0.0",
    description: "Unison ensemble with pitch scatter — Roland Juno class",
    author: "Max Booster",
    grade: "A",
    parameters: [
      {
