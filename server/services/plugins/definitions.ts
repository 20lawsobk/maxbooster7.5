...
export const BUILT_IN_EFFECTS: PluginDefinition[] = [
  ...
  {
    id: 'mb-gated-reverb',
    slug: 'mb-gated-reverb',
    name: 'MB Gated Reverb',
    category: 'effect',
    type: 'reverb',
    version: '1.0.0',
    description: '80s-style gated reverb — big snare sound, aggressive dynamics',
    author: 'Max Booster',
    parameters: [
      { id: 'decay', name: 'Decay Time', type: 'float', defaultValue: 1.5, minValue: 0.2, maxValue: 4, unit: 's', automatable: true },
      { id: 'gateThreshold', name: 'Gate Threshold', type: 'float', defaultValue: -30, minValue: -60, maxValue: 0, unit: 'dB', automatable: true },
      { id: 'gateRelease', name: 'Gate Release', type: 'float', defaultValue: 80, minValue: 10, maxValue: 500, unit: 'ms', automatable: true },
      { id: 'roomSize', name: 'Room Size', type: 'float', defaultValue: 0.7, minValue: 0, maxValue: 1, automatable: true },
      { id: 'diffusion', name: 'Diffusion', type: 'float', defaultValue: 0.8, minValue: 0, maxValue: 1, automatable: true },
      { id: 'mix', name: 'Dry/Wet', type: 'float', defaultValue: 0.35, minValue: 0, maxValue: 1, automatable: true },
    ],
    defaultPreset: { decay: 1.5, gateThreshold: -30, gateRelease: 80, roomSize: 0.7, diffusion: 0.8, mix: 0.35 },
  },
  {
  ...
  },
  {
    id: 'mb-ring-mod',
    slug: 'mb-ring-mod',
    name: 'MB Ring Modulator',
    category: 'effect',
    type: 'ring-mod',
    version: '1.0.0',
    description: 'Ring modulator for metallic, robotic, and alien timbres',
    author: 'Max Booster',
    parameters: [
      { id: 'frequency', name: 'Carrier Freq', type: 'float', defaultValue: 440, minValue: 1, maxValue: 5000, unit: 'Hz', automatable: true },
      { id: 'shape', name: 'Carrier Shape', type: 'choice', defaultValue: 'sine', choices: ['sine', 'square', 'sawtooth', 'triangle'], automatable: false },
      { id: 'depth', name: 'Depth', type: 'float', defaultValue: 1.0, minValue: 0, maxValue: 1, automatable: true },
      { id: 'lowCut', name: 'Low Cut', type: 'float', defaultValue: 20, minValue: 20, maxValue: 500, unit: 'Hz', automatable: true },
      { id: 'mix', name: 'Mix', type: 'float', defaultValue: 0.5, minValue: 0, maxValue: 1, automatable: true },
    ],
    defaultPreset: { frequency: 440, shape: 'sine', depth: 1.0, lowCut: 20, mix: 0.5 },
  },
  {
    id: 'mb-rotary',
    slug: 'mb-rotary',
  ...
  },
  {
    ...
    type: 'auto-pan',
    version: '1.0.0',
    description: 'Stereo auto-panning with multiple shapes and tempo sync',
    author: 'Max Booster',
    parameters: [
      { id: 'rate', name: 'Rate', type: 'float', defaultValue: 1, minValue: 0.01, maxValue: 20, unit: 'Hz', automatable: true },
      { id: 'depth', name: 'Depth', type: 'float', defaultValue: 0.8, minValue: 0, maxValue: 1, automatable: true },
      { id: 'shape', name: 'LFO Shape', type: 'choice', defaultValue: 'sine', choices: ['sine', 'triangle', 'square', 'random'], automatable: false },
      { id: 'offset', name: 'Phase Offset', type: 'float', defaultValue: 0, minValue: 0, maxValue: 1, automatable: true },
      { id: 'tempoSync', name: 'Tempo Sync', type: 'bool', defaultValue: true, automatable: false },
      { id: 'syncDivision', name: 'Sync Division', type: 'choice', defaultValue: '1/4', choices: ['1/32', '1/16', '1/8', '1/4', '1/2', '1/1'], automatable: false },
    ],
    defaultPreset: { rate: 1, depth: 0.8, shape: 'sine', offset: 0, tempoSync: true, syncDivision: '1/4' },
  },
  {
    id: 'mb-ensemble',
    slug: 'mb-ensemble',
    ...
    type: 'ensemble',
    version: '1.0.0',
    description: 'String/synth ensemble widener with multiple BBD voices — lush and expansive',
    author: 'Max Booster',
    parameters: [
      { id: 'voices', name: 'Voices', type: 'int', defaultValue: 4, minValue: 2, maxValue: 8, automatable: false },
      { id: 'rate', name: 'Rate', type: 'float', defaultValue: 0.3, minValue: 0.01, maxValue: 5, unit: 'Hz', automatable: true },
      { id: 'depth', name: 'Depth', type: 'float', defaultValue: 0.6, minValue: 0, maxValue: 1, automatable: true },
      { id: 'detune', name: 'Detune', type: 'float', defaultValue: 12, minValue: 0, maxValue: 50, unit: 'cents', automatable: true },
      { id: 'spread', name: 'Stereo Spread', type: 'float', defaultValue: 0.9, minValue: 0, maxValue: 1, automatable: true },
      { id: 'mix', name: 'Mix', type: 'float', defaultValue: 0.6, minValue: 0, maxValue: 1, automatable: true },
    ],
    defaultPreset: { voices: 4, rate: 0.3, depth: 0.6, detune: 12, spread: 0.9, mix: 0.6 },
  },
];
