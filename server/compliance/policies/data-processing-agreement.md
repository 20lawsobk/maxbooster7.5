...
**Version:** 1.0  
**Compliance:** GDPR Article 28, CCPA

This Data Processing Agreement ("DPA") forms part of the Master Services Agreement or Terms of Service ("Agreement") between Max Booster, Inc. ("Data Processor" or "Processor") and the Customer ("Data Controller" or "Controller").
...
**"Processing"** means any operation performed on Personal Data, including collection, storage, use, disclosure, or deletion as defined by GDPR Article 4(2).
...
**"Data Protection Laws"** means all applicable laws relating to privacy, data protection, and security, including GDPR, CCPA, and other relevant regulations.
...
- Platform users (artists, producers, musicians)
- Collaborators and co-creators
- End listeners (limited analytics data)
...
### 3.5 Data Subject Rights (GDPR Chapter III)

Processor shall assist Controller in fulfilling Data Subject rights requests:

**Right to Access (Art. 15):** Provide data exports in portable format  
**Right to Rectification (Art. 16):** Enable data corrections  
...
**Fees:** Processor may charge reasonable fees for excessive or repetitive requests as permitted by GDPR Article 12(5).
...
- Review Processor's security policies and procedures

**Audit Frequency:** No more than once per year unless data breach occurs or required by Supervisory Authority.

**Audit Costs:** Controller bears costs of third-party audits except in case of Processor non-compliance.

## 4. Sub-processors

### 4.1 Authorization

Controller provides general authorization for Processor to engage Sub-processors to Process Personal Data.
...
- Provide alternative solutions if Controller objects

**Notification Method:** Email to Controller's designated contact

### 4.5 Liability

Processor remains fully liable to Controller for Sub-processor performance as if Processor performed the services directly.
...
- Processor will document all requests and responses
...
- It will promptly notify Processor of any Data Subject requests or complaints
...
In case of conflict between this DPA and the Agreement, this DPA prevails on data protection matters.
...
If any provision is found invalid, the remainder of the DPA remains in effect.
...
Data Subjects and Supervisory Authorities are third-party beneficiaries of this DPA and may enforce it directly against Processor.
...
By entering into the Agreement, both parties agree to the terms of this Data Processing Agreement.
...
- Audits: Annual SOC 2 audit, quarterly internal security reviews

## Annex 2: Sub-processors

Current Sub-processors with data processing activities:

1. **Amazon Web Services, Inc.**
   - Purpose: Cloud infrastructure, storage, and compute
   - Data Processed: All Personal Data categories
   - Location: United States (with global infrastructure)
   - Safeguards: AWS Data Processing Addendum, SCCs
   - Website: aws.amazon.com/compliance/gdpr

2. **Stripe, Inc.**
   - Purpose: Payment processing
   - Data Processed: Financial Data, Transaction Data
   - Location: United States
   - Safeguards: Stripe DPA, PCI-DSS Level 1, SCCs
   - Website: stripe.com/privacy

3. **Twilio Inc. (SendGrid)**
   - Purpose: Transactional email delivery
   - Data Processed: Email addresses, names
   - Location: United States
   - Safeguards: Twilio Data Protection Addendum, SCCs
   - Website: twilio.com/legal/data-protection-addendum

**Sub-processor List:** Updated quarterly at https://maxbooster.com/sub-processors

## Annex 3: Standard Contractual Clauses

[European Commission Standard Contractual Clauses (Module 2: Controller-to-Processor) attached or incorporated by reference]

**SCCs Version:** Commission Implementing Decision (EU) 2021/914  
**Module:** Module TWO: Controller to Processor  
**Optional Clauses:** Docking clause, mediation clause, governing law clause selected
